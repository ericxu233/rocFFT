 ...
 * Kernel is: namespace(factors=[4, 11], flavour='wide', length=44, scheme='CS_KERNEL_STOCKHAM', threads_per_block=64)
 */
...
__device__ void ip_forward_length44_SBRR_device(scalar_type* __restrict__ lds,
                                                ...
                                                bool         write)
{
    ...
    // pass 0
    thread = threadIdx.x % 4 + 0; /* stockham.py:787 */
    ...
    thread = threadIdx.x % 4 + 4; /* stockham.py:787 */
    R[4]   = lds[offset_lds + (thread + 0) * lstride]; /* stockham.py:542 */
    R[5]   = lds[offset_lds + (thread + 11) * lstride]; /* stockham.py:542 */
    R[6]   = lds[offset_lds + (thread + 22) * lstride]; /* stockham.py:542 */
    R[7]   = lds[offset_lds + (thread + 33) * lstride]; /* stockham.py:542 */

    thread = threadIdx.x % 4 + 8; /* stockham.py:787 */
    if(threadIdx.x % 4 + 8 < 11)
    {
        R[8]  = lds[offset_lds + (thread + 0) * lstride]; /* stockham.py:542 */
        R[9]  = lds[offset_lds + (thread + 11) * lstride]; /* stockham.py:542 */
        R[10] = lds[offset_lds + (thread + 22) * lstride]; /* stockham.py:542 */
        R[11] = lds[offset_lds + (thread + 33) * lstride]; /* stockham.py:542 */
    }
    ...
    {
        thread = threadIdx.x % 4 + 0; /* stockham.py:787 */
        lds[offset_lds + ((thread / 4) * 44 + thread % 4 + 0) * lstride]
            = R[0]; /* stockham.py:577 */
        lds[offset_lds + ((thread / 4) * 44 + thread % 4 + 4) * lstride]
            = R[1]; /* stockham.py:577 */
        lds[offset_lds + ((thread / 4) * 44 + thread % 4 + 8) * lstride]
            = R[2]; /* stockham.py:577 */
        lds[offset_lds + ((thread / 4) * 44 + thread % 4 + 12) * lstride]
            = R[3]; /* stockham.py:577 */
        lds[offset_lds + ((thread / 4) * 44 + thread % 4 + 16) * lstride]
            = R[4]; /* stockham.py:577 */
        lds[offset_lds + ((thread / 4) * 44 + thread % 4 + 20) * lstride]
            = R[5]; /* stockham.py:577 */
        lds[offset_lds + ((thread / 4) * 44 + thread % 4 + 24) * lstride]
            = R[6]; /* stockham.py:577 */
        lds[offset_lds + ((thread / 4) * 44 + thread % 4 + 28) * lstride]
            = R[7]; /* stockham.py:577 */
        lds[offset_lds + ((thread / 4) * 44 + thread % 4 + 32) * lstride]
            = R[8]; /* stockham.py:577 */
        lds[offset_lds + ((thread / 4) * 44 + thread % 4 + 36) * lstride]
            = R[9]; /* stockham.py:577 */
        lds[offset_lds + ((thread / 4) * 44 + thread % 4 + 40) * lstride]
            = R[10]; /* stockham.py:577 */
    }
}
/* stockham.py:709 */
...
__global__
    __launch_bounds__(64) void ip_forward_length44_SBRR(const scalar_type* __restrict__ twiddles,
                                                        const size_t dim,
                                                        ...
                                                        scalar_type* __restrict__ buf)
{
    ...
    transform = blockIdx.x * 16 + threadIdx.x / 4; /* stockham.py:363 */
    ...
    offset_lds = (44 + lds_padding) * (transform % 16); /* stockham.py:373 */
    ...
    // load global
    thread = threadIdx.x % 4; /* stockham.py:384 */
    ...
    if(ebtype == EmbeddedType::C2Real_PRE)
    {
        ...
        if(thread == 3)
        {
            lds[offset_lds + thread + 40 + 1]
                = load_cb(buf, offset + (thread + 40 + 1) * stride0, load_cb_data, nullptr);
            ; /* stockham.py:395 */
        }
    }
    ...
    if(ebtype == EmbeddedType::C2Real_PRE)
    {
        ...
        real_pre_process_kernel_inplace<scalar_type, true>(thread % 22 + 0,
                                                           44 - thread % 22 - 0,
                                                           22,
                                                           &lds[offset_lds],
                                                           0,
                                                           &twiddles[44]); /* stockham.py:338 */

        real_pre_process_kernel_inplace<scalar_type, true>(thread % 22 + 4,
                                                           44 - thread % 22 - 4,
                                                           22,
                                                           &lds[offset_lds],
                                                           0,
        ...
        real_pre_process_kernel_inplace<scalar_type, true>(thread % 22 + 8,
                                                           44 - thread % 22 - 8,
                                                           22,
                                                           &lds[offset_lds],
                                                           0,
        ...
        real_pre_process_kernel_inplace<scalar_type, true>(thread % 22 + 12,
                                                           44 - thread % 22 - 12,
                                                           22,
                                                           &lds[offset_lds],
                                                           0,
        ...
        real_pre_process_kernel_inplace<scalar_type, true>(thread % 22 + 16,
                                                           44 - thread % 22 - 16,
                                                           22,
                                                           &lds[offset_lds],
                                                           0,
        ...
        real_pre_process_kernel_inplace<scalar_type, true>(thread % 22 + 20,
                                                           44 - thread % 22 - 20,
                                                           22,
                                                           &lds[offset_lds],
                                                           0,
    ...
    ip_forward_length44_SBRR_device<scalar_type, SB_UNIT>(
    ...
    if(ebtype == EmbeddedType::Real2C_POST)
    {
        ...
        real_post_process_kernel_inplace<scalar_type, true>(thread % 22 + 0,
                                                            44 - thread % 22 - 0,
                                                            22,
                                                            &lds[offset_lds],
                                                            0,
        ...
        real_post_process_kernel_inplace<scalar_type, true>(thread % 22 + 4,
                                                            44 - thread % 22 - 4,
                                                            22,
                                                            &lds[offset_lds],
                                                            0,
        ...
        real_post_process_kernel_inplace<scalar_type, true>(thread % 22 + 8,
                                                            44 - thread % 22 - 8,
                                                            22,
                                                            &lds[offset_lds],
                                                            0,
        ...
        real_post_process_kernel_inplace<scalar_type, true>(thread % 22 + 12,
                                                            44 - thread % 22 - 12,
                                                            22,
                                                            &lds[offset_lds],
                                                            0,
        ...
        real_post_process_kernel_inplace<scalar_type, true>(thread % 22 + 16,
                                                            44 - thread % 22 - 16,
                                                            22,
                                                            &lds[offset_lds],
                                                            0,
        ...
        real_post_process_kernel_inplace<scalar_type, true>(thread % 22 + 20,
                                                            44 - thread % 22 - 20,
                                                            22,
                                                            &lds[offset_lds],
                                                            0,
...
/* stockham.py:709 */
template <typename scalar_type, StrideBin sb, EmbeddedType ebtype, CallbackType cbtype>
__global__ __launch_bounds__(64) void ip_forward_length44_SBRR(
    const scalar_type* __restrict__ twiddles,
    const size_t dim,
    const size_t* __restrict__ lengths,
    const size_t* __restrict__ stride,
    ...
    real_type_t<scalar_type>* __restrict__ bufim)
{
    ...
    if(ebtype == EmbeddedType::C2Real_PRE)
    {
        ...
        {
            lds[offset_lds + thread + 40 + 1]
                = {bufre[offset + (thread + 40 + 1) * stride0],
                   bufim[offset + (thread + 40 + 1) * stride0]}; /* generator.py:872 */
        }
    }
    ...
    if(ebtype == EmbeddedType::Real2C_POST)
    {
        ...
        {
            bufre[offset + (thread + 40 + 1) * stride0]
                = lds[offset_lds + thread + 40 + 1].x; /* generator.py:906 */
            bufim[offset + (thread + 40 + 1) * stride0]
                = lds[offset_lds + thread + 40 + 1].y; /* generator.py:908 */
        }
    }
}
/* stockham.py:843 */
template <typename scalar_type, StrideBin sb>
__device__ void op_forward_length44_SBRR_device(scalar_type* __restrict__ lds,
                                                const scalar_type* __restrict__ twiddles,
                                                size_t       stride_lds,
                                                unsigned int offset_lds,
                                                bool         write)
...
template <typename scalar_type, StrideBin sb, EmbeddedType ebtype, CallbackType cbtype>
__global__
    __launch_bounds__(64) void op_forward_length44_SBRR(const scalar_type* __restrict__ twiddles,
                                                        const size_t dim,
                                                        const size_t* __restrict__ lengths,
                                                        ...
                                                        scalar_type* __restrict__ buf_out)
{
    ...
    if(ebtype == EmbeddedType::C2Real_PRE)
    {
        ...
        if(thread == 3)
        {
            lds[offset_lds + thread + 40 + 1] = load_cb(
                buf_in, offset_in + (thread + 40 + 1) * stride0_in, load_cb_data, nullptr);
            ; /* stockham.py:395 */
        }
    }
    ...
    // transform
    write = true; /* stockham.py:681 */
    op_forward_length44_SBRR_device<scalar_type, SB_UNIT>(
        lds, twiddles, stride_lds, offset_lds, write); /* stockham.py:686 */
    ...
    if(ebtype == EmbeddedType::Real2C_POST)
    {
        ...
        {
            store_cb(buf_out,
                     offset_out + (thread + 40 + 1) * stride0_out,
                     lds[offset_lds + thread + 40 + 1],
                     store_cb_data,
                     nullptr);
        }
...
/* stockham.py:709 */
template <typename scalar_type, StrideBin sb, EmbeddedType ebtype, CallbackType cbtype>
__global__ __launch_bounds__(64) void op_forward_length44_SBRR(
    const scalar_type* __restrict__ twiddles,
    const size_t dim,
    const size_t* __restrict__ lengths,
    const size_t* __restrict__ stride_in,
    ...
    real_type_t<scalar_type>* __restrict__ buf_outim)
{
    ...
    if(ebtype == EmbeddedType::Real2C_POST)
    {
        ...
        if(thread == 3)
        {
            buf_outre[offset_out + (thread + 40 + 1) * stride0_out]
                = lds[offset_lds + thread + 40 + 1].x; /* generator.py:906 */
            buf_outim[offset_out + (thread + 40 + 1) * stride0_out]
                = lds[offset_lds + thread + 40 + 1].y; /* generator.py:908 */
        }
    }
}
    ...
    scalar_type* __restrict__ buf_out)
{
    ...
    if(ebtype == EmbeddedType::C2Real_PRE)
    {
        ...
        {
            lds[offset_lds + thread + 40 + 1]
                = {buf_inre[offset_in + (thread + 40 + 1) * stride0_in],
                   buf_inim[offset_in + (thread + 40 + 1) * stride0_in]}; /* generator.py:872 */
        }
    }
...
/* stockham.py:843 */
template <typename scalar_type, StrideBin sb>
__device__ void ip_inverse_length44_SBRR_device(scalar_type* __restrict__ lds,
                                                const scalar_type* __restrict__ twiddles,
                                                size_t       stride_lds,
                                                unsigned int offset_lds,
                                                bool         write)
{
    ...
    thread = threadIdx.x % 4 + 0; /* stockham.py:787 */
    W      = {twiddles[3 + 10 * (thread % 4)].x,
         -twiddles[3 + 10 * (thread % 4)].y}; /* generator.py:1065 */
    t.x    = W.x * R[1].x - W.y * R[1].y; /* stockham.py:555 */
    t.y    = W.y * R[1].x + W.x * R[1].y; /* stockham.py:556 */
    R[1]   = t; /* stockham.py:557 */
    W      = {twiddles[4 + 10 * (thread % 4)].x,
         -twiddles[4 + 10 * (thread % 4)].y}; /* generator.py:1065 */
    t.x    = W.x * R[2].x - W.y * R[2].y; /* stockham.py:555 */
    t.y    = W.y * R[2].x + W.x * R[2].y; /* stockham.py:556 */
    R[2]   = t; /* stockham.py:557 */
    W      = {twiddles[5 + 10 * (thread % 4)].x,
         -twiddles[5 + 10 * (thread % 4)].y}; /* generator.py:1065 */
    t.x    = W.x * R[3].x - W.y * R[3].y; /* stockham.py:555 */
    t.y    = W.y * R[3].x + W.x * R[3].y; /* stockham.py:556 */
    R[3]   = t; /* stockham.py:557 */
    W      = {twiddles[6 + 10 * (thread % 4)].x,
         -twiddles[6 + 10 * (thread % 4)].y}; /* generator.py:1065 */
    t.x    = W.x * R[4].x - W.y * R[4].y; /* stockham.py:555 */
    t.y    = W.y * R[4].x + W.x * R[4].y; /* stockham.py:556 */
    R[4]   = t; /* stockham.py:557 */
    W      = {twiddles[7 + 10 * (thread % 4)].x,
         -twiddles[7 + 10 * (thread % 4)].y}; /* generator.py:1065 */
    t.x    = W.x * R[5].x - W.y * R[5].y; /* stockham.py:555 */
    t.y    = W.y * R[5].x + W.x * R[5].y; /* stockham.py:556 */
    R[5]   = t; /* stockham.py:557 */
    W      = {twiddles[8 + 10 * (thread % 4)].x,
         -twiddles[8 + 10 * (thread % 4)].y}; /* generator.py:1065 */
    t.x    = W.x * R[6].x - W.y * R[6].y; /* stockham.py:555 */
    t.y    = W.y * R[6].x + W.x * R[6].y; /* stockham.py:556 */
    R[6]   = t; /* stockham.py:557 */
    W      = {twiddles[9 + 10 * (thread % 4)].x,
         -twiddles[9 + 10 * (thread % 4)].y}; /* generator.py:1065 */
    t.x    = W.x * R[7].x - W.y * R[7].y; /* stockham.py:555 */
    t.y    = W.y * R[7].x + W.x * R[7].y; /* stockham.py:556 */
    R[7]   = t; /* stockham.py:557 */
    W      = {twiddles[10 + 10 * (thread % 4)].x,
         -twiddles[10 + 10 * (thread % 4)].y}; /* generator.py:1065 */
    t.x    = W.x * R[8].x - W.y * R[8].y; /* stockham.py:555 */
    t.y    = W.y * R[8].x + W.x * R[8].y; /* stockham.py:556 */
    R[8]   = t; /* stockham.py:557 */
    W      = {twiddles[11 + 10 * (thread % 4)].x,
         -twiddles[11 + 10 * (thread % 4)].y}; /* generator.py:1065 */
    t.x    = W.x * R[9].x - W.y * R[9].y; /* stockham.py:555 */
    t.y    = W.y * R[9].x + W.x * R[9].y; /* stockham.py:556 */
    R[9]   = t; /* stockham.py:557 */
    W      = {twiddles[12 + 10 * (thread % 4)].x,
         -twiddles[12 + 10 * (thread % 4)].y}; /* generator.py:1065 */
    t.x    = W.x * R[10].x - W.y * R[10].y; /* stockham.py:555 */
    t.y    = W.y * R[10].x + W.x * R[10].y; /* stockham.py:556 */
    R[10]  = t; /* stockham.py:557 */
...
template <typename scalar_type, StrideBin sb, EmbeddedType ebtype, CallbackType cbtype>
__global__
    __launch_bounds__(64) void ip_inverse_length44_SBRR(const scalar_type* __restrict__ twiddles,
                                                        const size_t dim,
                                                        const size_t* __restrict__ lengths,
                                                        const size_t* __restrict__ stride,
                                                        const size_t       nbatch,
                                                        ...
                                                        scalar_type* __restrict__ buf)
{
    ...
    // transform
    write = true; /* stockham.py:681 */
    ip_inverse_length44_SBRR_device<scalar_type, SB_UNIT>(
        lds, twiddles, stride_lds, offset_lds, write); /* stockham.py:686 */
...
/* stockham.py:709 */
template <typename scalar_type, StrideBin sb, EmbeddedType ebtype, CallbackType cbtype>
__global__ __launch_bounds__(64) void ip_inverse_length44_SBRR(
    const scalar_type* __restrict__ twiddles,
    const size_t dim,
    const size_t* __restrict__ lengths,
    const size_t* __restrict__ stride,
...
/* stockham.py:843 */
template <typename scalar_type, StrideBin sb>
__device__ void op_inverse_length44_SBRR_device(scalar_type* __restrict__ lds,
                                                const scalar_type* __restrict__ twiddles,
                                                size_t       stride_lds,
                                                unsigned int offset_lds,
                                                bool         write)
...
template <typename scalar_type, StrideBin sb, EmbeddedType ebtype, CallbackType cbtype>
__global__
    __launch_bounds__(64) void op_inverse_length44_SBRR(const scalar_type* __restrict__ twiddles,
                                                        const size_t dim,
                                                        const size_t* __restrict__ lengths,
                                                        const size_t* __restrict__ stride_in,
                                                        const size_t* __restrict__ stride_out,
                                                        ...
                                                        scalar_type* __restrict__ buf_out)
{
    ...
    // transform
    write = true; /* stockham.py:681 */
    op_inverse_length44_SBRR_device<scalar_type, SB_UNIT>(
        lds, twiddles, stride_lds, offset_lds, write); /* stockham.py:686 */
...
/* stockham.py:709 */
template <typename scalar_type, StrideBin sb, EmbeddedType ebtype, CallbackType cbtype>
__global__ __launch_bounds__(64) void op_inverse_length44_SBRR(
    const scalar_type* __restrict__ twiddles,
    const size_t dim,
    const size_t* __restrict__ lengths,
    const size_t* __restrict__ stride_in,
...
POWX_SMALL_GENERATOR(rocfft_internal_dfn_dp_ci_ci_stoc_44,
                     ip_forward_length44_SBRR,
                     ip_inverse_length44_SBRR,
                     op_forward_length44_SBRR,
                     op_inverse_length44_SBRR,
                     double2);
POWX_SMALL_GENERATOR(rocfft_internal_dfn_sp_ci_ci_stoc_44,
                     ip_forward_length44_SBRR,
                     ip_inverse_length44_SBRR,
                     op_forward_length44_SBRR,
                     op_inverse_length44_SBRR,
