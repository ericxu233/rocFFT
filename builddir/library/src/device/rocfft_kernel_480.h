...
FwdPass0_len480(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, T *bufIn, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data)
{
	...
	(*R1) = load_cb(bufIn, inOffset + ( 0 + me*3 + 0 + 48 )*stride_in, load_cb_data, nullptr);

	(*R11) = load_cb(bufIn, inOffset + ( 0 + me*3 + 1 + 48 )*stride_in, load_cb_data, nullptr);

	(*R21) = load_cb(bufIn, inOffset + ( 0 + me*3 + 2 + 48 )*stride_in, load_cb_data, nullptr);

	(*R2) = load_cb(bufIn, inOffset + ( 0 + me*3 + 0 + 96 )*stride_in, load_cb_data, nullptr);

	(*R12) = load_cb(bufIn, inOffset + ( 0 + me*3 + 1 + 96 )*stride_in, load_cb_data, nullptr);

	(*R22) = load_cb(bufIn, inOffset + ( 0 + me*3 + 2 + 96 )*stride_in, load_cb_data, nullptr);

	(*R3) = load_cb(bufIn, inOffset + ( 0 + me*3 + 0 + 144 )*stride_in, load_cb_data, nullptr);

	(*R13) = load_cb(bufIn, inOffset + ( 0 + me*3 + 1 + 144 )*stride_in, load_cb_data, nullptr);

	(*R23) = load_cb(bufIn, inOffset + ( 0 + me*3 + 2 + 144 )*stride_in, load_cb_data, nullptr);

	(*R4) = load_cb(bufIn, inOffset + ( 0 + me*3 + 0 + 192 )*stride_in, load_cb_data, nullptr);

	(*R14) = load_cb(bufIn, inOffset + ( 0 + me*3 + 1 + 192 )*stride_in, load_cb_data, nullptr);

	(*R24) = load_cb(bufIn, inOffset + ( 0 + me*3 + 2 + 192 )*stride_in, load_cb_data, nullptr);

	(*R5) = load_cb(bufIn, inOffset + ( 0 + me*3 + 0 + 240 )*stride_in, load_cb_data, nullptr);

	(*R15) = load_cb(bufIn, inOffset + ( 0 + me*3 + 1 + 240 )*stride_in, load_cb_data, nullptr);

	(*R25) = load_cb(bufIn, inOffset + ( 0 + me*3 + 2 + 240 )*stride_in, load_cb_data, nullptr);

	(*R6) = load_cb(bufIn, inOffset + ( 0 + me*3 + 0 + 288 )*stride_in, load_cb_data, nullptr);

	(*R16) = load_cb(bufIn, inOffset + ( 0 + me*3 + 1 + 288 )*stride_in, load_cb_data, nullptr);

	(*R26) = load_cb(bufIn, inOffset + ( 0 + me*3 + 2 + 288 )*stride_in, load_cb_data, nullptr);

	(*R7) = load_cb(bufIn, inOffset + ( 0 + me*3 + 0 + 336 )*stride_in, load_cb_data, nullptr);

	(*R17) = load_cb(bufIn, inOffset + ( 0 + me*3 + 1 + 336 )*stride_in, load_cb_data, nullptr);

	(*R27) = load_cb(bufIn, inOffset + ( 0 + me*3 + 2 + 336 )*stride_in, load_cb_data, nullptr);

	(*R8) = load_cb(bufIn, inOffset + ( 0 + me*3 + 0 + 384 )*stride_in, load_cb_data, nullptr);

	(*R18) = load_cb(bufIn, inOffset + ( 0 + me*3 + 1 + 384 )*stride_in, load_cb_data, nullptr);

	(*R28) = load_cb(bufIn, inOffset + ( 0 + me*3 + 2 + 384 )*stride_in, load_cb_data, nullptr);

	(*R9) = load_cb(bufIn, inOffset + ( 0 + me*3 + 0 + 432 )*stride_in, load_cb_data, nullptr);

	(*R19) = load_cb(bufIn, inOffset + ( 0 + me*3 + 1 + 432 )*stride_in, load_cb_data, nullptr);

	(*R29) = load_cb(bufIn, inOffset + ( 0 + me*3 + 2 + 432 )*stride_in, load_cb_data, nullptr);
	...
	(*R7).x = bufOutRe[outOffset + ( 0 + me*5 + 1 + 80 ) ];
	(*R13).x = bufOutRe[outOffset + ( 0 + me*5 + 2 + 80 ) ];
	(*R19).x = bufOutRe[outOffset + ( 0 + me*5 + 3 + 80 ) ];
	(*R25).x = bufOutRe[outOffset + ( 0 + me*5 + 4 + 80 ) ];
	(*R2).x = bufOutRe[outOffset + ( 0 + me*5 + 0 + 160 ) ];
	(*R8).x = bufOutRe[outOffset + ( 0 + me*5 + 1 + 160 ) ];
	(*R14).x = bufOutRe[outOffset + ( 0 + me*5 + 2 + 160 ) ];
	(*R20).x = bufOutRe[outOffset + ( 0 + me*5 + 3 + 160 ) ];
	(*R26).x = bufOutRe[outOffset + ( 0 + me*5 + 4 + 160 ) ];
	(*R3).x = bufOutRe[outOffset + ( 0 + me*5 + 0 + 240 ) ];
	(*R9).x = bufOutRe[outOffset + ( 0 + me*5 + 1 + 240 ) ];
	(*R15).x = bufOutRe[outOffset + ( 0 + me*5 + 2 + 240 ) ];
	(*R21).x = bufOutRe[outOffset + ( 0 + me*5 + 3 + 240 ) ];
	(*R27).x = bufOutRe[outOffset + ( 0 + me*5 + 4 + 240 ) ];
	(*R4).x = bufOutRe[outOffset + ( 0 + me*5 + 0 + 320 ) ];
	(*R10).x = bufOutRe[outOffset + ( 0 + me*5 + 1 + 320 ) ];
	(*R16).x = bufOutRe[outOffset + ( 0 + me*5 + 2 + 320 ) ];
	(*R22).x = bufOutRe[outOffset + ( 0 + me*5 + 3 + 320 ) ];
	(*R28).x = bufOutRe[outOffset + ( 0 + me*5 + 4 + 320 ) ];
	(*R5).x = bufOutRe[outOffset + ( 0 + me*5 + 0 + 400 ) ];
	(*R11).x = bufOutRe[outOffset + ( 0 + me*5 + 1 + 400 ) ];
	(*R17).x = bufOutRe[outOffset + ( 0 + me*5 + 2 + 400 ) ];
	(*R23).x = bufOutRe[outOffset + ( 0 + me*5 + 3 + 400 ) ];
	(*R29).x = bufOutRe[outOffset + ( 0 + me*5 + 4 + 400 ) ];
	}
	...
	(*R7).y = bufOutIm[outOffset + ( 0 + me*5 + 1 + 80 ) ];
	(*R13).y = bufOutIm[outOffset + ( 0 + me*5 + 2 + 80 ) ];
	(*R19).y = bufOutIm[outOffset + ( 0 + me*5 + 3 + 80 ) ];
	(*R25).y = bufOutIm[outOffset + ( 0 + me*5 + 4 + 80 ) ];
	(*R2).y = bufOutIm[outOffset + ( 0 + me*5 + 0 + 160 ) ];
	(*R8).y = bufOutIm[outOffset + ( 0 + me*5 + 1 + 160 ) ];
	(*R14).y = bufOutIm[outOffset + ( 0 + me*5 + 2 + 160 ) ];
	(*R20).y = bufOutIm[outOffset + ( 0 + me*5 + 3 + 160 ) ];
	(*R26).y = bufOutIm[outOffset + ( 0 + me*5 + 4 + 160 ) ];
	(*R3).y = bufOutIm[outOffset + ( 0 + me*5 + 0 + 240 ) ];
	(*R9).y = bufOutIm[outOffset + ( 0 + me*5 + 1 + 240 ) ];
	(*R15).y = bufOutIm[outOffset + ( 0 + me*5 + 2 + 240 ) ];
	(*R21).y = bufOutIm[outOffset + ( 0 + me*5 + 3 + 240 ) ];
	(*R27).y = bufOutIm[outOffset + ( 0 + me*5 + 4 + 240 ) ];
	(*R4).y = bufOutIm[outOffset + ( 0 + me*5 + 0 + 320 ) ];
	(*R10).y = bufOutIm[outOffset + ( 0 + me*5 + 1 + 320 ) ];
	(*R16).y = bufOutIm[outOffset + ( 0 + me*5 + 2 + 320 ) ];
	(*R22).y = bufOutIm[outOffset + ( 0 + me*5 + 3 + 320 ) ];
	(*R28).y = bufOutIm[outOffset + ( 0 + me*5 + 4 + 320 ) ];
	(*R5).y = bufOutIm[outOffset + ( 0 + me*5 + 0 + 400 ) ];
	(*R11).y = bufOutIm[outOffset + ( 0 + me*5 + 1 + 400 ) ];
	(*R17).y = bufOutIm[outOffset + ( 0 + me*5 + 2 + 400 ) ];
	(*R23).y = bufOutIm[outOffset + ( 0 + me*5 + 3 + 400 ) ];
	(*R29).y = bufOutIm[outOffset + ( 0 + me*5 + 4 + 400 ) ];
	}
...
FwdPass0_len480(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data)
{
	...
	(*R1).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 48 )*stride_in];
	(*R1).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 48 )*stride_in];
	(*R11).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 48 )*stride_in];
	(*R11).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 48 )*stride_in];
	(*R21).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 48 )*stride_in];
	(*R21).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 48 )*stride_in];
	(*R2).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 96 )*stride_in];
	(*R2).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 96 )*stride_in];
	(*R12).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 96 )*stride_in];
	(*R12).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 96 )*stride_in];
	(*R22).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 96 )*stride_in];
	(*R22).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 96 )*stride_in];
	(*R3).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 144 )*stride_in];
	(*R3).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 144 )*stride_in];
	(*R13).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 144 )*stride_in];
	(*R13).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 144 )*stride_in];
	(*R23).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 144 )*stride_in];
	(*R23).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 144 )*stride_in];
	(*R4).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 192 )*stride_in];
	(*R4).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 192 )*stride_in];
	(*R14).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 192 )*stride_in];
	(*R14).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 192 )*stride_in];
	(*R24).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 192 )*stride_in];
	(*R24).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 192 )*stride_in];
	(*R5).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 240 )*stride_in];
	(*R5).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 240 )*stride_in];
	(*R15).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 240 )*stride_in];
	(*R15).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 240 )*stride_in];
	(*R25).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 240 )*stride_in];
	(*R25).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 240 )*stride_in];
	(*R6).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 288 )*stride_in];
	(*R6).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 288 )*stride_in];
	(*R16).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 288 )*stride_in];
	(*R16).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 288 )*stride_in];
	(*R26).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 288 )*stride_in];
	(*R26).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 288 )*stride_in];
	(*R7).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 336 )*stride_in];
	(*R7).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 336 )*stride_in];
	(*R17).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 336 )*stride_in];
	(*R17).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 336 )*stride_in];
	(*R27).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 336 )*stride_in];
	(*R27).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 336 )*stride_in];
	(*R8).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 384 )*stride_in];
	(*R8).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 384 )*stride_in];
	(*R18).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 384 )*stride_in];
	(*R18).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 384 )*stride_in];
	(*R28).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 384 )*stride_in];
	(*R28).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 384 )*stride_in];
	(*R9).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 432 )*stride_in];
	(*R9).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 432 )*stride_in];
	(*R19).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 432 )*stride_in];
	(*R19).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 432 )*stride_in];
	(*R29).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 432 )*stride_in];
	(*R29).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 432 )*stride_in];
	}
...
FwdPass1_len480(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29)
{
	...
	(*R1).x = bufOutRe[outOffset + ( 0 + me*15 + 0 + 240 ) ];
	(*R3).x = bufOutRe[outOffset + ( 0 + me*15 + 1 + 240 ) ];
	(*R5).x = bufOutRe[outOffset + ( 0 + me*15 + 2 + 240 ) ];
	(*R7).x = bufOutRe[outOffset + ( 0 + me*15 + 3 + 240 ) ];
	(*R9).x = bufOutRe[outOffset + ( 0 + me*15 + 4 + 240 ) ];
	(*R11).x = bufOutRe[outOffset + ( 0 + me*15 + 5 + 240 ) ];
	(*R13).x = bufOutRe[outOffset + ( 0 + me*15 + 6 + 240 ) ];
	(*R15).x = bufOutRe[outOffset + ( 0 + me*15 + 7 + 240 ) ];
	(*R17).x = bufOutRe[outOffset + ( 0 + me*15 + 8 + 240 ) ];
	(*R19).x = bufOutRe[outOffset + ( 0 + me*15 + 9 + 240 ) ];
	(*R21).x = bufOutRe[outOffset + ( 0 + me*15 + 10 + 240 ) ];
	(*R23).x = bufOutRe[outOffset + ( 0 + me*15 + 11 + 240 ) ];
	(*R25).x = bufOutRe[outOffset + ( 0 + me*15 + 12 + 240 ) ];
	(*R27).x = bufOutRe[outOffset + ( 0 + me*15 + 13 + 240 ) ];
	(*R29).x = bufOutRe[outOffset + ( 0 + me*15 + 14 + 240 ) ];
	}
	...
	(*R1).y = bufOutIm[outOffset + ( 0 + me*15 + 0 + 240 ) ];
	(*R3).y = bufOutIm[outOffset + ( 0 + me*15 + 1 + 240 ) ];
	(*R5).y = bufOutIm[outOffset + ( 0 + me*15 + 2 + 240 ) ];
	(*R7).y = bufOutIm[outOffset + ( 0 + me*15 + 3 + 240 ) ];
	(*R9).y = bufOutIm[outOffset + ( 0 + me*15 + 4 + 240 ) ];
	(*R11).y = bufOutIm[outOffset + ( 0 + me*15 + 5 + 240 ) ];
	(*R13).y = bufOutIm[outOffset + ( 0 + me*15 + 6 + 240 ) ];
	(*R15).y = bufOutIm[outOffset + ( 0 + me*15 + 7 + 240 ) ];
	(*R17).y = bufOutIm[outOffset + ( 0 + me*15 + 8 + 240 ) ];
	(*R19).y = bufOutIm[outOffset + ( 0 + me*15 + 9 + 240 ) ];
	(*R21).y = bufOutIm[outOffset + ( 0 + me*15 + 10 + 240 ) ];
	(*R23).y = bufOutIm[outOffset + ( 0 + me*15 + 11 + 240 ) ];
	(*R25).y = bufOutIm[outOffset + ( 0 + me*15 + 12 + 240 ) ];
	(*R27).y = bufOutIm[outOffset + ( 0 + me*15 + 13 + 240 ) ];
	(*R29).y = bufOutIm[outOffset + ( 0 + me*15 + 14 + 240 ) ];
	}
...
template <typename T, StrideBin sb, CallbackType cbtype>
__device__ void
FwdPass2_len480(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29)
{
...
template <typename T, StrideBin sb, CallbackType cbtype>
__device__ void
FwdPass3_len480(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29)
{
...
FwdPass4_len480(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, T *bufOut, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data)
{
	...
	store_cb(bufOut, outOffset + ( 15*me + 0 + 240 )*stride_out, (*R1), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 1 + 240 )*stride_out, (*R3), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 2 + 240 )*stride_out, (*R5), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 3 + 240 )*stride_out, (*R7), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 4 + 240 )*stride_out, (*R9), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 5 + 240 )*stride_out, (*R11), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 6 + 240 )*stride_out, (*R13), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 7 + 240 )*stride_out, (*R15), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 8 + 240 )*stride_out, (*R17), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 9 + 240 )*stride_out, (*R19), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 10 + 240 )*stride_out, (*R21), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 11 + 240 )*stride_out, (*R23), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 12 + 240 )*stride_out, (*R25), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 13 + 240 )*stride_out, (*R27), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 14 + 240 )*stride_out, (*R29), store_cb_data, nullptr);
...
FwdPass4_len480(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data)
{
	...
	bufOutRe[outOffset + ( 15*me + 0 + 240 )*stride_out] = (*R1).x;
	bufOutIm[outOffset + ( 15*me + 0 + 240 )*stride_out] = (*R1).y;
	bufOutRe[outOffset + ( 15*me + 1 + 240 )*stride_out] = (*R3).x;
	bufOutIm[outOffset + ( 15*me + 1 + 240 )*stride_out] = (*R3).y;
	bufOutRe[outOffset + ( 15*me + 2 + 240 )*stride_out] = (*R5).x;
	bufOutIm[outOffset + ( 15*me + 2 + 240 )*stride_out] = (*R5).y;
	bufOutRe[outOffset + ( 15*me + 3 + 240 )*stride_out] = (*R7).x;
	bufOutIm[outOffset + ( 15*me + 3 + 240 )*stride_out] = (*R7).y;
	bufOutRe[outOffset + ( 15*me + 4 + 240 )*stride_out] = (*R9).x;
	bufOutIm[outOffset + ( 15*me + 4 + 240 )*stride_out] = (*R9).y;
	bufOutRe[outOffset + ( 15*me + 5 + 240 )*stride_out] = (*R11).x;
	bufOutIm[outOffset + ( 15*me + 5 + 240 )*stride_out] = (*R11).y;
	bufOutRe[outOffset + ( 15*me + 6 + 240 )*stride_out] = (*R13).x;
	bufOutIm[outOffset + ( 15*me + 6 + 240 )*stride_out] = (*R13).y;
	bufOutRe[outOffset + ( 15*me + 7 + 240 )*stride_out] = (*R15).x;
	bufOutIm[outOffset + ( 15*me + 7 + 240 )*stride_out] = (*R15).y;
	bufOutRe[outOffset + ( 15*me + 8 + 240 )*stride_out] = (*R17).x;
	bufOutIm[outOffset + ( 15*me + 8 + 240 )*stride_out] = (*R17).y;
	bufOutRe[outOffset + ( 15*me + 9 + 240 )*stride_out] = (*R19).x;
	bufOutIm[outOffset + ( 15*me + 9 + 240 )*stride_out] = (*R19).y;
	bufOutRe[outOffset + ( 15*me + 10 + 240 )*stride_out] = (*R21).x;
	bufOutIm[outOffset + ( 15*me + 10 + 240 )*stride_out] = (*R21).y;
	bufOutRe[outOffset + ( 15*me + 11 + 240 )*stride_out] = (*R23).x;
	bufOutIm[outOffset + ( 15*me + 11 + 240 )*stride_out] = (*R23).y;
	bufOutRe[outOffset + ( 15*me + 12 + 240 )*stride_out] = (*R25).x;
	bufOutIm[outOffset + ( 15*me + 12 + 240 )*stride_out] = (*R25).y;
	bufOutRe[outOffset + ( 15*me + 13 + 240 )*stride_out] = (*R27).x;
	bufOutIm[outOffset + ( 15*me + 13 + 240 )*stride_out] = (*R27).y;
	bufOutRe[outOffset + ( 15*me + 14 + 240 )*stride_out] = (*R29).x;
	bufOutIm[outOffset + ( 15*me + 14 + 240 )*stride_out] = (*R29).y;
	}
...
template <typename T, StrideBin sb, CallbackType cbtype>
__device__ void
InvPass1_len480(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29)
{
...
template <typename T, StrideBin sb, CallbackType cbtype>
__device__ void
InvPass3_len480(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29)
{
...
template <typename T, StrideBin sb, CallbackType cbtype>
__device__ void
InvPass4_len480(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, T *bufOut, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data)
{
...
template <typename T, StrideBin sb,CallbackType cbtype>
__device__ void 
fwd_len480_device(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *gbIn, unsigned int iOffset, T *gbOut, unsigned int oOffset, real_type_t<T> *lds, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19, R20, R21, R22, R23, R24, R25, R26, R27, R28, R29;
	FwdPass0_len480<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, iOffset, ldsOffset,  gbIn, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29, load_cb_fn, load_cb_data);
	FwdPass1_len480<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	FwdPass2_len480<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	FwdPass3_len480<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	FwdPass4_len480<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, oOffset, lds, lds,  gbOut, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}

template <typename T, StrideBin sb,CallbackType cbtype>
__device__ void 
back_len480_device(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *gbIn, unsigned int iOffset, T *gbOut, unsigned int oOffset, real_type_t<T> *lds, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19, R20, R21, R22, R23, R24, R25, R26, R27, R28, R29;
	InvPass0_len480<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, iOffset, ldsOffset,  gbIn, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29, load_cb_fn, load_cb_data);
	InvPass1_len480<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	InvPass2_len480<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	InvPass3_len480<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	InvPass4_len480<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, oOffset, lds, lds,  gbOut, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fwd_len480_device(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *gbIn, unsigned int iOffset, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, unsigned int oOffset, real_type_t<T> *lds, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data)
{
	...
	FwdPass2_len480<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	FwdPass3_len480<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	FwdPass4_len480<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, oOffset, lds, lds, bufOutRe, bufOutIm, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
back_len480_device(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *gbIn, unsigned int iOffset, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, unsigned int oOffset, real_type_t<T> *lds, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data)
{
	...
	InvPass2_len480<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	InvPass3_len480<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	InvPass4_len480<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, oOffset, lds, lds, bufOutRe, bufOutIm, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19, R20, R21, R22, R23, R24, R25, R26, R27, R28, R29;
	FwdPass0_len480<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, iOffset, ldsOffset,  bufInRe, bufInIm, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29, load_cb_fn, load_cb_data);
	FwdPass1_len480<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	FwdPass2_len480<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	FwdPass3_len480<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	FwdPass4_len480<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, oOffset, lds, lds,  gbOut, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29, load_cb_lds_bytes, store_cb_fn, store_cb_data);
...
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19, R20, R21, R22, R23, R24, R25, R26, R27, R28, R29;
	InvPass0_len480<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, iOffset, ldsOffset,  bufInRe, bufInIm, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29, load_cb_fn, load_cb_data);
	InvPass1_len480<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	InvPass2_len480<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	InvPass3_len480<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	InvPass4_len480<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, oOffset, lds, lds,  gbOut, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29, load_cb_lds_bytes, store_cb_fn, store_cb_data);
...
////////////////////////////////////////Global kernels
//Kernel configuration: number of threads per thread block: 64, maximum transforms: 4, Passes: 5
...
fft_fwd_ip_len480( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, T * __restrict__ gb)
{
	...
	fwd_len480_device<T, sb, cbtype>(twiddles, stride_in[0], stride_in[0],  rw, b, me%16, (me/16)*480, gb, ioOffset, gb, ioOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_back_ip_len480( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, T * __restrict__ gb)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	back_len480_device<T, sb, cbtype>(twiddles, stride_in[0], stride_in[0],  rw, b, me%16, (me/16)*480, gb, ioOffset, gb, ioOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_fwd_ip_len480( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, real_type_t<T> * __restrict__ gbRe, real_type_t<T> * __restrict__ gbIm)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	fwd_len480_device<T, sb, cbtype>(twiddles, stride_in[0], stride_in[0],  rw, b, me%16, (me/16)*480, gbRe, gbIm, ioOffset, gbRe, gbIm, ioOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_back_ip_len480( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, real_type_t<T> * __restrict__ gbRe, real_type_t<T> * __restrict__ gbIm)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	back_len480_device<T, sb, cbtype>(twiddles, stride_in[0], stride_in[0],  rw, b, me%16, (me/16)*480, gbRe, gbIm, ioOffset, gbRe, gbIm, ioOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_fwd_op_len480( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, T * __restrict__ gbIn, T * __restrict__ gbOut)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	fwd_len480_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  rw, b, me%16, (me/16)*480, gbIn, iOffset, gbOut, oOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
__global__ void
__launch_bounds__(64)
fft_back_op_len480( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, T * __restrict__ gbIn, T * __restrict__ gbOut)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	back_len480_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  rw, b, me%16, (me/16)*480, gbIn, iOffset, gbOut, oOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_fwd_op_len480( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, T * __restrict__ gbIn, real_type_t<T> * __restrict__ gbOutRe, real_type_t<T> * __restrict__ gbOutIm)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	fwd_len480_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  rw, b, me%16, (me/16)*480, gbIn, iOffset, gbOutRe, gbOutIm, oOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_back_op_len480( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, T * __restrict__ gbIn, real_type_t<T> * __restrict__ gbOutRe, real_type_t<T> * __restrict__ gbOutIm)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	back_len480_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  rw, b, me%16, (me/16)*480, gbIn, iOffset, gbOutRe, gbOutIm, oOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_fwd_op_len480( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, real_type_t<T> * __restrict__ gbInRe, real_type_t<T> * __restrict__ gbInIm, T * __restrict__ gbOut)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	fwd_len480_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  rw, b, me%16, (me/16)*480, gbInRe, gbInIm, iOffset, gbOut, oOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_back_op_len480( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, real_type_t<T> * __restrict__ gbInRe, real_type_t<T> * __restrict__ gbInIm, T * __restrict__ gbOut)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	back_len480_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  rw, b, me%16, (me/16)*480, gbInRe, gbInIm, iOffset, gbOut, oOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_fwd_op_len480( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, real_type_t<T> * __restrict__ gbInRe, real_type_t<T> * __restrict__ gbInIm, real_type_t<T> * __restrict__ gbOutRe, real_type_t<T> * __restrict__ gbOutIm)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	fwd_len480_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  rw, b, me%16, (me/16)*480, gbInRe, gbInIm, iOffset, gbOutRe, gbOutIm, oOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_back_op_len480( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, real_type_t<T> * __restrict__ gbInRe, real_type_t<T> * __restrict__ gbInIm, real_type_t<T> * __restrict__ gbOutRe, real_type_t<T> * __restrict__ gbOutIm)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	back_len480_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  rw, b, me%16, (me/16)*480, gbInRe, gbInIm, iOffset, gbOutRe, gbOutIm, oOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
