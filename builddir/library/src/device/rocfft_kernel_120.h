...
FwdPass0_len120(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, T *bufIn, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29)
{
	...
	(*R1) = bufIn[inOffset + ( 0 + me*3 + 0 + 12 )*stride_in];
	(*R11) = bufIn[inOffset + ( 0 + me*3 + 1 + 12 )*stride_in];
	(*R21) = bufIn[inOffset + ( 0 + me*3 + 2 + 12 )*stride_in];
	(*R2) = bufIn[inOffset + ( 0 + me*3 + 0 + 24 )*stride_in];
	(*R12) = bufIn[inOffset + ( 0 + me*3 + 1 + 24 )*stride_in];
	(*R22) = bufIn[inOffset + ( 0 + me*3 + 2 + 24 )*stride_in];
	(*R3) = bufIn[inOffset + ( 0 + me*3 + 0 + 36 )*stride_in];
	(*R13) = bufIn[inOffset + ( 0 + me*3 + 1 + 36 )*stride_in];
	(*R23) = bufIn[inOffset + ( 0 + me*3 + 2 + 36 )*stride_in];
	(*R4) = bufIn[inOffset + ( 0 + me*3 + 0 + 48 )*stride_in];
	(*R14) = bufIn[inOffset + ( 0 + me*3 + 1 + 48 )*stride_in];
	(*R24) = bufIn[inOffset + ( 0 + me*3 + 2 + 48 )*stride_in];
	(*R5) = bufIn[inOffset + ( 0 + me*3 + 0 + 60 )*stride_in];
	(*R15) = bufIn[inOffset + ( 0 + me*3 + 1 + 60 )*stride_in];
	(*R25) = bufIn[inOffset + ( 0 + me*3 + 2 + 60 )*stride_in];
	(*R6) = bufIn[inOffset + ( 0 + me*3 + 0 + 72 )*stride_in];
	(*R16) = bufIn[inOffset + ( 0 + me*3 + 1 + 72 )*stride_in];
	(*R26) = bufIn[inOffset + ( 0 + me*3 + 2 + 72 )*stride_in];
	(*R7) = bufIn[inOffset + ( 0 + me*3 + 0 + 84 )*stride_in];
	(*R17) = bufIn[inOffset + ( 0 + me*3 + 1 + 84 )*stride_in];
	(*R27) = bufIn[inOffset + ( 0 + me*3 + 2 + 84 )*stride_in];
	(*R8) = bufIn[inOffset + ( 0 + me*3 + 0 + 96 )*stride_in];
	(*R18) = bufIn[inOffset + ( 0 + me*3 + 1 + 96 )*stride_in];
	(*R28) = bufIn[inOffset + ( 0 + me*3 + 2 + 96 )*stride_in];
	(*R9) = bufIn[inOffset + ( 0 + me*3 + 0 + 108 )*stride_in];
	(*R19) = bufIn[inOffset + ( 0 + me*3 + 1 + 108 )*stride_in];
	(*R29) = bufIn[inOffset + ( 0 + me*3 + 2 + 108 )*stride_in];
	}
	...
	(*R1).x = bufOutRe[outOffset + ( 0 + me*5 + 0 + 20 ) ];
	(*R7).x = bufOutRe[outOffset + ( 0 + me*5 + 1 + 20 ) ];
	(*R13).x = bufOutRe[outOffset + ( 0 + me*5 + 2 + 20 ) ];
	(*R19).x = bufOutRe[outOffset + ( 0 + me*5 + 3 + 20 ) ];
	(*R25).x = bufOutRe[outOffset + ( 0 + me*5 + 4 + 20 ) ];
	(*R2).x = bufOutRe[outOffset + ( 0 + me*5 + 0 + 40 ) ];
	(*R8).x = bufOutRe[outOffset + ( 0 + me*5 + 1 + 40 ) ];
	(*R14).x = bufOutRe[outOffset + ( 0 + me*5 + 2 + 40 ) ];
	(*R20).x = bufOutRe[outOffset + ( 0 + me*5 + 3 + 40 ) ];
	(*R26).x = bufOutRe[outOffset + ( 0 + me*5 + 4 + 40 ) ];
	(*R3).x = bufOutRe[outOffset + ( 0 + me*5 + 0 + 60 ) ];
	(*R9).x = bufOutRe[outOffset + ( 0 + me*5 + 1 + 60 ) ];
	(*R15).x = bufOutRe[outOffset + ( 0 + me*5 + 2 + 60 ) ];
	(*R21).x = bufOutRe[outOffset + ( 0 + me*5 + 3 + 60 ) ];
	(*R27).x = bufOutRe[outOffset + ( 0 + me*5 + 4 + 60 ) ];
	(*R4).x = bufOutRe[outOffset + ( 0 + me*5 + 0 + 80 ) ];
	(*R10).x = bufOutRe[outOffset + ( 0 + me*5 + 1 + 80 ) ];
	(*R16).x = bufOutRe[outOffset + ( 0 + me*5 + 2 + 80 ) ];
	(*R22).x = bufOutRe[outOffset + ( 0 + me*5 + 3 + 80 ) ];
	(*R28).x = bufOutRe[outOffset + ( 0 + me*5 + 4 + 80 ) ];
	(*R5).x = bufOutRe[outOffset + ( 0 + me*5 + 0 + 100 ) ];
	(*R11).x = bufOutRe[outOffset + ( 0 + me*5 + 1 + 100 ) ];
	(*R17).x = bufOutRe[outOffset + ( 0 + me*5 + 2 + 100 ) ];
	(*R23).x = bufOutRe[outOffset + ( 0 + me*5 + 3 + 100 ) ];
	(*R29).x = bufOutRe[outOffset + ( 0 + me*5 + 4 + 100 ) ];
	}
	...
	(*R1).y = bufOutIm[outOffset + ( 0 + me*5 + 0 + 20 ) ];
	(*R7).y = bufOutIm[outOffset + ( 0 + me*5 + 1 + 20 ) ];
	(*R13).y = bufOutIm[outOffset + ( 0 + me*5 + 2 + 20 ) ];
	(*R19).y = bufOutIm[outOffset + ( 0 + me*5 + 3 + 20 ) ];
	(*R25).y = bufOutIm[outOffset + ( 0 + me*5 + 4 + 20 ) ];
	(*R2).y = bufOutIm[outOffset + ( 0 + me*5 + 0 + 40 ) ];
	(*R8).y = bufOutIm[outOffset + ( 0 + me*5 + 1 + 40 ) ];
	(*R14).y = bufOutIm[outOffset + ( 0 + me*5 + 2 + 40 ) ];
	(*R20).y = bufOutIm[outOffset + ( 0 + me*5 + 3 + 40 ) ];
	(*R26).y = bufOutIm[outOffset + ( 0 + me*5 + 4 + 40 ) ];
	(*R3).y = bufOutIm[outOffset + ( 0 + me*5 + 0 + 60 ) ];
	(*R9).y = bufOutIm[outOffset + ( 0 + me*5 + 1 + 60 ) ];
	(*R15).y = bufOutIm[outOffset + ( 0 + me*5 + 2 + 60 ) ];
	(*R21).y = bufOutIm[outOffset + ( 0 + me*5 + 3 + 60 ) ];
	(*R27).y = bufOutIm[outOffset + ( 0 + me*5 + 4 + 60 ) ];
	(*R4).y = bufOutIm[outOffset + ( 0 + me*5 + 0 + 80 ) ];
	(*R10).y = bufOutIm[outOffset + ( 0 + me*5 + 1 + 80 ) ];
	(*R16).y = bufOutIm[outOffset + ( 0 + me*5 + 2 + 80 ) ];
	(*R22).y = bufOutIm[outOffset + ( 0 + me*5 + 3 + 80 ) ];
	(*R28).y = bufOutIm[outOffset + ( 0 + me*5 + 4 + 80 ) ];
	(*R5).y = bufOutIm[outOffset + ( 0 + me*5 + 0 + 100 ) ];
	(*R11).y = bufOutIm[outOffset + ( 0 + me*5 + 1 + 100 ) ];
	(*R17).y = bufOutIm[outOffset + ( 0 + me*5 + 2 + 100 ) ];
	(*R23).y = bufOutIm[outOffset + ( 0 + me*5 + 3 + 100 ) ];
	(*R29).y = bufOutIm[outOffset + ( 0 + me*5 + 4 + 100 ) ];
	}
...
FwdPass0_len120(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29)
{
	...
	(*R1).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 12 )*stride_in];
	(*R1).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 12 )*stride_in];
	(*R11).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 12 )*stride_in];
	(*R11).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 12 )*stride_in];
	(*R21).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 12 )*stride_in];
	(*R21).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 12 )*stride_in];
	(*R2).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 24 )*stride_in];
	(*R2).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 24 )*stride_in];
	(*R12).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 24 )*stride_in];
	(*R12).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 24 )*stride_in];
	(*R22).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 24 )*stride_in];
	(*R22).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 24 )*stride_in];
	(*R3).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 36 )*stride_in];
	(*R3).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 36 )*stride_in];
	(*R13).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 36 )*stride_in];
	(*R13).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 36 )*stride_in];
	(*R23).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 36 )*stride_in];
	(*R23).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 36 )*stride_in];
	(*R4).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 48 )*stride_in];
	(*R4).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 48 )*stride_in];
	(*R14).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 48 )*stride_in];
	(*R14).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 48 )*stride_in];
	(*R24).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 48 )*stride_in];
	(*R24).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 48 )*stride_in];
	(*R5).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 60 )*stride_in];
	(*R5).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 60 )*stride_in];
	(*R15).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 60 )*stride_in];
	(*R15).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 60 )*stride_in];
	(*R25).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 60 )*stride_in];
	(*R25).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 60 )*stride_in];
	(*R6).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 72 )*stride_in];
	(*R6).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 72 )*stride_in];
	(*R16).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 72 )*stride_in];
	(*R16).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 72 )*stride_in];
	(*R26).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 72 )*stride_in];
	(*R26).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 72 )*stride_in];
	(*R7).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 84 )*stride_in];
	(*R7).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 84 )*stride_in];
	(*R17).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 84 )*stride_in];
	(*R17).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 84 )*stride_in];
	(*R27).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 84 )*stride_in];
	(*R27).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 84 )*stride_in];
	(*R8).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 96 )*stride_in];
	(*R8).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 96 )*stride_in];
	(*R18).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 96 )*stride_in];
	(*R18).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 96 )*stride_in];
	(*R28).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 96 )*stride_in];
	(*R28).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 96 )*stride_in];
	(*R9).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 108 )*stride_in];
	(*R9).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 108 )*stride_in];
	(*R19).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 108 )*stride_in];
	(*R19).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 108 )*stride_in];
	(*R29).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 108 )*stride_in];
	(*R29).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 108 )*stride_in];
	}
...
template <typename T, StrideBin sb>
__device__ void
FwdPass1_len120(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29)
{
	...
	(*R1).x = bufOutRe[outOffset + ( 0 + me*15 + 0 + 60 ) ];
	(*R3).x = bufOutRe[outOffset + ( 0 + me*15 + 1 + 60 ) ];
	(*R5).x = bufOutRe[outOffset + ( 0 + me*15 + 2 + 60 ) ];
	(*R7).x = bufOutRe[outOffset + ( 0 + me*15 + 3 + 60 ) ];
	(*R9).x = bufOutRe[outOffset + ( 0 + me*15 + 4 + 60 ) ];
	(*R11).x = bufOutRe[outOffset + ( 0 + me*15 + 5 + 60 ) ];
	(*R13).x = bufOutRe[outOffset + ( 0 + me*15 + 6 + 60 ) ];
	(*R15).x = bufOutRe[outOffset + ( 0 + me*15 + 7 + 60 ) ];
	(*R17).x = bufOutRe[outOffset + ( 0 + me*15 + 8 + 60 ) ];
	(*R19).x = bufOutRe[outOffset + ( 0 + me*15 + 9 + 60 ) ];
	(*R21).x = bufOutRe[outOffset + ( 0 + me*15 + 10 + 60 ) ];
	(*R23).x = bufOutRe[outOffset + ( 0 + me*15 + 11 + 60 ) ];
	(*R25).x = bufOutRe[outOffset + ( 0 + me*15 + 12 + 60 ) ];
	(*R27).x = bufOutRe[outOffset + ( 0 + me*15 + 13 + 60 ) ];
	(*R29).x = bufOutRe[outOffset + ( 0 + me*15 + 14 + 60 ) ];
	}
	...
	(*R1).y = bufOutIm[outOffset + ( 0 + me*15 + 0 + 60 ) ];
	(*R3).y = bufOutIm[outOffset + ( 0 + me*15 + 1 + 60 ) ];
	(*R5).y = bufOutIm[outOffset + ( 0 + me*15 + 2 + 60 ) ];
	(*R7).y = bufOutIm[outOffset + ( 0 + me*15 + 3 + 60 ) ];
	(*R9).y = bufOutIm[outOffset + ( 0 + me*15 + 4 + 60 ) ];
	(*R11).y = bufOutIm[outOffset + ( 0 + me*15 + 5 + 60 ) ];
	(*R13).y = bufOutIm[outOffset + ( 0 + me*15 + 6 + 60 ) ];
	(*R15).y = bufOutIm[outOffset + ( 0 + me*15 + 7 + 60 ) ];
	(*R17).y = bufOutIm[outOffset + ( 0 + me*15 + 8 + 60 ) ];
	(*R19).y = bufOutIm[outOffset + ( 0 + me*15 + 9 + 60 ) ];
	(*R21).y = bufOutIm[outOffset + ( 0 + me*15 + 10 + 60 ) ];
	(*R23).y = bufOutIm[outOffset + ( 0 + me*15 + 11 + 60 ) ];
	(*R25).y = bufOutIm[outOffset + ( 0 + me*15 + 12 + 60 ) ];
	(*R27).y = bufOutIm[outOffset + ( 0 + me*15 + 13 + 60 ) ];
	(*R29).y = bufOutIm[outOffset + ( 0 + me*15 + 14 + 60 ) ];
	}
...
FwdPass2_len120(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, T *bufOut, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29)
{
	...
	bufOut[outOffset + ( 15*me + 0 + 60 )*stride_out] = (*R1);
	bufOut[outOffset + ( 15*me + 1 + 60 )*stride_out] = (*R3);
	bufOut[outOffset + ( 15*me + 2 + 60 )*stride_out] = (*R5);
	bufOut[outOffset + ( 15*me + 3 + 60 )*stride_out] = (*R7);
	bufOut[outOffset + ( 15*me + 4 + 60 )*stride_out] = (*R9);
	bufOut[outOffset + ( 15*me + 5 + 60 )*stride_out] = (*R11);
	bufOut[outOffset + ( 15*me + 6 + 60 )*stride_out] = (*R13);
	bufOut[outOffset + ( 15*me + 7 + 60 )*stride_out] = (*R15);
	bufOut[outOffset + ( 15*me + 8 + 60 )*stride_out] = (*R17);
	bufOut[outOffset + ( 15*me + 9 + 60 )*stride_out] = (*R19);
	bufOut[outOffset + ( 15*me + 10 + 60 )*stride_out] = (*R21);
	bufOut[outOffset + ( 15*me + 11 + 60 )*stride_out] = (*R23);
	bufOut[outOffset + ( 15*me + 12 + 60 )*stride_out] = (*R25);
	bufOut[outOffset + ( 15*me + 13 + 60 )*stride_out] = (*R27);
	bufOut[outOffset + ( 15*me + 14 + 60 )*stride_out] = (*R29);
	}
...
FwdPass2_len120(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29)
{
	...
	bufOutRe[outOffset + ( 15*me + 0 + 60 )*stride_out] = (*R1).x;
	bufOutIm[outOffset + ( 15*me + 0 + 60 )*stride_out] = (*R1).y;
	bufOutRe[outOffset + ( 15*me + 1 + 60 )*stride_out] = (*R3).x;
	bufOutIm[outOffset + ( 15*me + 1 + 60 )*stride_out] = (*R3).y;
	bufOutRe[outOffset + ( 15*me + 2 + 60 )*stride_out] = (*R5).x;
	bufOutIm[outOffset + ( 15*me + 2 + 60 )*stride_out] = (*R5).y;
	bufOutRe[outOffset + ( 15*me + 3 + 60 )*stride_out] = (*R7).x;
	bufOutIm[outOffset + ( 15*me + 3 + 60 )*stride_out] = (*R7).y;
	bufOutRe[outOffset + ( 15*me + 4 + 60 )*stride_out] = (*R9).x;
	bufOutIm[outOffset + ( 15*me + 4 + 60 )*stride_out] = (*R9).y;
	bufOutRe[outOffset + ( 15*me + 5 + 60 )*stride_out] = (*R11).x;
	bufOutIm[outOffset + ( 15*me + 5 + 60 )*stride_out] = (*R11).y;
	bufOutRe[outOffset + ( 15*me + 6 + 60 )*stride_out] = (*R13).x;
	bufOutIm[outOffset + ( 15*me + 6 + 60 )*stride_out] = (*R13).y;
	bufOutRe[outOffset + ( 15*me + 7 + 60 )*stride_out] = (*R15).x;
	bufOutIm[outOffset + ( 15*me + 7 + 60 )*stride_out] = (*R15).y;
	bufOutRe[outOffset + ( 15*me + 8 + 60 )*stride_out] = (*R17).x;
	bufOutIm[outOffset + ( 15*me + 8 + 60 )*stride_out] = (*R17).y;
	bufOutRe[outOffset + ( 15*me + 9 + 60 )*stride_out] = (*R19).x;
	bufOutIm[outOffset + ( 15*me + 9 + 60 )*stride_out] = (*R19).y;
	bufOutRe[outOffset + ( 15*me + 10 + 60 )*stride_out] = (*R21).x;
	bufOutIm[outOffset + ( 15*me + 10 + 60 )*stride_out] = (*R21).y;
	bufOutRe[outOffset + ( 15*me + 11 + 60 )*stride_out] = (*R23).x;
	bufOutIm[outOffset + ( 15*me + 11 + 60 )*stride_out] = (*R23).y;
	bufOutRe[outOffset + ( 15*me + 12 + 60 )*stride_out] = (*R25).x;
	bufOutIm[outOffset + ( 15*me + 12 + 60 )*stride_out] = (*R25).y;
	bufOutRe[outOffset + ( 15*me + 13 + 60 )*stride_out] = (*R27).x;
	bufOutIm[outOffset + ( 15*me + 13 + 60 )*stride_out] = (*R27).y;
	bufOutRe[outOffset + ( 15*me + 14 + 60 )*stride_out] = (*R29).x;
	bufOutIm[outOffset + ( 15*me + 14 + 60 )*stride_out] = (*R29).y;
	}
...
template <typename T, StrideBin sb>
__device__ void
InvPass1_len120(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29)
{
...
template <typename T, StrideBin sb>
__device__ void
InvPass2_len120(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, T *bufOut, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29)
{
...
template <typename T, StrideBin sb>
__device__ void 
fwd_len120_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *lwbIn, T *lwbOut, real_type_t<T> *lds)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19, R20, R21, R22, R23, R24, R25, R26, R27, R28, R29;
	FwdPass0_len120<T, sb>(twiddles, stride_in, stride_out, rw, b, me, 0, ldsOffset,  lwbIn, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	FwdPass1_len120<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	FwdPass2_len120<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, 0, lds, lds,  lwbOut, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
}

template <typename T, StrideBin sb>
__device__ void 
back_len120_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *lwbIn, T *lwbOut, real_type_t<T> *lds)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19, R20, R21, R22, R23, R24, R25, R26, R27, R28, R29;
	InvPass0_len120<T, sb>(twiddles, stride_in, stride_out, rw, b, me, 0, ldsOffset,  lwbIn, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	InvPass1_len120<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	InvPass2_len120<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, 0, lds, lds,  lwbOut, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
}

template <typename T, StrideBin sb>
__device__ void 
fwd_len120_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *lwbIn, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, real_type_t<T> *lds)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19, R20, R21, R22, R23, R24, R25, R26, R27, R28, R29;
	FwdPass0_len120<T, sb>(twiddles, stride_in, stride_out, rw, b, me, 0, ldsOffset,  lwbIn, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	FwdPass1_len120<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	FwdPass2_len120<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, 0, lds, lds, bufOutRe, bufOutIm, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
}

template <typename T, StrideBin sb>
__device__ void 
back_len120_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *lwbIn, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, real_type_t<T> *lds)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19, R20, R21, R22, R23, R24, R25, R26, R27, R28, R29;
	InvPass0_len120<T, sb>(twiddles, stride_in, stride_out, rw, b, me, 0, ldsOffset,  lwbIn, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	InvPass1_len120<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	InvPass2_len120<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, 0, lds, lds, bufOutRe, bufOutIm, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
}

template <typename T, StrideBin sb>
__device__ void 
fwd_len120_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, T *lwbOut, real_type_t<T> *lds)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19, R20, R21, R22, R23, R24, R25, R26, R27, R28, R29;
	FwdPass0_len120<T, sb>(twiddles, stride_in, stride_out, rw, b, me, 0, ldsOffset,  bufInRe, bufInIm, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	FwdPass1_len120<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	FwdPass2_len120<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, 0, lds, lds,  lwbOut, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
}
...
template <typename T, StrideBin sb>
__device__ void 
back_len120_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, T *lwbOut, real_type_t<T> *lds)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19, R20, R21, R22, R23, R24, R25, R26, R27, R28, R29;
	InvPass0_len120<T, sb>(twiddles, stride_in, stride_out, rw, b, me, 0, ldsOffset,  bufInRe, bufInIm, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	InvPass1_len120<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	InvPass2_len120<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, 0, lds, lds,  lwbOut, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
}
...
template <typename T, StrideBin sb>
__device__ void 
fwd_len120_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, real_type_t<T> *lds)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19, R20, R21, R22, R23, R24, R25, R26, R27, R28, R29;
	FwdPass0_len120<T, sb>(twiddles, stride_in, stride_out, rw, b, me, 0, ldsOffset,  bufInRe, bufInIm, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	FwdPass1_len120<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
...
template <typename T, StrideBin sb>
__device__ void 
back_len120_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, real_type_t<T> *lds)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19, R20, R21, R22, R23, R24, R25, R26, R27, R28, R29;
	InvPass0_len120<T, sb>(twiddles, stride_in, stride_out, rw, b, me, 0, ldsOffset,  bufInRe, bufInIm, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	InvPass1_len120<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
...
////////////////////////////////////////Global kernels
//Kernel configuration: number of threads per thread block: 64, maximum transforms: 16, Passes: 3
template <typename T, StrideBin sb>
__global__ void
__launch_bounds__(64)
fft_fwd_ip_len120( cl::sycl::range<3> blocks, cl::sycl::range<3> threads, cl::sycl::queue rocfftQueue, cl::sycl::buffer<T, 1> twiddles_GB, const size_t dim, cl::sycl::buffer<size_t, 1> *lengths_GB, cl::sycl::buffer<size_t, 1> *stride_in_GB, const size_t batch_count, cl::sycl::buffer<T, 1> gb_GB)
{
rocfftQueue.submit([&](cl::sycl::handler &cgh)
{
	...
	cgh.parallel_for<class kern_fft_fwd_ip_len120>(
...
//// Print kernel code here (after function prototype)
	...
	fwd_len120_device<T, sb>(twiddles, stride_in[0], stride_in[0],  rw, b, me%4, (me/4)*120, lwb, lwb, lds);
});
});
}
...
__global__ void
__launch_bounds__(64)
fft_back_ip_len120( cl::sycl::range<3> blocks, cl::sycl::range<3> threads, cl::sycl::queue rocfftQueue, cl::sycl::buffer<T, 1> twiddles_GB, const size_t dim, cl::sycl::buffer<size_t, 1> *lengths_GB, cl::sycl::buffer<size_t, 1> *stride_in_GB, const size_t batch_count, cl::sycl::buffer<T, 1> gb_GB)
{
rocfftQueue.submit([&](cl::sycl::handler &cgh)
{
	auto twiddles = twiddles_GB.get_access<cl::sycl::access::mode::read>(cgh);
	...
	auto gb = gb_GB.get_access<cl::sycl::access::mode::read_write>(cgh);
	cl::sycl::accessor<real_type_t<T>,1,sycl::access::mode::read_write,sycl::access::target::local> lds(cl::sycl::range<1>(1920), cgh);
	cgh.parallel_for<class kern_fft_back_ip_len120>(
	                   cl::sycl::nd_range<3>(blocks, threads),
	                   [=](cl::sycl::nd_item<3> wItem)
{
//// Print kernel code here (after function prototype)
	...
	// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, lwb, lds
	back_len120_device<T, sb>(twiddles, stride_in[0], stride_in[0],  rw, b, me%4, (me/4)*120, lwb, lwb, lds);
});
});
}
...
//// Print kernel code here (after function prototype)
	...
	// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, lwb, lds
	fwd_len120_device<T, sb>(twiddles, stride_in[0], stride_in[0],  rw, b, me%4, (me/4)*120, lwbRe, lwbIm, lwbRe, lwbIm, lds);
});
});
}
...
__global__ void
__launch_bounds__(64)
fft_back_ip_len120( cl::sycl::range<3> blocks, cl::sycl::range<3> threads, cl::sycl::queue rocfftQueue, cl::sycl::buffer<T, 1> twiddles_GB, const size_t dim, cl::sycl::buffer<size_t, 1> *lengths_GB, cl::sycl::buffer<size_t, 1> *stride_in_GB, const size_t batch_count, cl::sycl::buffer<real_type_t<T>, 1> gbRe_GB, cl::sycl::buffer<real_type_t<T>, 1> gbIm_GB)
{
rocfftQueue.submit([&](cl::sycl::handler &cgh)
{
	auto twiddles = twiddles_GB.get_access<cl::sycl::access::mode::read>(cgh);
...
//// Print kernel code here (after function prototype)
	...
	// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, lwb, lds
	back_len120_device<T, sb>(twiddles, stride_in[0], stride_in[0],  rw, b, me%4, (me/4)*120, lwbRe, lwbIm, lwbRe, lwbIm, lds);
});
});
}
...
rocfftQueue.submit([&](cl::sycl::handler &cgh)
{
	...
	cl::sycl::accessor<real_type_t<T>,1,sycl::access::mode::read_write,sycl::access::target::local> lds(cl::sycl::range<1>(1920), cgh);
	cgh.parallel_for<class kern_fft_fwd_op_len120>(
	                   cl::sycl::nd_range<3>(blocks, threads),
	                   [=](cl::sycl::nd_item<3> wItem)
{
//// Print kernel code here (after function prototype)
	...
	// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, lwb, lds
	fwd_len120_device<T, sb>(twiddles, stride_in[0], stride_out[0],  rw, b, me%4, (me/4)*120, lwbIn, lwbOut, lds);
});
});
}
...
__global__ void
__launch_bounds__(64)
fft_back_op_len120( cl::sycl::range<3> blocks, cl::sycl::range<3> threads, cl::sycl::queue rocfftQueue, cl::sycl::buffer<T, 1> twiddles_GB, const size_t dim, cl::sycl::buffer<size_t, 1> *lengths_GB, cl::sycl::buffer<size_t, 1> *stride_in_GB, cl::sycl::buffer<size_t, 1> *stride_out_GB, const size_t batch_count, cl::sycl::buffer<T, 1> gbIn_GB, cl::sycl::buffer<T, 1> gbOut_GB)
{
rocfftQueue.submit([&](cl::sycl::handler &cgh)
{
	auto twiddles = twiddles_GB.get_access<cl::sycl::access::mode::read>(cgh);
	...
	auto gbOut = gbOut_GB.get_access<cl::sycl::access::mode::read_write>(cgh);
	cl::sycl::accessor<real_type_t<T>,1,sycl::access::mode::read_write,sycl::access::target::local> lds(cl::sycl::range<1>(1920), cgh);
	cgh.parallel_for<class kern_fft_back_op_len120>(
	                   cl::sycl::nd_range<3>(blocks, threads),
	                   [=](cl::sycl::nd_item<3> wItem)
{
//// Print kernel code here (after function prototype)
	...
	// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, lwb, lds
	back_len120_device<T, sb>(twiddles, stride_in[0], stride_out[0],  rw, b, me%4, (me/4)*120, lwbIn, lwbOut, lds);
});
});
}
...
//// Print kernel code here (after function prototype)
	...
	// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, lwb, lds
	fwd_len120_device<T, sb>(twiddles, stride_in[0], stride_out[0],  rw, b, me%4, (me/4)*120, lwbIn, lwbOutRe, lwbOutIm, lds);
});
});
}
...
//// Print kernel code here (after function prototype)
	...
	// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, lwb, lds
	back_len120_device<T, sb>(twiddles, stride_in[0], stride_out[0],  rw, b, me%4, (me/4)*120, lwbIn, lwbOutRe, lwbOutIm, lds);
});
});
}
...
//// Print kernel code here (after function prototype)
	...
	// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, lwb, lds
	fwd_len120_device<T, sb>(twiddles, stride_in[0], stride_out[0],  rw, b, me%4, (me/4)*120, lwbInRe, lwbInIm, lwbOut, lds);
});
});
}
...
//// Print kernel code here (after function prototype)
	...
	// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, lwb, lds
	back_len120_device<T, sb>(twiddles, stride_in[0], stride_out[0],  rw, b, me%4, (me/4)*120, lwbInRe, lwbInIm, lwbOut, lds);
});
});
}
...
//// Print kernel code here (after function prototype)
	...
	// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, lwb, lds
	fwd_len120_device<T, sb>(twiddles, stride_in[0], stride_out[0],  rw, b, me%4, (me/4)*120, lwbInRe, lwbInIm, lwbOutRe, lwbOutIm, lds);
});
});
}
...
//// Print kernel code here (after function prototype)
	...
	// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, lwb, lds
	back_len120_device<T, sb>(twiddles, stride_in[0], stride_out[0],  rw, b, me%4, (me/4)*120, lwbInRe, lwbInIm, lwbOutRe, lwbOutIm, lds);
});
});
}
