...
__device__ void
FwdPass0_len64_sbrc(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, T *bufIn, T *bufOut, T *R0, T *R1, T *R2, T *R3)
{
...
template <typename T, StrideBin sb, CallbackType cbtype>
__device__ void
FwdPass1_len64_sbrc(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, T *bufIn, T *bufOut, T *R0, T *R1, T *R2, T *R3)
{
...
template <typename T, StrideBin sb, CallbackType cbtype>
__device__ void
FwdPass2_len64_sbrc(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, T *bufIn, T *bufOut, T *R0, T *R1, T *R2, T *R3)
{
...
template <typename T, StrideBin sb, CallbackType cbtype>
__device__ void
InvPass0_len64_sbrc(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, T *bufIn, T *bufOut, T *R0, T *R1, T *R2, T *R3)
{
...
template <typename T, StrideBin sb, CallbackType cbtype>
__device__ void
InvPass1_len64_sbrc(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, T *bufIn, T *bufOut, T *R0, T *R1, T *R2, T *R3)
{
...
template <typename T, StrideBin sb, CallbackType cbtype>
__device__ void
InvPass2_len64_sbrc(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, T *bufIn, T *bufOut, T *R0, T *R1, T *R2, T *R3)
{
...
template <typename T, StrideBin sb,CallbackType cbtype>
__device__ void 
fwd_len64_sbrc_device(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *gbIn, T *gbOut, T *lds)
{
	T R0, R1, R2, R3;
	FwdPass0_len64_sbrc<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset,  gbIn, lds, &R0, &R1, &R2, &R3);
	__syncthreads();
	FwdPass1_len64_sbrc<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, &R0, &R1, &R2, &R3);
	__syncthreads();
	FwdPass2_len64_sbrc<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds,  gbOut, &R0, &R1, &R2, &R3);
	__syncthreads();
}

template <typename T, StrideBin sb,CallbackType cbtype>
__device__ void 
back_len64_sbrc_device(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *gbIn, T *gbOut, T *lds)
{
	T R0, R1, R2, R3;
	InvPass0_len64_sbrc<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset,  gbIn, lds, &R0, &R1, &R2, &R3);
	__syncthreads();
	InvPass1_len64_sbrc<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, &R0, &R1, &R2, &R3);
	__syncthreads();
	InvPass2_len64_sbrc<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds,  gbOut, &R0, &R1, &R2, &R3);
	__syncthreads();
}

template <typename T, StrideBin sb,CallbackType cbtype>
__device__ void 
fwd_len64_sbrc_device(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *gbIn, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *lds)
{
	T R0, R1, R2, R3;
	FwdPass0_len64_sbrc<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset,  gbIn, lds, &R0, &R1, &R2, &R3);
	__syncthreads();
	FwdPass1_len64_sbrc<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, &R0, &R1, &R2, &R3);
	__syncthreads();
	FwdPass2_len64_sbrc<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, bufOutRe, bufOutIm, &R0, &R1, &R2, &R3);
	__syncthreads();
}

template <typename T, StrideBin sb,CallbackType cbtype>
__device__ void 
back_len64_sbrc_device(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *gbIn, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *lds)
{
	T R0, R1, R2, R3;
	InvPass0_len64_sbrc<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset,  gbIn, lds, &R0, &R1, &R2, &R3);
	__syncthreads();
	InvPass1_len64_sbrc<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, &R0, &R1, &R2, &R3);
	__syncthreads();
	InvPass2_len64_sbrc<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, bufOutRe, bufOutIm, &R0, &R1, &R2, &R3);
	__syncthreads();
}

template <typename T, StrideBin sb,CallbackType cbtype>
__device__ void 
fwd_len64_sbrc_device(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, T *gbOut, T *lds)
{
	T R0, R1, R2, R3;
	FwdPass0_len64_sbrc<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset,  bufInRe, bufInIm, lds, &R0, &R1, &R2, &R3);
	__syncthreads();
	FwdPass1_len64_sbrc<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, &R0, &R1, &R2, &R3);
	__syncthreads();
	FwdPass2_len64_sbrc<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds,  gbOut, &R0, &R1, &R2, &R3);
...
template <typename T, StrideBin sb,CallbackType cbtype>
__device__ void 
back_len64_sbrc_device(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, T *gbOut, T *lds)
{
	T R0, R1, R2, R3;
	InvPass0_len64_sbrc<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset,  bufInRe, bufInIm, lds, &R0, &R1, &R2, &R3);
	__syncthreads();
	InvPass1_len64_sbrc<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, &R0, &R1, &R2, &R3);
	__syncthreads();
	InvPass2_len64_sbrc<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds,  gbOut, &R0, &R1, &R2, &R3);
...
template <typename T, StrideBin sb,CallbackType cbtype>
__device__ void 
fwd_len64_sbrc_device(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *lds)
{
	T R0, R1, R2, R3;
	FwdPass0_len64_sbrc<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset,  bufInRe, bufInIm, lds, &R0, &R1, &R2, &R3);
	__syncthreads();
...
template <typename T, StrideBin sb,CallbackType cbtype>
__device__ void 
back_len64_sbrc_device(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *lds)
{
	T R0, R1, R2, R3;
	InvPass0_len64_sbrc<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset,  bufInRe, bufInIm, lds, &R0, &R1, &R2, &R3);
	__syncthreads();
...
fft_fwd_op_len64_sbrc( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, T * __restrict__ gbIn, T * __restrict__ gbOut)
{
	...
	for(unsigned int t=0; t<8; t++) // generator.kernel.hpp:1477
	{
		...
		{
			R0 = load_cb(gbIn, iOffset + me % 64 * stride_in[0] + ((me /64 * 8) + t % 16)*stride_in[2] + t / 16 * 128 * stride_in[0], load_cb_data, nullptr);
		}
	...
	for(unsigned int t=0; t<2; t++) // generator.kernel.hpp:1669
	{
		...
		fwd_len64_sbrc_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  rw, b, me%16, t * (64 + lds_row_padding) * 8 + (me/16)*(64+ lds_row_padding), lds, lds, lds);
	...
	if (Tsbrc == SBRC_3D_FFT_ERC_TRANS_Z_XY)
	{
		...
		{
			post_process_interleaved_inplace<T, true,CallbackType::NONE>(me, 64 - me, 64, 32, &lds[r * (64 + lds_row_padding)], 0, &twiddles[64], nullptr, nullptr, 0, nullptr, nullptr);
		}
		__syncthreads();
	}
	...
	for(unsigned int t=0; t<8; t++) // generator.kernel.hpp:1800
	{
		...
		if(Tsbrc == SBRC_2D)
		{
			store_cb(gbOut, oOffset + (me%16) * stride_out[1] + (me/16)*stride_out[0] + t*stride_out[0]*8, R0, store_cb_data, nullptr );
		}
		else if(Tsbrc == SBRC_3D_FFT_TRANS_XY_Z)
		{
			store_cb(gbOut, oOffset + (me%16) * stride_out[0] + (me/16)*stride_out[1] + t*stride_out[1]*8, R0, store_cb_data, nullptr );
		}
		else if(Tsbrc == SBRC_3D_FFT_TRANS_Z_XY || Tsbrc == SBRC_3D_FFT_ERC_TRANS_Z_XY)
		{
			store_cb(gbOut, oOffset + (me%16) * stride_out[0] + (me/16)*stride_out[2] + t*stride_out[2]*8, R0, store_cb_data, nullptr );
		}
	}
...
fft_back_op_len64_sbrc( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, T * __restrict__ gbIn, T * __restrict__ gbOut)
{
	...
	for(unsigned int t=0; t<2; t++) // generator.kernel.hpp:1669
	{
		...
		// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
		// rw, b, me% control read/write; then ldsOffset, gb, lds
		back_len64_sbrc_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  rw, b, me%16, t * (64 + lds_row_padding) * 8 + (me/16)*(64+ lds_row_padding), lds, lds, lds);
...
fft_fwd_op_len64_sbrc( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, T * __restrict__ gbIn, real_type_t<T> * __restrict__ gbOutRe, real_type_t<T> * __restrict__ gbOutIm)
{
	...
	for(unsigned int t=0; t<8; t++) // generator.kernel.hpp:1800
	{
		...
		if(Tsbrc == SBRC_2D)
		{
			gbOutRe[oOffset + (me%16) * stride_out[1] + (me/16)*stride_out[0] + t*stride_out[0]*8] = R0.x;
			gbOutIm[oOffset + (me%16) * stride_out[1] + (me/16)*stride_out[0] + t*stride_out[0]*8] = R0.y;
		}
		else if(Tsbrc == SBRC_3D_FFT_TRANS_XY_Z)
		{
			gbOutRe[oOffset + (me%16) * stride_out[0] + (me/16)*stride_out[1] + t*stride_out[1]*8] = R0.x;
			gbOutIm[oOffset + (me%16) * stride_out[0] + (me/16)*stride_out[1] + t*stride_out[1]*8] = R0.y;
		}
		else if(Tsbrc == SBRC_3D_FFT_TRANS_Z_XY || Tsbrc == SBRC_3D_FFT_ERC_TRANS_Z_XY)
		{
			gbOutRe[oOffset + (me%16) * stride_out[0] + (me/16)*stride_out[2] + t*stride_out[2]*8] = R0.x;
			gbOutIm[oOffset + (me%16) * stride_out[0] + (me/16)*stride_out[2] + t*stride_out[2]*8] = R0.y;
		}
	}
...
fft_fwd_op_len64_sbrc( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, real_type_t<T> * __restrict__ gbInRe, real_type_t<T> * __restrict__ gbInIm, T * __restrict__ gbOut)
{
	...
	for(unsigned int t=0; t<8; t++) // generator.kernel.hpp:1477
	{
		...
		{
			R0.x = gbInRe[iOffset + me % 64 * stride_in[0] + ((me /64 * 8) + t % 16)*stride_in[2] + t / 16 * 128 * stride_in[0]];
			R0.y = gbInIm[iOffset + me % 64 * stride_in[0] + ((me /64 * 8) + t % 16)*stride_in[2] + t / 16 * 128 * stride_in[0]];
		}
