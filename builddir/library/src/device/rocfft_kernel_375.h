...
FwdPass0_len375(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, T *bufIn, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14)
{
	...
	(*R6) = bufIn[inOffset + ( 0 + me*3 + 1 + 75 )*stride_in];
	(*R11) = bufIn[inOffset + ( 0 + me*3 + 2 + 75 )*stride_in];
	(*R2) = bufIn[inOffset + ( 0 + me*3 + 0 + 150 )*stride_in];
	(*R7) = bufIn[inOffset + ( 0 + me*3 + 1 + 150 )*stride_in];
	(*R12) = bufIn[inOffset + ( 0 + me*3 + 2 + 150 )*stride_in];
	(*R3) = bufIn[inOffset + ( 0 + me*3 + 0 + 225 )*stride_in];
	(*R8) = bufIn[inOffset + ( 0 + me*3 + 1 + 225 )*stride_in];
	(*R13) = bufIn[inOffset + ( 0 + me*3 + 2 + 225 )*stride_in];
	(*R4) = bufIn[inOffset + ( 0 + me*3 + 0 + 300 )*stride_in];
	(*R9) = bufIn[inOffset + ( 0 + me*3 + 1 + 300 )*stride_in];
	(*R14) = bufIn[inOffset + ( 0 + me*3 + 2 + 300 )*stride_in];
	}
	...
	(*R1).x = bufOutRe[outOffset + ( 0 + me*3 + 0 + 75 ) ];
	(*R6).x = bufOutRe[outOffset + ( 0 + me*3 + 1 + 75 ) ];
	(*R11).x = bufOutRe[outOffset + ( 0 + me*3 + 2 + 75 ) ];
	(*R2).x = bufOutRe[outOffset + ( 0 + me*3 + 0 + 150 ) ];
	(*R7).x = bufOutRe[outOffset + ( 0 + me*3 + 1 + 150 ) ];
	(*R12).x = bufOutRe[outOffset + ( 0 + me*3 + 2 + 150 ) ];
	(*R3).x = bufOutRe[outOffset + ( 0 + me*3 + 0 + 225 ) ];
	(*R8).x = bufOutRe[outOffset + ( 0 + me*3 + 1 + 225 ) ];
	(*R13).x = bufOutRe[outOffset + ( 0 + me*3 + 2 + 225 ) ];
	(*R4).x = bufOutRe[outOffset + ( 0 + me*3 + 0 + 300 ) ];
	(*R9).x = bufOutRe[outOffset + ( 0 + me*3 + 1 + 300 ) ];
	(*R14).x = bufOutRe[outOffset + ( 0 + me*3 + 2 + 300 ) ];
	}
	...
	(*R1).y = bufOutIm[outOffset + ( 0 + me*3 + 0 + 75 ) ];
	(*R6).y = bufOutIm[outOffset + ( 0 + me*3 + 1 + 75 ) ];
	(*R11).y = bufOutIm[outOffset + ( 0 + me*3 + 2 + 75 ) ];
	(*R2).y = bufOutIm[outOffset + ( 0 + me*3 + 0 + 150 ) ];
	(*R7).y = bufOutIm[outOffset + ( 0 + me*3 + 1 + 150 ) ];
	(*R12).y = bufOutIm[outOffset + ( 0 + me*3 + 2 + 150 ) ];
	(*R3).y = bufOutIm[outOffset + ( 0 + me*3 + 0 + 225 ) ];
	(*R8).y = bufOutIm[outOffset + ( 0 + me*3 + 1 + 225 ) ];
	(*R13).y = bufOutIm[outOffset + ( 0 + me*3 + 2 + 225 ) ];
	(*R4).y = bufOutIm[outOffset + ( 0 + me*3 + 0 + 300 ) ];
	(*R9).y = bufOutIm[outOffset + ( 0 + me*3 + 1 + 300 ) ];
	(*R14).y = bufOutIm[outOffset + ( 0 + me*3 + 2 + 300 ) ];
	}
...
FwdPass0_len375(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14)
{
	...
	(*R6).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 75 )*stride_in];
	(*R6).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 75 )*stride_in];
	(*R11).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 75 )*stride_in];
	(*R11).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 75 )*stride_in];
	(*R2).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 150 )*stride_in];
	(*R2).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 150 )*stride_in];
	(*R7).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 150 )*stride_in];
	(*R7).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 150 )*stride_in];
	(*R12).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 150 )*stride_in];
	(*R12).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 150 )*stride_in];
	(*R3).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 225 )*stride_in];
	(*R3).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 225 )*stride_in];
	(*R8).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 225 )*stride_in];
	(*R8).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 225 )*stride_in];
	(*R13).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 225 )*stride_in];
	(*R13).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 225 )*stride_in];
	(*R4).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 300 )*stride_in];
	(*R4).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 300 )*stride_in];
	(*R9).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 300 )*stride_in];
	(*R9).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 300 )*stride_in];
	(*R14).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 300 )*stride_in];
	(*R14).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 300 )*stride_in];
	}
...
template <typename T, StrideBin sb>
__device__ void
FwdPass1_len375(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14)
{
...
template <typename T, StrideBin sb>
__device__ void
FwdPass2_len375(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14)
{
	...
	(*R1).x = bufOutRe[outOffset + ( 0 + me*5 + 0 + 125 ) ];
	(*R4).x = bufOutRe[outOffset + ( 0 + me*5 + 1 + 125 ) ];
	(*R7).x = bufOutRe[outOffset + ( 0 + me*5 + 2 + 125 ) ];
	(*R10).x = bufOutRe[outOffset + ( 0 + me*5 + 3 + 125 ) ];
	(*R13).x = bufOutRe[outOffset + ( 0 + me*5 + 4 + 125 ) ];
	(*R2).x = bufOutRe[outOffset + ( 0 + me*5 + 0 + 250 ) ];
	(*R5).x = bufOutRe[outOffset + ( 0 + me*5 + 1 + 250 ) ];
	(*R8).x = bufOutRe[outOffset + ( 0 + me*5 + 2 + 250 ) ];
	(*R11).x = bufOutRe[outOffset + ( 0 + me*5 + 3 + 250 ) ];
	(*R14).x = bufOutRe[outOffset + ( 0 + me*5 + 4 + 250 ) ];
	}
	...
	(*R1).y = bufOutIm[outOffset + ( 0 + me*5 + 0 + 125 ) ];
	(*R4).y = bufOutIm[outOffset + ( 0 + me*5 + 1 + 125 ) ];
	(*R7).y = bufOutIm[outOffset + ( 0 + me*5 + 2 + 125 ) ];
	(*R10).y = bufOutIm[outOffset + ( 0 + me*5 + 3 + 125 ) ];
	(*R13).y = bufOutIm[outOffset + ( 0 + me*5 + 4 + 125 ) ];
	(*R2).y = bufOutIm[outOffset + ( 0 + me*5 + 0 + 250 ) ];
	(*R5).y = bufOutIm[outOffset + ( 0 + me*5 + 1 + 250 ) ];
	(*R8).y = bufOutIm[outOffset + ( 0 + me*5 + 2 + 250 ) ];
	(*R11).y = bufOutIm[outOffset + ( 0 + me*5 + 3 + 250 ) ];
	(*R14).y = bufOutIm[outOffset + ( 0 + me*5 + 4 + 250 ) ];
	}
...
FwdPass3_len375(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, T *bufOut, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14)
{
	...
	bufOut[outOffset + ( 5*me + 0 + 125 )*stride_out] = (*R1);
	bufOut[outOffset + ( 5*me + 1 + 125 )*stride_out] = (*R4);
	bufOut[outOffset + ( 5*me + 2 + 125 )*stride_out] = (*R7);
	bufOut[outOffset + ( 5*me + 3 + 125 )*stride_out] = (*R10);
	bufOut[outOffset + ( 5*me + 4 + 125 )*stride_out] = (*R13);
	bufOut[outOffset + ( 5*me + 0 + 250 )*stride_out] = (*R2);
	bufOut[outOffset + ( 5*me + 1 + 250 )*stride_out] = (*R5);
	bufOut[outOffset + ( 5*me + 2 + 250 )*stride_out] = (*R8);
	bufOut[outOffset + ( 5*me + 3 + 250 )*stride_out] = (*R11);
	bufOut[outOffset + ( 5*me + 4 + 250 )*stride_out] = (*R14);
	}
...
FwdPass3_len375(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14)
{
	...
	bufOutRe[outOffset + ( 5*me + 0 + 125 )*stride_out] = (*R1).x;
	bufOutIm[outOffset + ( 5*me + 0 + 125 )*stride_out] = (*R1).y;
	bufOutRe[outOffset + ( 5*me + 1 + 125 )*stride_out] = (*R4).x;
	bufOutIm[outOffset + ( 5*me + 1 + 125 )*stride_out] = (*R4).y;
	bufOutRe[outOffset + ( 5*me + 2 + 125 )*stride_out] = (*R7).x;
	bufOutIm[outOffset + ( 5*me + 2 + 125 )*stride_out] = (*R7).y;
	bufOutRe[outOffset + ( 5*me + 3 + 125 )*stride_out] = (*R10).x;
	bufOutIm[outOffset + ( 5*me + 3 + 125 )*stride_out] = (*R10).y;
	bufOutRe[outOffset + ( 5*me + 4 + 125 )*stride_out] = (*R13).x;
	bufOutIm[outOffset + ( 5*me + 4 + 125 )*stride_out] = (*R13).y;
	bufOutRe[outOffset + ( 5*me + 0 + 250 )*stride_out] = (*R2).x;
	bufOutIm[outOffset + ( 5*me + 0 + 250 )*stride_out] = (*R2).y;
	bufOutRe[outOffset + ( 5*me + 1 + 250 )*stride_out] = (*R5).x;
	bufOutIm[outOffset + ( 5*me + 1 + 250 )*stride_out] = (*R5).y;
	bufOutRe[outOffset + ( 5*me + 2 + 250 )*stride_out] = (*R8).x;
	bufOutIm[outOffset + ( 5*me + 2 + 250 )*stride_out] = (*R8).y;
	bufOutRe[outOffset + ( 5*me + 3 + 250 )*stride_out] = (*R11).x;
	bufOutIm[outOffset + ( 5*me + 3 + 250 )*stride_out] = (*R11).y;
	bufOutRe[outOffset + ( 5*me + 4 + 250 )*stride_out] = (*R14).x;
	bufOutIm[outOffset + ( 5*me + 4 + 250 )*stride_out] = (*R14).y;
	}
...
template <typename T, StrideBin sb>
__device__ void
InvPass0_len375(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, T *bufIn, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14)
{
...
template <typename T, StrideBin sb>
__device__ void
InvPass1_len375(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14)
{
...
template <typename T, StrideBin sb>
__device__ void
InvPass3_len375(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, T *bufOut, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14)
{
...
template <typename T, StrideBin sb>
__device__ void 
fwd_len375_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *lwbIn, T *lwbOut, real_type_t<T> *lds)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14;
	FwdPass0_len375<T, sb>(twiddles, stride_in, stride_out, rw, b, me, 0, ldsOffset,  lwbIn, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14);
	FwdPass1_len375<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14);
	FwdPass2_len375<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14);
	FwdPass3_len375<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, 0, lds, lds,  lwbOut, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14);
}

template <typename T, StrideBin sb>
__device__ void 
back_len375_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *lwbIn, T *lwbOut, real_type_t<T> *lds)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14;
	InvPass0_len375<T, sb>(twiddles, stride_in, stride_out, rw, b, me, 0, ldsOffset,  lwbIn, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14);
	InvPass1_len375<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14);
	InvPass2_len375<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14);
	InvPass3_len375<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, 0, lds, lds,  lwbOut, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14);
}

template <typename T, StrideBin sb>
__device__ void 
fwd_len375_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *lwbIn, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, real_type_t<T> *lds)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14;
	FwdPass0_len375<T, sb>(twiddles, stride_in, stride_out, rw, b, me, 0, ldsOffset,  lwbIn, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14);
	FwdPass1_len375<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14);
	FwdPass2_len375<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14);
	FwdPass3_len375<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, 0, lds, lds, bufOutRe, bufOutIm, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14);
}

template <typename T, StrideBin sb>
__device__ void 
back_len375_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *lwbIn, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, real_type_t<T> *lds)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14;
	InvPass0_len375<T, sb>(twiddles, stride_in, stride_out, rw, b, me, 0, ldsOffset,  lwbIn, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14);
	InvPass1_len375<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14);
	InvPass2_len375<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14);
	InvPass3_len375<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, 0, lds, lds, bufOutRe, bufOutIm, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14);
}

template <typename T, StrideBin sb>
__device__ void 
fwd_len375_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, T *lwbOut, real_type_t<T> *lds)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14;
	FwdPass0_len375<T, sb>(twiddles, stride_in, stride_out, rw, b, me, 0, ldsOffset,  bufInRe, bufInIm, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14);
	FwdPass1_len375<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14);
	FwdPass2_len375<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14);
	FwdPass3_len375<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, 0, lds, lds,  lwbOut, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14);
}
...
template <typename T, StrideBin sb>
__device__ void 
back_len375_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, T *lwbOut, real_type_t<T> *lds)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14;
	InvPass0_len375<T, sb>(twiddles, stride_in, stride_out, rw, b, me, 0, ldsOffset,  bufInRe, bufInIm, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14);
	InvPass1_len375<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14);
	InvPass2_len375<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14);
	InvPass3_len375<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, 0, lds, lds,  lwbOut, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14);
}
...
template <typename T, StrideBin sb>
__device__ void 
fwd_len375_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, real_type_t<T> *lds)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14;
	FwdPass0_len375<T, sb>(twiddles, stride_in, stride_out, rw, b, me, 0, ldsOffset,  bufInRe, bufInIm, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14);
	FwdPass1_len375<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14);
...
template <typename T, StrideBin sb>
__device__ void 
back_len375_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, real_type_t<T> *lds)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14;
	InvPass0_len375<T, sb>(twiddles, stride_in, stride_out, rw, b, me, 0, ldsOffset,  bufInRe, bufInIm, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14);
	InvPass1_len375<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14);
...
////////////////////////////////////////Global kernels
//Kernel configuration: number of threads per thread block: 125, maximum transforms: 5, Passes: 4
template <typename T, StrideBin sb>
__global__ void
__launch_bounds__(125)
fft_fwd_ip_len375( cl::sycl::range<3> blocks, cl::sycl::range<3> threads, cl::sycl::queue rocfftQueue, cl::sycl::buffer<T, 1> twiddles_GB, const size_t dim, cl::sycl::buffer<size_t, 1> *lengths_GB, cl::sycl::buffer<size_t, 1> *stride_in_GB, const size_t batch_count, cl::sycl::buffer<T, 1> gb_GB)
{
rocfftQueue.submit([&](cl::sycl::handler &cgh)
{
	...
	cl::sycl::accessor<real_type_t<T>,1,sycl::access::mode::read_write,sycl::access::target::local> lds(cl::sycl::range<1>(1875), cgh);
	cgh.parallel_for<class kern_fft_fwd_ip_len375>(
...
//// Print kernel code here (after function prototype)
	...
	fwd_len375_device<T, sb>(twiddles, stride_in[0], stride_in[0],  rw, b, me%25, (me/25)*375, lwb, lwb, lds);
});
});
}
...
__global__ void
__launch_bounds__(125)
fft_back_ip_len375( cl::sycl::range<3> blocks, cl::sycl::range<3> threads, cl::sycl::queue rocfftQueue, cl::sycl::buffer<T, 1> twiddles_GB, const size_t dim, cl::sycl::buffer<size_t, 1> *lengths_GB, cl::sycl::buffer<size_t, 1> *stride_in_GB, const size_t batch_count, cl::sycl::buffer<T, 1> gb_GB)
{
rocfftQueue.submit([&](cl::sycl::handler &cgh)
{
	auto twiddles = twiddles_GB.get_access<cl::sycl::access::mode::read>(cgh);
	...
	auto gb = gb_GB.get_access<cl::sycl::access::mode::read_write>(cgh);
	cl::sycl::accessor<real_type_t<T>,1,sycl::access::mode::read_write,sycl::access::target::local> lds(cl::sycl::range<1>(1875), cgh);
	cgh.parallel_for<class kern_fft_back_ip_len375>(
	                   cl::sycl::nd_range<3>(blocks, threads),
	                   [=](cl::sycl::nd_item<3> wItem)
{
//// Print kernel code here (after function prototype)
	...
	// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, lwb, lds
	back_len375_device<T, sb>(twiddles, stride_in[0], stride_in[0],  rw, b, me%25, (me/25)*375, lwb, lwb, lds);
});
});
}
...
//// Print kernel code here (after function prototype)
	...
	// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, lwb, lds
	fwd_len375_device<T, sb>(twiddles, stride_in[0], stride_in[0],  rw, b, me%25, (me/25)*375, lwbRe, lwbIm, lwbRe, lwbIm, lds);
});
});
}
...
__global__ void
__launch_bounds__(125)
fft_back_ip_len375( cl::sycl::range<3> blocks, cl::sycl::range<3> threads, cl::sycl::queue rocfftQueue, cl::sycl::buffer<T, 1> twiddles_GB, const size_t dim, cl::sycl::buffer<size_t, 1> *lengths_GB, cl::sycl::buffer<size_t, 1> *stride_in_GB, const size_t batch_count, cl::sycl::buffer<real_type_t<T>, 1> gbRe_GB, cl::sycl::buffer<real_type_t<T>, 1> gbIm_GB)
{
rocfftQueue.submit([&](cl::sycl::handler &cgh)
{
	auto twiddles = twiddles_GB.get_access<cl::sycl::access::mode::read>(cgh);
...
//// Print kernel code here (after function prototype)
	...
	// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, lwb, lds
	back_len375_device<T, sb>(twiddles, stride_in[0], stride_in[0],  rw, b, me%25, (me/25)*375, lwbRe, lwbIm, lwbRe, lwbIm, lds);
});
});
}
...
rocfftQueue.submit([&](cl::sycl::handler &cgh)
{
	...
	cl::sycl::accessor<real_type_t<T>,1,sycl::access::mode::read_write,sycl::access::target::local> lds(cl::sycl::range<1>(1875), cgh);
	cgh.parallel_for<class kern_fft_fwd_op_len375>(
	                   cl::sycl::nd_range<3>(blocks, threads),
	                   [=](cl::sycl::nd_item<3> wItem)
{
//// Print kernel code here (after function prototype)
	...
	// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, lwb, lds
	fwd_len375_device<T, sb>(twiddles, stride_in[0], stride_out[0],  rw, b, me%25, (me/25)*375, lwbIn, lwbOut, lds);
});
});
}
...
__global__ void
__launch_bounds__(125)
fft_back_op_len375( cl::sycl::range<3> blocks, cl::sycl::range<3> threads, cl::sycl::queue rocfftQueue, cl::sycl::buffer<T, 1> twiddles_GB, const size_t dim, cl::sycl::buffer<size_t, 1> *lengths_GB, cl::sycl::buffer<size_t, 1> *stride_in_GB, cl::sycl::buffer<size_t, 1> *stride_out_GB, const size_t batch_count, cl::sycl::buffer<T, 1> gbIn_GB, cl::sycl::buffer<T, 1> gbOut_GB)
{
rocfftQueue.submit([&](cl::sycl::handler &cgh)
{
	auto twiddles = twiddles_GB.get_access<cl::sycl::access::mode::read>(cgh);
	...
	auto gbOut = gbOut_GB.get_access<cl::sycl::access::mode::read_write>(cgh);
	cl::sycl::accessor<real_type_t<T>,1,sycl::access::mode::read_write,sycl::access::target::local> lds(cl::sycl::range<1>(1875), cgh);
	cgh.parallel_for<class kern_fft_back_op_len375>(
	                   cl::sycl::nd_range<3>(blocks, threads),
	                   [=](cl::sycl::nd_item<3> wItem)
{
//// Print kernel code here (after function prototype)
	...
	// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, lwb, lds
	back_len375_device<T, sb>(twiddles, stride_in[0], stride_out[0],  rw, b, me%25, (me/25)*375, lwbIn, lwbOut, lds);
});
});
}
...
//// Print kernel code here (after function prototype)
	...
	// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, lwb, lds
	fwd_len375_device<T, sb>(twiddles, stride_in[0], stride_out[0],  rw, b, me%25, (me/25)*375, lwbIn, lwbOutRe, lwbOutIm, lds);
});
});
}
...
//// Print kernel code here (after function prototype)
	...
	// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, lwb, lds
	back_len375_device<T, sb>(twiddles, stride_in[0], stride_out[0],  rw, b, me%25, (me/25)*375, lwbIn, lwbOutRe, lwbOutIm, lds);
});
});
}
...
//// Print kernel code here (after function prototype)
	...
	// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, lwb, lds
	fwd_len375_device<T, sb>(twiddles, stride_in[0], stride_out[0],  rw, b, me%25, (me/25)*375, lwbInRe, lwbInIm, lwbOut, lds);
});
});
}
...
//// Print kernel code here (after function prototype)
	...
	// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, lwb, lds
	back_len375_device<T, sb>(twiddles, stride_in[0], stride_out[0],  rw, b, me%25, (me/25)*375, lwbInRe, lwbInIm, lwbOut, lds);
});
});
}
...
//// Print kernel code here (after function prototype)
	...
	// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, lwb, lds
	fwd_len375_device<T, sb>(twiddles, stride_in[0], stride_out[0],  rw, b, me%25, (me/25)*375, lwbInRe, lwbInIm, lwbOutRe, lwbOutIm, lds);
});
});
}
...
//// Print kernel code here (after function prototype)
	...
	// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, lwb, lds
	back_len375_device<T, sb>(twiddles, stride_in[0], stride_out[0],  rw, b, me%25, (me/25)*375, lwbInRe, lwbInIm, lwbOutRe, lwbOutIm, lds);
});
});
}
