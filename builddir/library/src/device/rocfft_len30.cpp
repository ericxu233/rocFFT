 ...
 * Kernel is: namespace(factors=[10, 3], flavour='uwide', length=30, scheme='CS_KERNEL_STOCKHAM', threads_per_block=256)
 */
...
__device__ void ip_forward_length30_SBRR_device(scalar_type* __restrict__ lds,
                                                ...
                                                bool         write)
{
    ...
    R[7] = lds[offset_lds + (thread + 21) * lstride]; /* stockham.py:542 */
    R[8] = lds[offset_lds + (thread + 24) * lstride]; /* stockham.py:542 */
    R[9] = lds[offset_lds + (thread + 27) * lstride]; /* stockham.py:542 */
    ...
    if(write)
    {
        lds[offset_lds + ((thread / 10) * 30 + thread % 10 + 0) * lstride]
            = R[0]; /* stockham.py:577 */
        lds[offset_lds + ((thread / 10) * 30 + thread % 10 + 10) * lstride]
            = R[1]; /* stockham.py:577 */
        lds[offset_lds + ((thread / 10) * 30 + thread % 10 + 20) * lstride]
            = R[2]; /* stockham.py:577 */
    }
}
/* stockham.py:709 */
...
__global__
    __launch_bounds__(250) void ip_forward_length30_SBRR(const scalar_type* __restrict__ twiddles,
                                                         const size_t dim,
                                                         ...
                                                         scalar_type* __restrict__ buf)
{
    ...
    transform = blockIdx.x * 25 + threadIdx.x / 10; /* stockham.py:363 */
    ...
    offset_lds = (30 + lds_padding) * (transform % 25); /* stockham.py:373 */
    ...
    if(ebtype == EmbeddedType::C2Real_PRE)
    {
        ...
        real_pre_process_kernel_inplace<scalar_type, true>(thread % 15 + 0,
                                                           30 - thread % 15 - 0,
                                                           15,
                                                           &lds[offset_lds],
                                                           0,
                                                           &twiddles[30]); /* stockham.py:338 */

        real_pre_process_kernel_inplace<scalar_type, true>(thread % 15 + 10,
                                                           30 - thread % 15 - 10,
                                                           15,
                                                           &lds[offset_lds],
                                                           0,
    ...
    ip_forward_length30_SBRR_device<scalar_type, SB_UNIT>(
    ...
    if(ebtype == EmbeddedType::Real2C_POST)
    {
        ...
        real_post_process_kernel_inplace<scalar_type, true>(thread % 15 + 0,
                                                            30 - thread % 15 - 0,
                                                            15,
                                                            &lds[offset_lds],
                                                            0,
        ...
        real_post_process_kernel_inplace<scalar_type, true>(thread % 15 + 10,
                                                            30 - thread % 15 - 10,
                                                            15,
                                                            &lds[offset_lds],
                                                            0,
...
/* stockham.py:709 */
template <typename scalar_type, StrideBin sb, EmbeddedType ebtype, CallbackType cbtype>
__global__ __launch_bounds__(250) void ip_forward_length30_SBRR(
    const scalar_type* __restrict__ twiddles,
    const size_t dim,
    const size_t* __restrict__ lengths,
    const size_t* __restrict__ stride,
...
/* stockham.py:765 */
template <typename scalar_type, StrideBin sb>
__device__ void op_forward_length30_SBRR_device(scalar_type* __restrict__ lds,
                                                const scalar_type* __restrict__ twiddles,
                                                size_t       stride_lds,
                                                unsigned int offset_lds,
                                                bool         write)
...
template <typename scalar_type, StrideBin sb, EmbeddedType ebtype, CallbackType cbtype>
__global__
    __launch_bounds__(250) void op_forward_length30_SBRR(const scalar_type* __restrict__ twiddles,
                                                         const size_t dim,
                                                         const size_t* __restrict__ lengths,
                                                         ...
                                                         scalar_type* __restrict__ buf_out)
{
    ...
    // transform
    write = true; /* stockham.py:681 */
    op_forward_length30_SBRR_device<scalar_type, SB_UNIT>(
        lds, twiddles, stride_lds, offset_lds, write); /* stockham.py:686 */
...
/* stockham.py:709 */
template <typename scalar_type, StrideBin sb, EmbeddedType ebtype, CallbackType cbtype>
__global__ __launch_bounds__(250) void op_forward_length30_SBRR(
    const scalar_type* __restrict__ twiddles,
    const size_t dim,
    const size_t* __restrict__ lengths,
    const size_t* __restrict__ stride_in,
...
/* stockham.py:765 */
template <typename scalar_type, StrideBin sb>
__device__ void ip_inverse_length30_SBRR_device(scalar_type* __restrict__ lds,
                                                const scalar_type* __restrict__ twiddles,
                                                size_t       stride_lds,
                                                unsigned int offset_lds,
                                                bool         write)
{
    ...
    W    = {twiddles[9 + 2 * (thread % 10)].x,
         -twiddles[9 + 2 * (thread % 10)].y}; /* generator.py:1065 */
    t.x  = W.x * R[1].x - W.y * R[1].y; /* stockham.py:555 */
    t.y  = W.y * R[1].x + W.x * R[1].y; /* stockham.py:556 */
    R[1] = t; /* stockham.py:557 */
    W    = {twiddles[10 + 2 * (thread % 10)].x,
         -twiddles[10 + 2 * (thread % 10)].y}; /* generator.py:1065 */
    t.x  = W.x * R[2].x - W.y * R[2].y; /* stockham.py:555 */
    t.y  = W.y * R[2].x + W.x * R[2].y; /* stockham.py:556 */
    R[2] = t; /* stockham.py:557 */
...
template <typename scalar_type, StrideBin sb, EmbeddedType ebtype, CallbackType cbtype>
__global__
    __launch_bounds__(250) void ip_inverse_length30_SBRR(const scalar_type* __restrict__ twiddles,
                                                         const size_t dim,
                                                         const size_t* __restrict__ lengths,
                                                         const size_t* __restrict__ stride,
                                                         const size_t       nbatch,
                                                         ...
                                                         scalar_type* __restrict__ buf)
{
    ...
    // transform
    write = true; /* stockham.py:681 */
    ip_inverse_length30_SBRR_device<scalar_type, SB_UNIT>(
        lds, twiddles, stride_lds, offset_lds, write); /* stockham.py:686 */
...
/* stockham.py:709 */
template <typename scalar_type, StrideBin sb, EmbeddedType ebtype, CallbackType cbtype>
__global__ __launch_bounds__(250) void ip_inverse_length30_SBRR(
    const scalar_type* __restrict__ twiddles,
    const size_t dim,
    const size_t* __restrict__ lengths,
    const size_t* __restrict__ stride,
...
/* stockham.py:765 */
template <typename scalar_type, StrideBin sb>
__device__ void op_inverse_length30_SBRR_device(scalar_type* __restrict__ lds,
                                                const scalar_type* __restrict__ twiddles,
                                                size_t       stride_lds,
                                                unsigned int offset_lds,
                                                bool         write)
...
template <typename scalar_type, StrideBin sb, EmbeddedType ebtype, CallbackType cbtype>
__global__
    __launch_bounds__(250) void op_inverse_length30_SBRR(const scalar_type* __restrict__ twiddles,
                                                         const size_t dim,
                                                         const size_t* __restrict__ lengths,
                                                         const size_t* __restrict__ stride_in,
                                                         const size_t* __restrict__ stride_out,
                                                         ...
                                                         scalar_type* __restrict__ buf_out)
{
    ...
    // transform
    write = true; /* stockham.py:681 */
    op_inverse_length30_SBRR_device<scalar_type, SB_UNIT>(
        lds, twiddles, stride_lds, offset_lds, write); /* stockham.py:686 */
...
/* stockham.py:709 */
template <typename scalar_type, StrideBin sb, EmbeddedType ebtype, CallbackType cbtype>
__global__ __launch_bounds__(250) void op_inverse_length30_SBRR(
    const scalar_type* __restrict__ twiddles,
    const size_t dim,
    const size_t* __restrict__ lengths,
    const size_t* __restrict__ stride_in,
...
POWX_SMALL_GENERATOR(rocfft_internal_dfn_dp_ci_ci_stoc_30,
                     ip_forward_length30_SBRR,
                     ip_inverse_length30_SBRR,
                     op_forward_length30_SBRR,
                     op_inverse_length30_SBRR,
                     double2);
POWX_SMALL_GENERATOR(rocfft_internal_dfn_sp_ci_ci_stoc_30,
                     ip_forward_length30_SBRR,
                     ip_inverse_length30_SBRR,
                     op_forward_length30_SBRR,
                     op_inverse_length30_SBRR,
