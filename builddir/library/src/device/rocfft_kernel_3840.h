...
FwdPass0_len3840(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, T *bufIn, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data)
{
	...
	(*R1) = load_cb(bufIn, inOffset + ( 0 + me*3 + 0 + 384 )*stride_in, load_cb_data, nullptr);

	(*R11) = load_cb(bufIn, inOffset + ( 0 + me*3 + 1 + 384 )*stride_in, load_cb_data, nullptr);

	(*R21) = load_cb(bufIn, inOffset + ( 0 + me*3 + 2 + 384 )*stride_in, load_cb_data, nullptr);

	(*R2) = load_cb(bufIn, inOffset + ( 0 + me*3 + 0 + 768 )*stride_in, load_cb_data, nullptr);

	(*R12) = load_cb(bufIn, inOffset + ( 0 + me*3 + 1 + 768 )*stride_in, load_cb_data, nullptr);

	(*R22) = load_cb(bufIn, inOffset + ( 0 + me*3 + 2 + 768 )*stride_in, load_cb_data, nullptr);

	(*R3) = load_cb(bufIn, inOffset + ( 0 + me*3 + 0 + 1152 )*stride_in, load_cb_data, nullptr);

	(*R13) = load_cb(bufIn, inOffset + ( 0 + me*3 + 1 + 1152 )*stride_in, load_cb_data, nullptr);

	(*R23) = load_cb(bufIn, inOffset + ( 0 + me*3 + 2 + 1152 )*stride_in, load_cb_data, nullptr);

	(*R4) = load_cb(bufIn, inOffset + ( 0 + me*3 + 0 + 1536 )*stride_in, load_cb_data, nullptr);

	(*R14) = load_cb(bufIn, inOffset + ( 0 + me*3 + 1 + 1536 )*stride_in, load_cb_data, nullptr);

	(*R24) = load_cb(bufIn, inOffset + ( 0 + me*3 + 2 + 1536 )*stride_in, load_cb_data, nullptr);

	(*R5) = load_cb(bufIn, inOffset + ( 0 + me*3 + 0 + 1920 )*stride_in, load_cb_data, nullptr);

	(*R15) = load_cb(bufIn, inOffset + ( 0 + me*3 + 1 + 1920 )*stride_in, load_cb_data, nullptr);

	(*R25) = load_cb(bufIn, inOffset + ( 0 + me*3 + 2 + 1920 )*stride_in, load_cb_data, nullptr);

	(*R6) = load_cb(bufIn, inOffset + ( 0 + me*3 + 0 + 2304 )*stride_in, load_cb_data, nullptr);

	(*R16) = load_cb(bufIn, inOffset + ( 0 + me*3 + 1 + 2304 )*stride_in, load_cb_data, nullptr);

	(*R26) = load_cb(bufIn, inOffset + ( 0 + me*3 + 2 + 2304 )*stride_in, load_cb_data, nullptr);

	(*R7) = load_cb(bufIn, inOffset + ( 0 + me*3 + 0 + 2688 )*stride_in, load_cb_data, nullptr);

	(*R17) = load_cb(bufIn, inOffset + ( 0 + me*3 + 1 + 2688 )*stride_in, load_cb_data, nullptr);

	(*R27) = load_cb(bufIn, inOffset + ( 0 + me*3 + 2 + 2688 )*stride_in, load_cb_data, nullptr);

	(*R8) = load_cb(bufIn, inOffset + ( 0 + me*3 + 0 + 3072 )*stride_in, load_cb_data, nullptr);

	(*R18) = load_cb(bufIn, inOffset + ( 0 + me*3 + 1 + 3072 )*stride_in, load_cb_data, nullptr);

	(*R28) = load_cb(bufIn, inOffset + ( 0 + me*3 + 2 + 3072 )*stride_in, load_cb_data, nullptr);

	(*R9) = load_cb(bufIn, inOffset + ( 0 + me*3 + 0 + 3456 )*stride_in, load_cb_data, nullptr);

	(*R19) = load_cb(bufIn, inOffset + ( 0 + me*3 + 1 + 3456 )*stride_in, load_cb_data, nullptr);

	(*R29) = load_cb(bufIn, inOffset + ( 0 + me*3 + 2 + 3456 )*stride_in, load_cb_data, nullptr);
	...
	(*R7).x = bufOutRe[outOffset + ( 0 + me*5 + 1 + 640 ) ];
	(*R13).x = bufOutRe[outOffset + ( 0 + me*5 + 2 + 640 ) ];
	(*R19).x = bufOutRe[outOffset + ( 0 + me*5 + 3 + 640 ) ];
	(*R25).x = bufOutRe[outOffset + ( 0 + me*5 + 4 + 640 ) ];
	(*R2).x = bufOutRe[outOffset + ( 0 + me*5 + 0 + 1280 ) ];
	(*R8).x = bufOutRe[outOffset + ( 0 + me*5 + 1 + 1280 ) ];
	(*R14).x = bufOutRe[outOffset + ( 0 + me*5 + 2 + 1280 ) ];
	(*R20).x = bufOutRe[outOffset + ( 0 + me*5 + 3 + 1280 ) ];
	(*R26).x = bufOutRe[outOffset + ( 0 + me*5 + 4 + 1280 ) ];
	(*R3).x = bufOutRe[outOffset + ( 0 + me*5 + 0 + 1920 ) ];
	(*R9).x = bufOutRe[outOffset + ( 0 + me*5 + 1 + 1920 ) ];
	(*R15).x = bufOutRe[outOffset + ( 0 + me*5 + 2 + 1920 ) ];
	(*R21).x = bufOutRe[outOffset + ( 0 + me*5 + 3 + 1920 ) ];
	(*R27).x = bufOutRe[outOffset + ( 0 + me*5 + 4 + 1920 ) ];
	(*R4).x = bufOutRe[outOffset + ( 0 + me*5 + 0 + 2560 ) ];
	(*R10).x = bufOutRe[outOffset + ( 0 + me*5 + 1 + 2560 ) ];
	(*R16).x = bufOutRe[outOffset + ( 0 + me*5 + 2 + 2560 ) ];
	(*R22).x = bufOutRe[outOffset + ( 0 + me*5 + 3 + 2560 ) ];
	(*R28).x = bufOutRe[outOffset + ( 0 + me*5 + 4 + 2560 ) ];
	(*R5).x = bufOutRe[outOffset + ( 0 + me*5 + 0 + 3200 ) ];
	(*R11).x = bufOutRe[outOffset + ( 0 + me*5 + 1 + 3200 ) ];
	(*R17).x = bufOutRe[outOffset + ( 0 + me*5 + 2 + 3200 ) ];
	(*R23).x = bufOutRe[outOffset + ( 0 + me*5 + 3 + 3200 ) ];
	(*R29).x = bufOutRe[outOffset + ( 0 + me*5 + 4 + 3200 ) ];
	}
	...
	(*R7).y = bufOutIm[outOffset + ( 0 + me*5 + 1 + 640 ) ];
	(*R13).y = bufOutIm[outOffset + ( 0 + me*5 + 2 + 640 ) ];
	(*R19).y = bufOutIm[outOffset + ( 0 + me*5 + 3 + 640 ) ];
	(*R25).y = bufOutIm[outOffset + ( 0 + me*5 + 4 + 640 ) ];
	(*R2).y = bufOutIm[outOffset + ( 0 + me*5 + 0 + 1280 ) ];
	(*R8).y = bufOutIm[outOffset + ( 0 + me*5 + 1 + 1280 ) ];
	(*R14).y = bufOutIm[outOffset + ( 0 + me*5 + 2 + 1280 ) ];
	(*R20).y = bufOutIm[outOffset + ( 0 + me*5 + 3 + 1280 ) ];
	(*R26).y = bufOutIm[outOffset + ( 0 + me*5 + 4 + 1280 ) ];
	(*R3).y = bufOutIm[outOffset + ( 0 + me*5 + 0 + 1920 ) ];
	(*R9).y = bufOutIm[outOffset + ( 0 + me*5 + 1 + 1920 ) ];
	(*R15).y = bufOutIm[outOffset + ( 0 + me*5 + 2 + 1920 ) ];
	(*R21).y = bufOutIm[outOffset + ( 0 + me*5 + 3 + 1920 ) ];
	(*R27).y = bufOutIm[outOffset + ( 0 + me*5 + 4 + 1920 ) ];
	(*R4).y = bufOutIm[outOffset + ( 0 + me*5 + 0 + 2560 ) ];
	(*R10).y = bufOutIm[outOffset + ( 0 + me*5 + 1 + 2560 ) ];
	(*R16).y = bufOutIm[outOffset + ( 0 + me*5 + 2 + 2560 ) ];
	(*R22).y = bufOutIm[outOffset + ( 0 + me*5 + 3 + 2560 ) ];
	(*R28).y = bufOutIm[outOffset + ( 0 + me*5 + 4 + 2560 ) ];
	(*R5).y = bufOutIm[outOffset + ( 0 + me*5 + 0 + 3200 ) ];
	(*R11).y = bufOutIm[outOffset + ( 0 + me*5 + 1 + 3200 ) ];
	(*R17).y = bufOutIm[outOffset + ( 0 + me*5 + 2 + 3200 ) ];
	(*R23).y = bufOutIm[outOffset + ( 0 + me*5 + 3 + 3200 ) ];
	(*R29).y = bufOutIm[outOffset + ( 0 + me*5 + 4 + 3200 ) ];
	}
...
FwdPass0_len3840(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data)
{
	...
	(*R1).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 384 )*stride_in];
	(*R1).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 384 )*stride_in];
	(*R11).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 384 )*stride_in];
	(*R11).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 384 )*stride_in];
	(*R21).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 384 )*stride_in];
	(*R21).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 384 )*stride_in];
	(*R2).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 768 )*stride_in];
	(*R2).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 768 )*stride_in];
	(*R12).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 768 )*stride_in];
	(*R12).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 768 )*stride_in];
	(*R22).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 768 )*stride_in];
	(*R22).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 768 )*stride_in];
	(*R3).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 1152 )*stride_in];
	(*R3).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 1152 )*stride_in];
	(*R13).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 1152 )*stride_in];
	(*R13).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 1152 )*stride_in];
	(*R23).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 1152 )*stride_in];
	(*R23).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 1152 )*stride_in];
	(*R4).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 1536 )*stride_in];
	(*R4).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 1536 )*stride_in];
	(*R14).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 1536 )*stride_in];
	(*R14).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 1536 )*stride_in];
	(*R24).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 1536 )*stride_in];
	(*R24).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 1536 )*stride_in];
	(*R5).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 1920 )*stride_in];
	(*R5).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 1920 )*stride_in];
	(*R15).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 1920 )*stride_in];
	(*R15).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 1920 )*stride_in];
	(*R25).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 1920 )*stride_in];
	(*R25).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 1920 )*stride_in];
	(*R6).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 2304 )*stride_in];
	(*R6).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 2304 )*stride_in];
	(*R16).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 2304 )*stride_in];
	(*R16).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 2304 )*stride_in];
	(*R26).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 2304 )*stride_in];
	(*R26).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 2304 )*stride_in];
	(*R7).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 2688 )*stride_in];
	(*R7).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 2688 )*stride_in];
	(*R17).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 2688 )*stride_in];
	(*R17).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 2688 )*stride_in];
	(*R27).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 2688 )*stride_in];
	(*R27).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 2688 )*stride_in];
	(*R8).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 3072 )*stride_in];
	(*R8).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 3072 )*stride_in];
	(*R18).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 3072 )*stride_in];
	(*R18).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 3072 )*stride_in];
	(*R28).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 3072 )*stride_in];
	(*R28).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 3072 )*stride_in];
	(*R9).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 3456 )*stride_in];
	(*R9).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 3456 )*stride_in];
	(*R19).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 3456 )*stride_in];
	(*R19).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 3456 )*stride_in];
	(*R29).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 3456 )*stride_in];
	(*R29).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 3456 )*stride_in];
	}
...
FwdPass1_len3840(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29)
{
	...
	(*R1).x = bufOutRe[outOffset + ( 0 + me*15 + 0 + 1920 ) ];
	(*R3).x = bufOutRe[outOffset + ( 0 + me*15 + 1 + 1920 ) ];
	(*R5).x = bufOutRe[outOffset + ( 0 + me*15 + 2 + 1920 ) ];
	(*R7).x = bufOutRe[outOffset + ( 0 + me*15 + 3 + 1920 ) ];
	(*R9).x = bufOutRe[outOffset + ( 0 + me*15 + 4 + 1920 ) ];
	(*R11).x = bufOutRe[outOffset + ( 0 + me*15 + 5 + 1920 ) ];
	(*R13).x = bufOutRe[outOffset + ( 0 + me*15 + 6 + 1920 ) ];
	(*R15).x = bufOutRe[outOffset + ( 0 + me*15 + 7 + 1920 ) ];
	(*R17).x = bufOutRe[outOffset + ( 0 + me*15 + 8 + 1920 ) ];
	(*R19).x = bufOutRe[outOffset + ( 0 + me*15 + 9 + 1920 ) ];
	(*R21).x = bufOutRe[outOffset + ( 0 + me*15 + 10 + 1920 ) ];
	(*R23).x = bufOutRe[outOffset + ( 0 + me*15 + 11 + 1920 ) ];
	(*R25).x = bufOutRe[outOffset + ( 0 + me*15 + 12 + 1920 ) ];
	(*R27).x = bufOutRe[outOffset + ( 0 + me*15 + 13 + 1920 ) ];
	(*R29).x = bufOutRe[outOffset + ( 0 + me*15 + 14 + 1920 ) ];
	}
	...
	(*R1).y = bufOutIm[outOffset + ( 0 + me*15 + 0 + 1920 ) ];
	(*R3).y = bufOutIm[outOffset + ( 0 + me*15 + 1 + 1920 ) ];
	(*R5).y = bufOutIm[outOffset + ( 0 + me*15 + 2 + 1920 ) ];
	(*R7).y = bufOutIm[outOffset + ( 0 + me*15 + 3 + 1920 ) ];
	(*R9).y = bufOutIm[outOffset + ( 0 + me*15 + 4 + 1920 ) ];
	(*R11).y = bufOutIm[outOffset + ( 0 + me*15 + 5 + 1920 ) ];
	(*R13).y = bufOutIm[outOffset + ( 0 + me*15 + 6 + 1920 ) ];
	(*R15).y = bufOutIm[outOffset + ( 0 + me*15 + 7 + 1920 ) ];
	(*R17).y = bufOutIm[outOffset + ( 0 + me*15 + 8 + 1920 ) ];
	(*R19).y = bufOutIm[outOffset + ( 0 + me*15 + 9 + 1920 ) ];
	(*R21).y = bufOutIm[outOffset + ( 0 + me*15 + 10 + 1920 ) ];
	(*R23).y = bufOutIm[outOffset + ( 0 + me*15 + 11 + 1920 ) ];
	(*R25).y = bufOutIm[outOffset + ( 0 + me*15 + 12 + 1920 ) ];
	(*R27).y = bufOutIm[outOffset + ( 0 + me*15 + 13 + 1920 ) ];
	(*R29).y = bufOutIm[outOffset + ( 0 + me*15 + 14 + 1920 ) ];
	}
...
template <typename T, StrideBin sb, CallbackType cbtype>
__device__ void
FwdPass2_len3840(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29)
{
...
template <typename T, StrideBin sb, CallbackType cbtype>
__device__ void
FwdPass3_len3840(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29)
{
...
template <typename T, StrideBin sb, CallbackType cbtype>
__device__ void
FwdPass4_len3840(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29)
{
...
template <typename T, StrideBin sb, CallbackType cbtype>
__device__ void
FwdPass5_len3840(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29)
{
	...
	if(rw)
	{
	bufOutRe[outOffset + ( ((15*me + 0)/480)*960 + (15*me + 0)%480 + 0 ) ] = (*R0).x;
	bufOutRe[outOffset + ( ((15*me + 0)/480)*960 + (15*me + 0)%480 + 480 ) ] = (*R1).x;
	bufOutRe[outOffset + ( ((15*me + 1)/480)*960 + (15*me + 1)%480 + 0 ) ] = (*R2).x;
	bufOutRe[outOffset + ( ((15*me + 1)/480)*960 + (15*me + 1)%480 + 480 ) ] = (*R3).x;
	bufOutRe[outOffset + ( ((15*me + 2)/480)*960 + (15*me + 2)%480 + 0 ) ] = (*R4).x;
	bufOutRe[outOffset + ( ((15*me + 2)/480)*960 + (15*me + 2)%480 + 480 ) ] = (*R5).x;
	bufOutRe[outOffset + ( ((15*me + 3)/480)*960 + (15*me + 3)%480 + 0 ) ] = (*R6).x;
	bufOutRe[outOffset + ( ((15*me + 3)/480)*960 + (15*me + 3)%480 + 480 ) ] = (*R7).x;
	bufOutRe[outOffset + ( ((15*me + 4)/480)*960 + (15*me + 4)%480 + 0 ) ] = (*R8).x;
	bufOutRe[outOffset + ( ((15*me + 4)/480)*960 + (15*me + 4)%480 + 480 ) ] = (*R9).x;
	bufOutRe[outOffset + ( ((15*me + 5)/480)*960 + (15*me + 5)%480 + 0 ) ] = (*R10).x;
	bufOutRe[outOffset + ( ((15*me + 5)/480)*960 + (15*me + 5)%480 + 480 ) ] = (*R11).x;
	bufOutRe[outOffset + ( ((15*me + 6)/480)*960 + (15*me + 6)%480 + 0 ) ] = (*R12).x;
	bufOutRe[outOffset + ( ((15*me + 6)/480)*960 + (15*me + 6)%480 + 480 ) ] = (*R13).x;
	bufOutRe[outOffset + ( ((15*me + 7)/480)*960 + (15*me + 7)%480 + 0 ) ] = (*R14).x;
	bufOutRe[outOffset + ( ((15*me + 7)/480)*960 + (15*me + 7)%480 + 480 ) ] = (*R15).x;
	bufOutRe[outOffset + ( ((15*me + 8)/480)*960 + (15*me + 8)%480 + 0 ) ] = (*R16).x;
	bufOutRe[outOffset + ( ((15*me + 8)/480)*960 + (15*me + 8)%480 + 480 ) ] = (*R17).x;
	bufOutRe[outOffset + ( ((15*me + 9)/480)*960 + (15*me + 9)%480 + 0 ) ] = (*R18).x;
	bufOutRe[outOffset + ( ((15*me + 9)/480)*960 + (15*me + 9)%480 + 480 ) ] = (*R19).x;
	bufOutRe[outOffset + ( ((15*me + 10)/480)*960 + (15*me + 10)%480 + 0 ) ] = (*R20).x;
	bufOutRe[outOffset + ( ((15*me + 10)/480)*960 + (15*me + 10)%480 + 480 ) ] = (*R21).x;
	bufOutRe[outOffset + ( ((15*me + 11)/480)*960 + (15*me + 11)%480 + 0 ) ] = (*R22).x;
	bufOutRe[outOffset + ( ((15*me + 11)/480)*960 + (15*me + 11)%480 + 480 ) ] = (*R23).x;
	bufOutRe[outOffset + ( ((15*me + 12)/480)*960 + (15*me + 12)%480 + 0 ) ] = (*R24).x;
	bufOutRe[outOffset + ( ((15*me + 12)/480)*960 + (15*me + 12)%480 + 480 ) ] = (*R25).x;
	bufOutRe[outOffset + ( ((15*me + 13)/480)*960 + (15*me + 13)%480 + 0 ) ] = (*R26).x;
	bufOutRe[outOffset + ( ((15*me + 13)/480)*960 + (15*me + 13)%480 + 480 ) ] = (*R27).x;
	bufOutRe[outOffset + ( ((15*me + 14)/480)*960 + (15*me + 14)%480 + 0 ) ] = (*R28).x;
	bufOutRe[outOffset + ( ((15*me + 14)/480)*960 + (15*me + 14)%480 + 480 ) ] = (*R29).x;
	}
	...
	if(rw)
	{
	bufOutIm[outOffset + ( ((15*me + 0)/480)*960 + (15*me + 0)%480 + 0 ) ] = (*R0).y;
	bufOutIm[outOffset + ( ((15*me + 0)/480)*960 + (15*me + 0)%480 + 480 ) ] = (*R1).y;
	bufOutIm[outOffset + ( ((15*me + 1)/480)*960 + (15*me + 1)%480 + 0 ) ] = (*R2).y;
	bufOutIm[outOffset + ( ((15*me + 1)/480)*960 + (15*me + 1)%480 + 480 ) ] = (*R3).y;
	bufOutIm[outOffset + ( ((15*me + 2)/480)*960 + (15*me + 2)%480 + 0 ) ] = (*R4).y;
	bufOutIm[outOffset + ( ((15*me + 2)/480)*960 + (15*me + 2)%480 + 480 ) ] = (*R5).y;
	bufOutIm[outOffset + ( ((15*me + 3)/480)*960 + (15*me + 3)%480 + 0 ) ] = (*R6).y;
	bufOutIm[outOffset + ( ((15*me + 3)/480)*960 + (15*me + 3)%480 + 480 ) ] = (*R7).y;
	bufOutIm[outOffset + ( ((15*me + 4)/480)*960 + (15*me + 4)%480 + 0 ) ] = (*R8).y;
	bufOutIm[outOffset + ( ((15*me + 4)/480)*960 + (15*me + 4)%480 + 480 ) ] = (*R9).y;
	bufOutIm[outOffset + ( ((15*me + 5)/480)*960 + (15*me + 5)%480 + 0 ) ] = (*R10).y;
	bufOutIm[outOffset + ( ((15*me + 5)/480)*960 + (15*me + 5)%480 + 480 ) ] = (*R11).y;
	bufOutIm[outOffset + ( ((15*me + 6)/480)*960 + (15*me + 6)%480 + 0 ) ] = (*R12).y;
	bufOutIm[outOffset + ( ((15*me + 6)/480)*960 + (15*me + 6)%480 + 480 ) ] = (*R13).y;
	bufOutIm[outOffset + ( ((15*me + 7)/480)*960 + (15*me + 7)%480 + 0 ) ] = (*R14).y;
	bufOutIm[outOffset + ( ((15*me + 7)/480)*960 + (15*me + 7)%480 + 480 ) ] = (*R15).y;
	bufOutIm[outOffset + ( ((15*me + 8)/480)*960 + (15*me + 8)%480 + 0 ) ] = (*R16).y;
	bufOutIm[outOffset + ( ((15*me + 8)/480)*960 + (15*me + 8)%480 + 480 ) ] = (*R17).y;
	bufOutIm[outOffset + ( ((15*me + 9)/480)*960 + (15*me + 9)%480 + 0 ) ] = (*R18).y;
	bufOutIm[outOffset + ( ((15*me + 9)/480)*960 + (15*me + 9)%480 + 480 ) ] = (*R19).y;
	bufOutIm[outOffset + ( ((15*me + 10)/480)*960 + (15*me + 10)%480 + 0 ) ] = (*R20).y;
	bufOutIm[outOffset + ( ((15*me + 10)/480)*960 + (15*me + 10)%480 + 480 ) ] = (*R21).y;
	bufOutIm[outOffset + ( ((15*me + 11)/480)*960 + (15*me + 11)%480 + 0 ) ] = (*R22).y;
	bufOutIm[outOffset + ( ((15*me + 11)/480)*960 + (15*me + 11)%480 + 480 ) ] = (*R23).y;
	bufOutIm[outOffset + ( ((15*me + 12)/480)*960 + (15*me + 12)%480 + 0 ) ] = (*R24).y;
	bufOutIm[outOffset + ( ((15*me + 12)/480)*960 + (15*me + 12)%480 + 480 ) ] = (*R25).y;
	bufOutIm[outOffset + ( ((15*me + 13)/480)*960 + (15*me + 13)%480 + 0 ) ] = (*R26).y;
	bufOutIm[outOffset + ( ((15*me + 13)/480)*960 + (15*me + 13)%480 + 480 ) ] = (*R27).y;
	bufOutIm[outOffset + ( ((15*me + 14)/480)*960 + (15*me + 14)%480 + 0 ) ] = (*R28).y;
	bufOutIm[outOffset + ( ((15*me + 14)/480)*960 + (15*me + 14)%480 + 480 ) ] = (*R29).y;
	}
...
template <typename T, StrideBin sb, CallbackType cbtype>
__device__ void
FwdPass6_len3840(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29)
{
	...
	{
		T W = twiddles[959 + 1*((15*me + 0)%960) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R1).x; ry = (*R1).y;
	...
	{
		T W = twiddles[959 + 1*((15*me + 1)%960) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R3).x; ry = (*R3).y;
	...
	{
		T W = twiddles[959 + 1*((15*me + 2)%960) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R5).x; ry = (*R5).y;
	...
	{
		T W = twiddles[959 + 1*((15*me + 3)%960) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R7).x; ry = (*R7).y;
	...
	{
		T W = twiddles[959 + 1*((15*me + 4)%960) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R9).x; ry = (*R9).y;
	...
	{
		T W = twiddles[959 + 1*((15*me + 5)%960) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R11).x; ry = (*R11).y;
	...
	{
		T W = twiddles[959 + 1*((15*me + 6)%960) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R13).x; ry = (*R13).y;
	...
	{
		T W = twiddles[959 + 1*((15*me + 7)%960) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R15).x; ry = (*R15).y;
	...
	{
		T W = twiddles[959 + 1*((15*me + 8)%960) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R17).x; ry = (*R17).y;
	...
	{
		T W = twiddles[959 + 1*((15*me + 9)%960) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R19).x; ry = (*R19).y;
	...
	{
		T W = twiddles[959 + 1*((15*me + 10)%960) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R21).x; ry = (*R21).y;
	...
	{
		T W = twiddles[959 + 1*((15*me + 11)%960) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R23).x; ry = (*R23).y;
	...
	{
		T W = twiddles[959 + 1*((15*me + 12)%960) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R25).x; ry = (*R25).y;
	...
	{
		T W = twiddles[959 + 1*((15*me + 13)%960) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R27).x; ry = (*R27).y;
	...
	{
		T W = twiddles[959 + 1*((15*me + 14)%960) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R29).x; ry = (*R29).y;
	...
	if(rw)
	{
	bufOutRe[outOffset + ( ((15*me + 0)/960)*1920 + (15*me + 0)%960 + 0 ) ] = (*R0).x;
	bufOutRe[outOffset + ( ((15*me + 0)/960)*1920 + (15*me + 0)%960 + 960 ) ] = (*R1).x;
	bufOutRe[outOffset + ( ((15*me + 1)/960)*1920 + (15*me + 1)%960 + 0 ) ] = (*R2).x;
	bufOutRe[outOffset + ( ((15*me + 1)/960)*1920 + (15*me + 1)%960 + 960 ) ] = (*R3).x;
	bufOutRe[outOffset + ( ((15*me + 2)/960)*1920 + (15*me + 2)%960 + 0 ) ] = (*R4).x;
	bufOutRe[outOffset + ( ((15*me + 2)/960)*1920 + (15*me + 2)%960 + 960 ) ] = (*R5).x;
	bufOutRe[outOffset + ( ((15*me + 3)/960)*1920 + (15*me + 3)%960 + 0 ) ] = (*R6).x;
	bufOutRe[outOffset + ( ((15*me + 3)/960)*1920 + (15*me + 3)%960 + 960 ) ] = (*R7).x;
	bufOutRe[outOffset + ( ((15*me + 4)/960)*1920 + (15*me + 4)%960 + 0 ) ] = (*R8).x;
	bufOutRe[outOffset + ( ((15*me + 4)/960)*1920 + (15*me + 4)%960 + 960 ) ] = (*R9).x;
	bufOutRe[outOffset + ( ((15*me + 5)/960)*1920 + (15*me + 5)%960 + 0 ) ] = (*R10).x;
	bufOutRe[outOffset + ( ((15*me + 5)/960)*1920 + (15*me + 5)%960 + 960 ) ] = (*R11).x;
	bufOutRe[outOffset + ( ((15*me + 6)/960)*1920 + (15*me + 6)%960 + 0 ) ] = (*R12).x;
	bufOutRe[outOffset + ( ((15*me + 6)/960)*1920 + (15*me + 6)%960 + 960 ) ] = (*R13).x;
	bufOutRe[outOffset + ( ((15*me + 7)/960)*1920 + (15*me + 7)%960 + 0 ) ] = (*R14).x;
	bufOutRe[outOffset + ( ((15*me + 7)/960)*1920 + (15*me + 7)%960 + 960 ) ] = (*R15).x;
	bufOutRe[outOffset + ( ((15*me + 8)/960)*1920 + (15*me + 8)%960 + 0 ) ] = (*R16).x;
	bufOutRe[outOffset + ( ((15*me + 8)/960)*1920 + (15*me + 8)%960 + 960 ) ] = (*R17).x;
	bufOutRe[outOffset + ( ((15*me + 9)/960)*1920 + (15*me + 9)%960 + 0 ) ] = (*R18).x;
	bufOutRe[outOffset + ( ((15*me + 9)/960)*1920 + (15*me + 9)%960 + 960 ) ] = (*R19).x;
	bufOutRe[outOffset + ( ((15*me + 10)/960)*1920 + (15*me + 10)%960 + 0 ) ] = (*R20).x;
	bufOutRe[outOffset + ( ((15*me + 10)/960)*1920 + (15*me + 10)%960 + 960 ) ] = (*R21).x;
	bufOutRe[outOffset + ( ((15*me + 11)/960)*1920 + (15*me + 11)%960 + 0 ) ] = (*R22).x;
	bufOutRe[outOffset + ( ((15*me + 11)/960)*1920 + (15*me + 11)%960 + 960 ) ] = (*R23).x;
	bufOutRe[outOffset + ( ((15*me + 12)/960)*1920 + (15*me + 12)%960 + 0 ) ] = (*R24).x;
	bufOutRe[outOffset + ( ((15*me + 12)/960)*1920 + (15*me + 12)%960 + 960 ) ] = (*R25).x;
	bufOutRe[outOffset + ( ((15*me + 13)/960)*1920 + (15*me + 13)%960 + 0 ) ] = (*R26).x;
	bufOutRe[outOffset + ( ((15*me + 13)/960)*1920 + (15*me + 13)%960 + 960 ) ] = (*R27).x;
	bufOutRe[outOffset + ( ((15*me + 14)/960)*1920 + (15*me + 14)%960 + 0 ) ] = (*R28).x;
	bufOutRe[outOffset + ( ((15*me + 14)/960)*1920 + (15*me + 14)%960 + 960 ) ] = (*R29).x;
	}
	...
	if(rw)
	{
	bufOutIm[outOffset + ( ((15*me + 0)/960)*1920 + (15*me + 0)%960 + 0 ) ] = (*R0).y;
	bufOutIm[outOffset + ( ((15*me + 0)/960)*1920 + (15*me + 0)%960 + 960 ) ] = (*R1).y;
	bufOutIm[outOffset + ( ((15*me + 1)/960)*1920 + (15*me + 1)%960 + 0 ) ] = (*R2).y;
	bufOutIm[outOffset + ( ((15*me + 1)/960)*1920 + (15*me + 1)%960 + 960 ) ] = (*R3).y;
	bufOutIm[outOffset + ( ((15*me + 2)/960)*1920 + (15*me + 2)%960 + 0 ) ] = (*R4).y;
	bufOutIm[outOffset + ( ((15*me + 2)/960)*1920 + (15*me + 2)%960 + 960 ) ] = (*R5).y;
	bufOutIm[outOffset + ( ((15*me + 3)/960)*1920 + (15*me + 3)%960 + 0 ) ] = (*R6).y;
	bufOutIm[outOffset + ( ((15*me + 3)/960)*1920 + (15*me + 3)%960 + 960 ) ] = (*R7).y;
	bufOutIm[outOffset + ( ((15*me + 4)/960)*1920 + (15*me + 4)%960 + 0 ) ] = (*R8).y;
	bufOutIm[outOffset + ( ((15*me + 4)/960)*1920 + (15*me + 4)%960 + 960 ) ] = (*R9).y;
	bufOutIm[outOffset + ( ((15*me + 5)/960)*1920 + (15*me + 5)%960 + 0 ) ] = (*R10).y;
	bufOutIm[outOffset + ( ((15*me + 5)/960)*1920 + (15*me + 5)%960 + 960 ) ] = (*R11).y;
	bufOutIm[outOffset + ( ((15*me + 6)/960)*1920 + (15*me + 6)%960 + 0 ) ] = (*R12).y;
	bufOutIm[outOffset + ( ((15*me + 6)/960)*1920 + (15*me + 6)%960 + 960 ) ] = (*R13).y;
	bufOutIm[outOffset + ( ((15*me + 7)/960)*1920 + (15*me + 7)%960 + 0 ) ] = (*R14).y;
	bufOutIm[outOffset + ( ((15*me + 7)/960)*1920 + (15*me + 7)%960 + 960 ) ] = (*R15).y;
	bufOutIm[outOffset + ( ((15*me + 8)/960)*1920 + (15*me + 8)%960 + 0 ) ] = (*R16).y;
	bufOutIm[outOffset + ( ((15*me + 8)/960)*1920 + (15*me + 8)%960 + 960 ) ] = (*R17).y;
	bufOutIm[outOffset + ( ((15*me + 9)/960)*1920 + (15*me + 9)%960 + 0 ) ] = (*R18).y;
	bufOutIm[outOffset + ( ((15*me + 9)/960)*1920 + (15*me + 9)%960 + 960 ) ] = (*R19).y;
	bufOutIm[outOffset + ( ((15*me + 10)/960)*1920 + (15*me + 10)%960 + 0 ) ] = (*R20).y;
	bufOutIm[outOffset + ( ((15*me + 10)/960)*1920 + (15*me + 10)%960 + 960 ) ] = (*R21).y;
	bufOutIm[outOffset + ( ((15*me + 11)/960)*1920 + (15*me + 11)%960 + 0 ) ] = (*R22).y;
	bufOutIm[outOffset + ( ((15*me + 11)/960)*1920 + (15*me + 11)%960 + 960 ) ] = (*R23).y;
	bufOutIm[outOffset + ( ((15*me + 12)/960)*1920 + (15*me + 12)%960 + 0 ) ] = (*R24).y;
	bufOutIm[outOffset + ( ((15*me + 12)/960)*1920 + (15*me + 12)%960 + 960 ) ] = (*R25).y;
	bufOutIm[outOffset + ( ((15*me + 13)/960)*1920 + (15*me + 13)%960 + 0 ) ] = (*R26).y;
	bufOutIm[outOffset + ( ((15*me + 13)/960)*1920 + (15*me + 13)%960 + 960 ) ] = (*R27).y;
	bufOutIm[outOffset + ( ((15*me + 14)/960)*1920 + (15*me + 14)%960 + 0 ) ] = (*R28).y;
	bufOutIm[outOffset + ( ((15*me + 14)/960)*1920 + (15*me + 14)%960 + 960 ) ] = (*R29).y;
	}
...
FwdPass7_len3840(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, T *bufOut, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data)
{
	...
	{
		T W = twiddles[1919 + 1*((15*me + 0)%1920) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R1).x; ry = (*R1).y;
	...
	{
		T W = twiddles[1919 + 1*((15*me + 1)%1920) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R3).x; ry = (*R3).y;
	...
	{
		T W = twiddles[1919 + 1*((15*me + 2)%1920) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R5).x; ry = (*R5).y;
	...
	{
		T W = twiddles[1919 + 1*((15*me + 3)%1920) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R7).x; ry = (*R7).y;
	...
	{
		T W = twiddles[1919 + 1*((15*me + 4)%1920) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R9).x; ry = (*R9).y;
	...
	{
		T W = twiddles[1919 + 1*((15*me + 5)%1920) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R11).x; ry = (*R11).y;
	...
	{
		T W = twiddles[1919 + 1*((15*me + 6)%1920) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R13).x; ry = (*R13).y;
	...
	{
		T W = twiddles[1919 + 1*((15*me + 7)%1920) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R15).x; ry = (*R15).y;
	...
	{
		T W = twiddles[1919 + 1*((15*me + 8)%1920) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R17).x; ry = (*R17).y;
	...
	{
		T W = twiddles[1919 + 1*((15*me + 9)%1920) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R19).x; ry = (*R19).y;
	...
	{
		T W = twiddles[1919 + 1*((15*me + 10)%1920) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R21).x; ry = (*R21).y;
	...
	{
		T W = twiddles[1919 + 1*((15*me + 11)%1920) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R23).x; ry = (*R23).y;
	...
	{
		T W = twiddles[1919 + 1*((15*me + 12)%1920) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R25).x; ry = (*R25).y;
	...
	{
		T W = twiddles[1919 + 1*((15*me + 13)%1920) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R27).x; ry = (*R27).y;
	...
	{
		T W = twiddles[1919 + 1*((15*me + 14)%1920) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R29).x; ry = (*R29).y;
	...
	store_cb(bufOut, outOffset + ( 15*me + 0 + 0 )*stride_out, (*R0), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 1 + 0 )*stride_out, (*R2), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 2 + 0 )*stride_out, (*R4), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 3 + 0 )*stride_out, (*R6), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 4 + 0 )*stride_out, (*R8), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 5 + 0 )*stride_out, (*R10), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 6 + 0 )*stride_out, (*R12), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 7 + 0 )*stride_out, (*R14), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 8 + 0 )*stride_out, (*R16), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 9 + 0 )*stride_out, (*R18), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 10 + 0 )*stride_out, (*R20), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 11 + 0 )*stride_out, (*R22), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 12 + 0 )*stride_out, (*R24), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 13 + 0 )*stride_out, (*R26), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 14 + 0 )*stride_out, (*R28), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 0 + 1920 )*stride_out, (*R1), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 1 + 1920 )*stride_out, (*R3), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 2 + 1920 )*stride_out, (*R5), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 3 + 1920 )*stride_out, (*R7), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 4 + 1920 )*stride_out, (*R9), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 5 + 1920 )*stride_out, (*R11), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 6 + 1920 )*stride_out, (*R13), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 7 + 1920 )*stride_out, (*R15), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 8 + 1920 )*stride_out, (*R17), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 9 + 1920 )*stride_out, (*R19), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 10 + 1920 )*stride_out, (*R21), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 11 + 1920 )*stride_out, (*R23), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 12 + 1920 )*stride_out, (*R25), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 13 + 1920 )*stride_out, (*R27), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 15*me + 14 + 1920 )*stride_out, (*R29), store_cb_data, nullptr);
...
FwdPass7_len3840(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data)
{
	...
	bufOutRe[outOffset + ( 15*me + 0 + 1920 )*stride_out] = (*R1).x;
	bufOutIm[outOffset + ( 15*me + 0 + 1920 )*stride_out] = (*R1).y;
	bufOutRe[outOffset + ( 15*me + 1 + 1920 )*stride_out] = (*R3).x;
	bufOutIm[outOffset + ( 15*me + 1 + 1920 )*stride_out] = (*R3).y;
	bufOutRe[outOffset + ( 15*me + 2 + 1920 )*stride_out] = (*R5).x;
	bufOutIm[outOffset + ( 15*me + 2 + 1920 )*stride_out] = (*R5).y;
	bufOutRe[outOffset + ( 15*me + 3 + 1920 )*stride_out] = (*R7).x;
	bufOutIm[outOffset + ( 15*me + 3 + 1920 )*stride_out] = (*R7).y;
	bufOutRe[outOffset + ( 15*me + 4 + 1920 )*stride_out] = (*R9).x;
	bufOutIm[outOffset + ( 15*me + 4 + 1920 )*stride_out] = (*R9).y;
	bufOutRe[outOffset + ( 15*me + 5 + 1920 )*stride_out] = (*R11).x;
	bufOutIm[outOffset + ( 15*me + 5 + 1920 )*stride_out] = (*R11).y;
	bufOutRe[outOffset + ( 15*me + 6 + 1920 )*stride_out] = (*R13).x;
	bufOutIm[outOffset + ( 15*me + 6 + 1920 )*stride_out] = (*R13).y;
	bufOutRe[outOffset + ( 15*me + 7 + 1920 )*stride_out] = (*R15).x;
	bufOutIm[outOffset + ( 15*me + 7 + 1920 )*stride_out] = (*R15).y;
	bufOutRe[outOffset + ( 15*me + 8 + 1920 )*stride_out] = (*R17).x;
	bufOutIm[outOffset + ( 15*me + 8 + 1920 )*stride_out] = (*R17).y;
	bufOutRe[outOffset + ( 15*me + 9 + 1920 )*stride_out] = (*R19).x;
	bufOutIm[outOffset + ( 15*me + 9 + 1920 )*stride_out] = (*R19).y;
	bufOutRe[outOffset + ( 15*me + 10 + 1920 )*stride_out] = (*R21).x;
	bufOutIm[outOffset + ( 15*me + 10 + 1920 )*stride_out] = (*R21).y;
	bufOutRe[outOffset + ( 15*me + 11 + 1920 )*stride_out] = (*R23).x;
	bufOutIm[outOffset + ( 15*me + 11 + 1920 )*stride_out] = (*R23).y;
	bufOutRe[outOffset + ( 15*me + 12 + 1920 )*stride_out] = (*R25).x;
	bufOutIm[outOffset + ( 15*me + 12 + 1920 )*stride_out] = (*R25).y;
	bufOutRe[outOffset + ( 15*me + 13 + 1920 )*stride_out] = (*R27).x;
	bufOutIm[outOffset + ( 15*me + 13 + 1920 )*stride_out] = (*R27).y;
	bufOutRe[outOffset + ( 15*me + 14 + 1920 )*stride_out] = (*R29).x;
	bufOutIm[outOffset + ( 15*me + 14 + 1920 )*stride_out] = (*R29).y;
	}
...
template <typename T, StrideBin sb, CallbackType cbtype>
__device__ void
InvPass1_len3840(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29)
{
...
template <typename T, StrideBin sb, CallbackType cbtype>
__device__ void
InvPass2_len3840(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29)
{
...
template <typename T, StrideBin sb, CallbackType cbtype>
__device__ void
InvPass3_len3840(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29)
{
...
template <typename T, StrideBin sb, CallbackType cbtype>
__device__ void
InvPass5_len3840(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29)
{
...
template <typename T, StrideBin sb, CallbackType cbtype>
__device__ void
InvPass6_len3840(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29)
{
...
template <typename T, StrideBin sb,CallbackType cbtype>
__device__ void 
fwd_len3840_device(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *gbIn, unsigned int iOffset, T *gbOut, unsigned int oOffset, real_type_t<T> *lds, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19, R20, R21, R22, R23, R24, R25, R26, R27, R28, R29;
	FwdPass0_len3840<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, iOffset, ldsOffset,  gbIn, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29, load_cb_fn, load_cb_data);
	FwdPass1_len3840<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	FwdPass2_len3840<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	FwdPass3_len3840<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	FwdPass4_len3840<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	FwdPass5_len3840<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	FwdPass6_len3840<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	FwdPass7_len3840<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, oOffset, lds, lds,  gbOut, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}

template <typename T, StrideBin sb,CallbackType cbtype>
__device__ void 
back_len3840_device(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *gbIn, unsigned int iOffset, T *gbOut, unsigned int oOffset, real_type_t<T> *lds, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19, R20, R21, R22, R23, R24, R25, R26, R27, R28, R29;
	InvPass0_len3840<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, iOffset, ldsOffset,  gbIn, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29, load_cb_fn, load_cb_data);
	InvPass1_len3840<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	InvPass2_len3840<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	InvPass3_len3840<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	InvPass4_len3840<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	InvPass5_len3840<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	InvPass6_len3840<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	InvPass7_len3840<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, oOffset, lds, lds,  gbOut, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fwd_len3840_device(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *gbIn, unsigned int iOffset, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, unsigned int oOffset, real_type_t<T> *lds, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data)
{
	...
	FwdPass5_len3840<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	FwdPass6_len3840<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	FwdPass7_len3840<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, oOffset, lds, lds, bufOutRe, bufOutIm, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
back_len3840_device(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *gbIn, unsigned int iOffset, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, unsigned int oOffset, real_type_t<T> *lds, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data)
{
	...
	InvPass5_len3840<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	InvPass6_len3840<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	InvPass7_len3840<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, oOffset, lds, lds, bufOutRe, bufOutIm, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19, R20, R21, R22, R23, R24, R25, R26, R27, R28, R29;
	FwdPass0_len3840<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, iOffset, ldsOffset,  bufInRe, bufInIm, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29, load_cb_fn, load_cb_data);
	FwdPass1_len3840<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	FwdPass2_len3840<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	FwdPass3_len3840<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	FwdPass4_len3840<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
...
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19, R20, R21, R22, R23, R24, R25, R26, R27, R28, R29;
	InvPass0_len3840<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, iOffset, ldsOffset,  bufInRe, bufInIm, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29, load_cb_fn, load_cb_data);
	InvPass1_len3840<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	InvPass2_len3840<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	InvPass3_len3840<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	InvPass4_len3840<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
...
fft_fwd_ip_len3840( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, T * __restrict__ gb)
{
	...
	fwd_len3840_device<T, sb, cbtype>(twiddles, stride_in[0], stride_in[0],  1, b, me, 0, gb, ioOffset, gb, ioOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
__global__ void
__launch_bounds__(128)
fft_back_ip_len3840( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, T * __restrict__ gb)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	back_len3840_device<T, sb, cbtype>(twiddles, stride_in[0], stride_in[0],  1, b, me, 0, gb, ioOffset, gb, ioOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_fwd_ip_len3840( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, real_type_t<T> * __restrict__ gbRe, real_type_t<T> * __restrict__ gbIm)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	fwd_len3840_device<T, sb, cbtype>(twiddles, stride_in[0], stride_in[0],  1, b, me, 0, gbRe, gbIm, ioOffset, gbRe, gbIm, ioOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_back_ip_len3840( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, real_type_t<T> * __restrict__ gbRe, real_type_t<T> * __restrict__ gbIm)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	back_len3840_device<T, sb, cbtype>(twiddles, stride_in[0], stride_in[0],  1, b, me, 0, gbRe, gbIm, ioOffset, gbRe, gbIm, ioOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_fwd_op_len3840( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, T * __restrict__ gbIn, T * __restrict__ gbOut)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	fwd_len3840_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  1, b, me, 0, gbIn, iOffset, gbOut, oOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
__global__ void
__launch_bounds__(128)
fft_back_op_len3840( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, T * __restrict__ gbIn, T * __restrict__ gbOut)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	back_len3840_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  1, b, me, 0, gbIn, iOffset, gbOut, oOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_fwd_op_len3840( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, T * __restrict__ gbIn, real_type_t<T> * __restrict__ gbOutRe, real_type_t<T> * __restrict__ gbOutIm)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	fwd_len3840_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  1, b, me, 0, gbIn, iOffset, gbOutRe, gbOutIm, oOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_back_op_len3840( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, T * __restrict__ gbIn, real_type_t<T> * __restrict__ gbOutRe, real_type_t<T> * __restrict__ gbOutIm)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	back_len3840_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  1, b, me, 0, gbIn, iOffset, gbOutRe, gbOutIm, oOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_fwd_op_len3840( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, real_type_t<T> * __restrict__ gbInRe, real_type_t<T> * __restrict__ gbInIm, T * __restrict__ gbOut)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	fwd_len3840_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  1, b, me, 0, gbInRe, gbInIm, iOffset, gbOut, oOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_back_op_len3840( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, real_type_t<T> * __restrict__ gbInRe, real_type_t<T> * __restrict__ gbInIm, T * __restrict__ gbOut)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	back_len3840_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  1, b, me, 0, gbInRe, gbInIm, iOffset, gbOut, oOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_fwd_op_len3840( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, real_type_t<T> * __restrict__ gbInRe, real_type_t<T> * __restrict__ gbInIm, real_type_t<T> * __restrict__ gbOutRe, real_type_t<T> * __restrict__ gbOutIm)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	fwd_len3840_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  1, b, me, 0, gbInRe, gbInIm, iOffset, gbOutRe, gbOutIm, oOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_back_op_len3840( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, real_type_t<T> * __restrict__ gbInRe, real_type_t<T> * __restrict__ gbInIm, real_type_t<T> * __restrict__ gbOutRe, real_type_t<T> * __restrict__ gbOutIm)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	back_len3840_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  1, b, me, 0, gbInRe, gbInIm, iOffset, gbOutRe, gbOutIm, oOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
