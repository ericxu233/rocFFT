 ...
 * Kernel is: namespace(factors=[5, 5, 5], flavour='uwide', length=125, scheme='CS_KERNEL_STOCKHAM', threads_per_block=256)
 */
...
__device__ void ip_forward_length125_SBRR_device(scalar_type* __restrict__ lds,
                                                 ...
                                                 bool         write)
{
    ...
    W    = twiddles[24 + 4 * (thread % 25)]; /* stockham.py:554 */
    t.x  = W.x * R[1].x - W.y * R[1].y; /* stockham.py:555 */
    t.y  = W.y * R[1].x + W.x * R[1].y; /* stockham.py:556 */
    R[1] = t; /* stockham.py:557 */
    W    = twiddles[25 + 4 * (thread % 25)]; /* stockham.py:554 */
    t.x  = W.x * R[2].x - W.y * R[2].y; /* stockham.py:555 */
    t.y  = W.y * R[2].x + W.x * R[2].y; /* stockham.py:556 */
    R[2] = t; /* stockham.py:557 */
    W    = twiddles[26 + 4 * (thread % 25)]; /* stockham.py:554 */
    t.x  = W.x * R[3].x - W.y * R[3].y; /* stockham.py:555 */
    t.y  = W.y * R[3].x + W.x * R[3].y; /* stockham.py:556 */
    R[3] = t; /* stockham.py:557 */
    W    = twiddles[27 + 4 * (thread % 25)]; /* stockham.py:554 */
    t.x  = W.x * R[4].x - W.y * R[4].y; /* stockham.py:555 */
    t.y  = W.y * R[4].x + W.x * R[4].y; /* stockham.py:556 */
    R[4] = t; /* stockham.py:557 */
    ...
    if(write)
    {
        lds[offset_lds + ((thread / 25) * 125 + thread % 25 + 0) * lstride]
            = R[0]; /* stockham.py:577 */
        lds[offset_lds + ((thread / 25) * 125 + thread % 25 + 25) * lstride]
            = R[1]; /* stockham.py:577 */
        lds[offset_lds + ((thread / 25) * 125 + thread % 25 + 50) * lstride]
            = R[2]; /* stockham.py:577 */
        lds[offset_lds + ((thread / 25) * 125 + thread % 25 + 75) * lstride]
            = R[3]; /* stockham.py:577 */
        lds[offset_lds + ((thread / 25) * 125 + thread % 25 + 100) * lstride]
            = R[4]; /* stockham.py:577 */
    }
}
/* stockham.py:709 */
                                                          ...
                                                          scalar_type* __restrict__ buf)
{
    ...
    offset_lds = (125 + lds_padding) * (transform % 10); /* stockham.py:373 */
    ...
    if(ebtype == EmbeddedType::C2Real_PRE)
    {
        ...
        real_pre_process_kernel_inplace<scalar_type, false>(thread % 63 + 0,
                                                            125 - thread % 63 - 0,
                                                            63,
                                                            &lds[offset_lds],
                                                            0,
                                                            &twiddles[125]); /* stockham.py:338 */

        real_pre_process_kernel_inplace<scalar_type, false>(thread % 63 + 25,
                                                            125 - thread % 63 - 25,
                                                            63,
                                                            &lds[offset_lds],
                                                            0,
        ...
        real_pre_process_kernel_inplace<scalar_type, false>(thread % 63 + 50,
                                                            125 - thread % 63 - 50,
                                                            63,
                                                            &lds[offset_lds],
                                                            0,
    ...
    ip_forward_length125_SBRR_device<scalar_type, SB_UNIT>(
    ...
    if(ebtype == EmbeddedType::Real2C_POST)
    {
        ...
        real_post_process_kernel_inplace<scalar_type, false>(thread % 63 + 0,
                                                             125 - thread % 63 - 0,
                                                             63,
                                                             &lds[offset_lds],
                                                             0,
        ...
        real_post_process_kernel_inplace<scalar_type, false>(thread % 63 + 25,
                                                             125 - thread % 63 - 25,
                                                             63,
                                                             &lds[offset_lds],
                                                             0,
        ...
        real_post_process_kernel_inplace<scalar_type, false>(thread % 63 + 50,
                                                             125 - thread % 63 - 50,
                                                             63,
                                                             &lds[offset_lds],
                                                             0,
    ...
    real_type_t<scalar_type>* __restrict__ bufim)
{
    ...
    lds[offset_lds + thread + 100]
        = {bufre[offset + (thread + 100) * stride0],
           bufim[offset + (thread + 100) * stride0]}; /* generator.py:872 */
        ...
        if(thread == 24)
        {
            lds[offset_lds + thread + 100 + 1]
                = {bufre[offset + (thread + 100 + 1) * stride0],
                   bufim[offset + (thread + 100 + 1) * stride0]}; /* generator.py:872 */
        }
    }
    ...
    bufre[offset + (thread + 100) * stride0]
        = lds[offset_lds + thread + 100].x; /* generator.py:906 */
    bufim[offset + (thread + 100) * stride0]
        = lds[offset_lds + thread + 100].y; /* generator.py:908 */
    ...
    if(ebtype == EmbeddedType::Real2C_POST)
    {
        ...
        {
            bufre[offset + (thread + 100 + 1) * stride0]
                = lds[offset_lds + thread + 100 + 1].x; /* generator.py:906 */
            bufim[offset + (thread + 100 + 1) * stride0]
                = lds[offset_lds + thread + 100 + 1].y; /* generator.py:908 */
        }
    }
}
/* stockham.py:765 */
template <typename scalar_type, StrideBin sb>
__device__ void op_forward_length125_SBRR_device(scalar_type* __restrict__ lds,
                                                 const scalar_type* __restrict__ twiddles,
                                                 size_t       stride_lds,
                                                 unsigned int offset_lds,
                                                 bool         write)
                                                          ...
                                                          scalar_type* __restrict__ buf_out)
{
    ...
    if(ebtype == EmbeddedType::C2Real_PRE)
    {
        ...
        if(thread == 24)
        {
            lds[offset_lds + thread + 100 + 1] = load_cb(
    ...
    // transform
    write = true; /* stockham.py:681 */
    op_forward_length125_SBRR_device<scalar_type, SB_UNIT>(
        lds, twiddles, stride_lds, offset_lds, write); /* stockham.py:686 */
    ...
    scalar_type* __restrict__ buf_out)
{
    ...
    lds[offset_lds + thread + 100]
        = {buf_inre[offset_in + (thread + 100) * stride0_in],
           buf_inim[offset_in + (thread + 100) * stride0_in]}; /* generator.py:872 */
        ...
        if(thread == 24)
        {
            lds[offset_lds + thread + 100 + 1]
                = {buf_inre[offset_in + (thread + 100 + 1) * stride0_in],
                   buf_inim[offset_in + (thread + 100 + 1) * stride0_in]}; /* generator.py:872 */
        }
    }
...
/* stockham.py:765 */
template <typename scalar_type, StrideBin sb>
__device__ void ip_inverse_length125_SBRR_device(scalar_type* __restrict__ lds,
                                                 const scalar_type* __restrict__ twiddles,
                                                 size_t       stride_lds,
                                                 unsigned int offset_lds,
                                                 bool         write)
{
    ...
    W    = {twiddles[24 + 4 * (thread % 25)].x,
         -twiddles[24 + 4 * (thread % 25)].y}; /* generator.py:1065 */
    t.x  = W.x * R[1].x - W.y * R[1].y; /* stockham.py:555 */
    t.y  = W.y * R[1].x + W.x * R[1].y; /* stockham.py:556 */
    R[1] = t; /* stockham.py:557 */
    W    = {twiddles[25 + 4 * (thread % 25)].x,
         -twiddles[25 + 4 * (thread % 25)].y}; /* generator.py:1065 */
    t.x  = W.x * R[2].x - W.y * R[2].y; /* stockham.py:555 */
    t.y  = W.y * R[2].x + W.x * R[2].y; /* stockham.py:556 */
    R[2] = t; /* stockham.py:557 */
    W    = {twiddles[26 + 4 * (thread % 25)].x,
         -twiddles[26 + 4 * (thread % 25)].y}; /* generator.py:1065 */
    t.x  = W.x * R[3].x - W.y * R[3].y; /* stockham.py:555 */
    t.y  = W.y * R[3].x + W.x * R[3].y; /* stockham.py:556 */
    R[3] = t; /* stockham.py:557 */
    W    = {twiddles[27 + 4 * (thread % 25)].x,
         -twiddles[27 + 4 * (thread % 25)].y}; /* generator.py:1065 */
    t.x  = W.x * R[4].x - W.y * R[4].y; /* stockham.py:555 */
    t.y  = W.y * R[4].x + W.x * R[4].y; /* stockham.py:556 */
    R[4] = t; /* stockham.py:557 */
                                                          ...
                                                          scalar_type* __restrict__ buf)
{
    ...
    // transform
    write = true; /* stockham.py:681 */
    ip_inverse_length125_SBRR_device<scalar_type, SB_UNIT>(
        lds, twiddles, stride_lds, offset_lds, write); /* stockham.py:686 */
...
/* stockham.py:765 */
template <typename scalar_type, StrideBin sb>
__device__ void op_inverse_length125_SBRR_device(scalar_type* __restrict__ lds,
                                                 const scalar_type* __restrict__ twiddles,
                                                 size_t       stride_lds,
                                                 unsigned int offset_lds,
                                                 bool         write)
                                                          ...
                                                          scalar_type* __restrict__ buf_out)
{
    ...
    // transform
    write = true; /* stockham.py:681 */
    op_inverse_length125_SBRR_device<scalar_type, SB_UNIT>(
        lds, twiddles, stride_lds, offset_lds, write); /* stockham.py:686 */
