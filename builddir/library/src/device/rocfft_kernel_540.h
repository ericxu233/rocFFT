...
FwdPass0_len540(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, T *bufIn, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data)
{
	...
	(*R1) = load_cb(bufIn, inOffset + ( 0 + me*3 + 0 + 54 )*stride_in, load_cb_data, nullptr);

	(*R11) = load_cb(bufIn, inOffset + ( 0 + me*3 + 1 + 54 )*stride_in, load_cb_data, nullptr);

	(*R21) = load_cb(bufIn, inOffset + ( 0 + me*3 + 2 + 54 )*stride_in, load_cb_data, nullptr);

	(*R2) = load_cb(bufIn, inOffset + ( 0 + me*3 + 0 + 108 )*stride_in, load_cb_data, nullptr);

	(*R12) = load_cb(bufIn, inOffset + ( 0 + me*3 + 1 + 108 )*stride_in, load_cb_data, nullptr);

	(*R22) = load_cb(bufIn, inOffset + ( 0 + me*3 + 2 + 108 )*stride_in, load_cb_data, nullptr);

	(*R3) = load_cb(bufIn, inOffset + ( 0 + me*3 + 0 + 162 )*stride_in, load_cb_data, nullptr);

	(*R13) = load_cb(bufIn, inOffset + ( 0 + me*3 + 1 + 162 )*stride_in, load_cb_data, nullptr);

	(*R23) = load_cb(bufIn, inOffset + ( 0 + me*3 + 2 + 162 )*stride_in, load_cb_data, nullptr);

	(*R4) = load_cb(bufIn, inOffset + ( 0 + me*3 + 0 + 216 )*stride_in, load_cb_data, nullptr);

	(*R14) = load_cb(bufIn, inOffset + ( 0 + me*3 + 1 + 216 )*stride_in, load_cb_data, nullptr);

	(*R24) = load_cb(bufIn, inOffset + ( 0 + me*3 + 2 + 216 )*stride_in, load_cb_data, nullptr);

	(*R5) = load_cb(bufIn, inOffset + ( 0 + me*3 + 0 + 270 )*stride_in, load_cb_data, nullptr);

	(*R15) = load_cb(bufIn, inOffset + ( 0 + me*3 + 1 + 270 )*stride_in, load_cb_data, nullptr);

	(*R25) = load_cb(bufIn, inOffset + ( 0 + me*3 + 2 + 270 )*stride_in, load_cb_data, nullptr);

	(*R6) = load_cb(bufIn, inOffset + ( 0 + me*3 + 0 + 324 )*stride_in, load_cb_data, nullptr);

	(*R16) = load_cb(bufIn, inOffset + ( 0 + me*3 + 1 + 324 )*stride_in, load_cb_data, nullptr);

	(*R26) = load_cb(bufIn, inOffset + ( 0 + me*3 + 2 + 324 )*stride_in, load_cb_data, nullptr);

	(*R7) = load_cb(bufIn, inOffset + ( 0 + me*3 + 0 + 378 )*stride_in, load_cb_data, nullptr);

	(*R17) = load_cb(bufIn, inOffset + ( 0 + me*3 + 1 + 378 )*stride_in, load_cb_data, nullptr);

	(*R27) = load_cb(bufIn, inOffset + ( 0 + me*3 + 2 + 378 )*stride_in, load_cb_data, nullptr);

	(*R8) = load_cb(bufIn, inOffset + ( 0 + me*3 + 0 + 432 )*stride_in, load_cb_data, nullptr);

	(*R18) = load_cb(bufIn, inOffset + ( 0 + me*3 + 1 + 432 )*stride_in, load_cb_data, nullptr);

	(*R28) = load_cb(bufIn, inOffset + ( 0 + me*3 + 2 + 432 )*stride_in, load_cb_data, nullptr);

	(*R9) = load_cb(bufIn, inOffset + ( 0 + me*3 + 0 + 486 )*stride_in, load_cb_data, nullptr);

	(*R19) = load_cb(bufIn, inOffset + ( 0 + me*3 + 1 + 486 )*stride_in, load_cb_data, nullptr);

	(*R29) = load_cb(bufIn, inOffset + ( 0 + me*3 + 2 + 486 )*stride_in, load_cb_data, nullptr);
	...
	(*R1).x = bufOutRe[outOffset + ( 0 + me*5 + 0 + 90 ) ];
	(*R7).x = bufOutRe[outOffset + ( 0 + me*5 + 1 + 90 ) ];
	(*R13).x = bufOutRe[outOffset + ( 0 + me*5 + 2 + 90 ) ];
	(*R19).x = bufOutRe[outOffset + ( 0 + me*5 + 3 + 90 ) ];
	(*R25).x = bufOutRe[outOffset + ( 0 + me*5 + 4 + 90 ) ];
	(*R2).x = bufOutRe[outOffset + ( 0 + me*5 + 0 + 180 ) ];
	(*R8).x = bufOutRe[outOffset + ( 0 + me*5 + 1 + 180 ) ];
	(*R14).x = bufOutRe[outOffset + ( 0 + me*5 + 2 + 180 ) ];
	(*R20).x = bufOutRe[outOffset + ( 0 + me*5 + 3 + 180 ) ];
	(*R26).x = bufOutRe[outOffset + ( 0 + me*5 + 4 + 180 ) ];
	(*R3).x = bufOutRe[outOffset + ( 0 + me*5 + 0 + 270 ) ];
	(*R9).x = bufOutRe[outOffset + ( 0 + me*5 + 1 + 270 ) ];
	(*R15).x = bufOutRe[outOffset + ( 0 + me*5 + 2 + 270 ) ];
	(*R21).x = bufOutRe[outOffset + ( 0 + me*5 + 3 + 270 ) ];
	(*R27).x = bufOutRe[outOffset + ( 0 + me*5 + 4 + 270 ) ];
	(*R4).x = bufOutRe[outOffset + ( 0 + me*5 + 0 + 360 ) ];
	(*R10).x = bufOutRe[outOffset + ( 0 + me*5 + 1 + 360 ) ];
	(*R16).x = bufOutRe[outOffset + ( 0 + me*5 + 2 + 360 ) ];
	(*R22).x = bufOutRe[outOffset + ( 0 + me*5 + 3 + 360 ) ];
	(*R28).x = bufOutRe[outOffset + ( 0 + me*5 + 4 + 360 ) ];
	(*R5).x = bufOutRe[outOffset + ( 0 + me*5 + 0 + 450 ) ];
	(*R11).x = bufOutRe[outOffset + ( 0 + me*5 + 1 + 450 ) ];
	(*R17).x = bufOutRe[outOffset + ( 0 + me*5 + 2 + 450 ) ];
	(*R23).x = bufOutRe[outOffset + ( 0 + me*5 + 3 + 450 ) ];
	(*R29).x = bufOutRe[outOffset + ( 0 + me*5 + 4 + 450 ) ];
	}
	...
	(*R1).y = bufOutIm[outOffset + ( 0 + me*5 + 0 + 90 ) ];
	(*R7).y = bufOutIm[outOffset + ( 0 + me*5 + 1 + 90 ) ];
	(*R13).y = bufOutIm[outOffset + ( 0 + me*5 + 2 + 90 ) ];
	(*R19).y = bufOutIm[outOffset + ( 0 + me*5 + 3 + 90 ) ];
	(*R25).y = bufOutIm[outOffset + ( 0 + me*5 + 4 + 90 ) ];
	(*R2).y = bufOutIm[outOffset + ( 0 + me*5 + 0 + 180 ) ];
	(*R8).y = bufOutIm[outOffset + ( 0 + me*5 + 1 + 180 ) ];
	(*R14).y = bufOutIm[outOffset + ( 0 + me*5 + 2 + 180 ) ];
	(*R20).y = bufOutIm[outOffset + ( 0 + me*5 + 3 + 180 ) ];
	(*R26).y = bufOutIm[outOffset + ( 0 + me*5 + 4 + 180 ) ];
	(*R3).y = bufOutIm[outOffset + ( 0 + me*5 + 0 + 270 ) ];
	(*R9).y = bufOutIm[outOffset + ( 0 + me*5 + 1 + 270 ) ];
	(*R15).y = bufOutIm[outOffset + ( 0 + me*5 + 2 + 270 ) ];
	(*R21).y = bufOutIm[outOffset + ( 0 + me*5 + 3 + 270 ) ];
	(*R27).y = bufOutIm[outOffset + ( 0 + me*5 + 4 + 270 ) ];
	(*R4).y = bufOutIm[outOffset + ( 0 + me*5 + 0 + 360 ) ];
	(*R10).y = bufOutIm[outOffset + ( 0 + me*5 + 1 + 360 ) ];
	(*R16).y = bufOutIm[outOffset + ( 0 + me*5 + 2 + 360 ) ];
	(*R22).y = bufOutIm[outOffset + ( 0 + me*5 + 3 + 360 ) ];
	(*R28).y = bufOutIm[outOffset + ( 0 + me*5 + 4 + 360 ) ];
	(*R5).y = bufOutIm[outOffset + ( 0 + me*5 + 0 + 450 ) ];
	(*R11).y = bufOutIm[outOffset + ( 0 + me*5 + 1 + 450 ) ];
	(*R17).y = bufOutIm[outOffset + ( 0 + me*5 + 2 + 450 ) ];
	(*R23).y = bufOutIm[outOffset + ( 0 + me*5 + 3 + 450 ) ];
	(*R29).y = bufOutIm[outOffset + ( 0 + me*5 + 4 + 450 ) ];
	}
...
FwdPass0_len540(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data)
{
	...
	(*R1).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 54 )*stride_in];
	(*R1).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 54 )*stride_in];
	(*R11).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 54 )*stride_in];
	(*R11).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 54 )*stride_in];
	(*R21).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 54 )*stride_in];
	(*R21).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 54 )*stride_in];
	(*R2).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 108 )*stride_in];
	(*R2).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 108 )*stride_in];
	(*R12).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 108 )*stride_in];
	(*R12).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 108 )*stride_in];
	(*R22).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 108 )*stride_in];
	(*R22).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 108 )*stride_in];
	(*R3).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 162 )*stride_in];
	(*R3).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 162 )*stride_in];
	(*R13).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 162 )*stride_in];
	(*R13).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 162 )*stride_in];
	(*R23).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 162 )*stride_in];
	(*R23).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 162 )*stride_in];
	(*R4).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 216 )*stride_in];
	(*R4).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 216 )*stride_in];
	(*R14).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 216 )*stride_in];
	(*R14).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 216 )*stride_in];
	(*R24).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 216 )*stride_in];
	(*R24).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 216 )*stride_in];
	(*R5).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 270 )*stride_in];
	(*R5).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 270 )*stride_in];
	(*R15).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 270 )*stride_in];
	(*R15).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 270 )*stride_in];
	(*R25).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 270 )*stride_in];
	(*R25).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 270 )*stride_in];
	(*R6).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 324 )*stride_in];
	(*R6).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 324 )*stride_in];
	(*R16).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 324 )*stride_in];
	(*R16).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 324 )*stride_in];
	(*R26).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 324 )*stride_in];
	(*R26).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 324 )*stride_in];
	(*R7).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 378 )*stride_in];
	(*R7).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 378 )*stride_in];
	(*R17).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 378 )*stride_in];
	(*R17).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 378 )*stride_in];
	(*R27).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 378 )*stride_in];
	(*R27).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 378 )*stride_in];
	(*R8).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 432 )*stride_in];
	(*R8).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 432 )*stride_in];
	(*R18).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 432 )*stride_in];
	(*R18).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 432 )*stride_in];
	(*R28).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 432 )*stride_in];
	(*R28).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 432 )*stride_in];
	(*R9).x = bufInRe[inOffset + ( 0 + me*3 + 0 + 486 )*stride_in];
	(*R9).y = bufInIm[inOffset + ( 0 + me*3 + 0 + 486 )*stride_in];
	(*R19).x = bufInRe[inOffset + ( 0 + me*3 + 1 + 486 )*stride_in];
	(*R19).y = bufInIm[inOffset + ( 0 + me*3 + 1 + 486 )*stride_in];
	(*R29).x = bufInRe[inOffset + ( 0 + me*3 + 2 + 486 )*stride_in];
	(*R29).y = bufInIm[inOffset + ( 0 + me*3 + 2 + 486 )*stride_in];
	}
...
FwdPass1_len540(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29)
{
	...
	(*R1).x = bufOutRe[outOffset + ( 0 + me*10 + 0 + 180 ) ];
	(*R4).x = bufOutRe[outOffset + ( 0 + me*10 + 1 + 180 ) ];
	(*R7).x = bufOutRe[outOffset + ( 0 + me*10 + 2 + 180 ) ];
	(*R10).x = bufOutRe[outOffset + ( 0 + me*10 + 3 + 180 ) ];
	(*R13).x = bufOutRe[outOffset + ( 0 + me*10 + 4 + 180 ) ];
	(*R16).x = bufOutRe[outOffset + ( 0 + me*10 + 5 + 180 ) ];
	(*R19).x = bufOutRe[outOffset + ( 0 + me*10 + 6 + 180 ) ];
	(*R22).x = bufOutRe[outOffset + ( 0 + me*10 + 7 + 180 ) ];
	(*R25).x = bufOutRe[outOffset + ( 0 + me*10 + 8 + 180 ) ];
	(*R28).x = bufOutRe[outOffset + ( 0 + me*10 + 9 + 180 ) ];
	(*R2).x = bufOutRe[outOffset + ( 0 + me*10 + 0 + 360 ) ];
	(*R5).x = bufOutRe[outOffset + ( 0 + me*10 + 1 + 360 ) ];
	(*R8).x = bufOutRe[outOffset + ( 0 + me*10 + 2 + 360 ) ];
	(*R11).x = bufOutRe[outOffset + ( 0 + me*10 + 3 + 360 ) ];
	(*R14).x = bufOutRe[outOffset + ( 0 + me*10 + 4 + 360 ) ];
	(*R17).x = bufOutRe[outOffset + ( 0 + me*10 + 5 + 360 ) ];
	(*R20).x = bufOutRe[outOffset + ( 0 + me*10 + 6 + 360 ) ];
	(*R23).x = bufOutRe[outOffset + ( 0 + me*10 + 7 + 360 ) ];
	(*R26).x = bufOutRe[outOffset + ( 0 + me*10 + 8 + 360 ) ];
	(*R29).x = bufOutRe[outOffset + ( 0 + me*10 + 9 + 360 ) ];
	}
	...
	(*R1).y = bufOutIm[outOffset + ( 0 + me*10 + 0 + 180 ) ];
	(*R4).y = bufOutIm[outOffset + ( 0 + me*10 + 1 + 180 ) ];
	(*R7).y = bufOutIm[outOffset + ( 0 + me*10 + 2 + 180 ) ];
	(*R10).y = bufOutIm[outOffset + ( 0 + me*10 + 3 + 180 ) ];
	(*R13).y = bufOutIm[outOffset + ( 0 + me*10 + 4 + 180 ) ];
	(*R16).y = bufOutIm[outOffset + ( 0 + me*10 + 5 + 180 ) ];
	(*R19).y = bufOutIm[outOffset + ( 0 + me*10 + 6 + 180 ) ];
	(*R22).y = bufOutIm[outOffset + ( 0 + me*10 + 7 + 180 ) ];
	(*R25).y = bufOutIm[outOffset + ( 0 + me*10 + 8 + 180 ) ];
	(*R28).y = bufOutIm[outOffset + ( 0 + me*10 + 9 + 180 ) ];
	(*R2).y = bufOutIm[outOffset + ( 0 + me*10 + 0 + 360 ) ];
	(*R5).y = bufOutIm[outOffset + ( 0 + me*10 + 1 + 360 ) ];
	(*R8).y = bufOutIm[outOffset + ( 0 + me*10 + 2 + 360 ) ];
	(*R11).y = bufOutIm[outOffset + ( 0 + me*10 + 3 + 360 ) ];
	(*R14).y = bufOutIm[outOffset + ( 0 + me*10 + 4 + 360 ) ];
	(*R17).y = bufOutIm[outOffset + ( 0 + me*10 + 5 + 360 ) ];
	(*R20).y = bufOutIm[outOffset + ( 0 + me*10 + 6 + 360 ) ];
	(*R23).y = bufOutIm[outOffset + ( 0 + me*10 + 7 + 360 ) ];
	(*R26).y = bufOutIm[outOffset + ( 0 + me*10 + 8 + 360 ) ];
	(*R29).y = bufOutIm[outOffset + ( 0 + me*10 + 9 + 360 ) ];
	}
...
template <typename T, StrideBin sb, CallbackType cbtype>
__device__ void
FwdPass2_len540(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29)
{
...
FwdPass3_len540(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, T *bufOut, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data)
{
	...
	buff4g[ 5*me + 0 + 90 ] = lib_make_vector4< vector4_type_t<T> >((*R1).x, (*R1).y, (*R4).x, (*R4).y) ;
	buff4g[ 5*me + 1 + 90 ] = lib_make_vector4< vector4_type_t<T> >((*R7).x, (*R7).y, (*R10).x, (*R10).y) ;
	buff4g[ 5*me + 2 + 90 ] = lib_make_vector4< vector4_type_t<T> >((*R13).x, (*R13).y, (*R16).x, (*R16).y) ;
	buff4g[ 5*me + 3 + 90 ] = lib_make_vector4< vector4_type_t<T> >((*R19).x, (*R19).y, (*R22).x, (*R22).y) ;
	buff4g[ 5*me + 4 + 90 ] = lib_make_vector4< vector4_type_t<T> >((*R25).x, (*R25).y, (*R28).x, (*R28).y) ;
	buff4g[ 5*me + 0 + 180 ] = lib_make_vector4< vector4_type_t<T> >((*R2).x, (*R2).y, (*R5).x, (*R5).y) ;
	buff4g[ 5*me + 1 + 180 ] = lib_make_vector4< vector4_type_t<T> >((*R8).x, (*R8).y, (*R11).x, (*R11).y) ;
	buff4g[ 5*me + 2 + 180 ] = lib_make_vector4< vector4_type_t<T> >((*R14).x, (*R14).y, (*R17).x, (*R17).y) ;
	buff4g[ 5*me + 3 + 180 ] = lib_make_vector4< vector4_type_t<T> >((*R20).x, (*R20).y, (*R23).x, (*R23).y) ;
	buff4g[ 5*me + 4 + 180 ] = lib_make_vector4< vector4_type_t<T> >((*R26).x, (*R26).y, (*R29).x, (*R29).y) ;
	}
	...
	store_cb(bufOut, outOffset + ( 10*me + 0 + 180 )*stride_out, (*R1), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 10*me + 1 + 180 )*stride_out, (*R4), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 10*me + 2 + 180 )*stride_out, (*R7), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 10*me + 3 + 180 )*stride_out, (*R10), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 10*me + 4 + 180 )*stride_out, (*R13), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 10*me + 5 + 180 )*stride_out, (*R16), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 10*me + 6 + 180 )*stride_out, (*R19), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 10*me + 7 + 180 )*stride_out, (*R22), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 10*me + 8 + 180 )*stride_out, (*R25), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 10*me + 9 + 180 )*stride_out, (*R28), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 10*me + 0 + 360 )*stride_out, (*R2), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 10*me + 1 + 360 )*stride_out, (*R5), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 10*me + 2 + 360 )*stride_out, (*R8), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 10*me + 3 + 360 )*stride_out, (*R11), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 10*me + 4 + 360 )*stride_out, (*R14), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 10*me + 5 + 360 )*stride_out, (*R17), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 10*me + 6 + 360 )*stride_out, (*R20), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 10*me + 7 + 360 )*stride_out, (*R23), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 10*me + 8 + 360 )*stride_out, (*R26), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 10*me + 9 + 360 )*stride_out, (*R29), store_cb_data, nullptr);
...
FwdPass3_len540(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data)
{
	...
	bufOutRe[outOffset + ( 10*me + 0 + 180 )*stride_out] = (*R1).x;
	bufOutIm[outOffset + ( 10*me + 0 + 180 )*stride_out] = (*R1).y;
	bufOutRe[outOffset + ( 10*me + 1 + 180 )*stride_out] = (*R4).x;
	bufOutIm[outOffset + ( 10*me + 1 + 180 )*stride_out] = (*R4).y;
	bufOutRe[outOffset + ( 10*me + 2 + 180 )*stride_out] = (*R7).x;
	bufOutIm[outOffset + ( 10*me + 2 + 180 )*stride_out] = (*R7).y;
	bufOutRe[outOffset + ( 10*me + 3 + 180 )*stride_out] = (*R10).x;
	bufOutIm[outOffset + ( 10*me + 3 + 180 )*stride_out] = (*R10).y;
	bufOutRe[outOffset + ( 10*me + 4 + 180 )*stride_out] = (*R13).x;
	bufOutIm[outOffset + ( 10*me + 4 + 180 )*stride_out] = (*R13).y;
	bufOutRe[outOffset + ( 10*me + 5 + 180 )*stride_out] = (*R16).x;
	bufOutIm[outOffset + ( 10*me + 5 + 180 )*stride_out] = (*R16).y;
	bufOutRe[outOffset + ( 10*me + 6 + 180 )*stride_out] = (*R19).x;
	bufOutIm[outOffset + ( 10*me + 6 + 180 )*stride_out] = (*R19).y;
	bufOutRe[outOffset + ( 10*me + 7 + 180 )*stride_out] = (*R22).x;
	bufOutIm[outOffset + ( 10*me + 7 + 180 )*stride_out] = (*R22).y;
	bufOutRe[outOffset + ( 10*me + 8 + 180 )*stride_out] = (*R25).x;
	bufOutIm[outOffset + ( 10*me + 8 + 180 )*stride_out] = (*R25).y;
	bufOutRe[outOffset + ( 10*me + 9 + 180 )*stride_out] = (*R28).x;
	bufOutIm[outOffset + ( 10*me + 9 + 180 )*stride_out] = (*R28).y;
	bufOutRe[outOffset + ( 10*me + 0 + 360 )*stride_out] = (*R2).x;
	bufOutIm[outOffset + ( 10*me + 0 + 360 )*stride_out] = (*R2).y;
	bufOutRe[outOffset + ( 10*me + 1 + 360 )*stride_out] = (*R5).x;
	bufOutIm[outOffset + ( 10*me + 1 + 360 )*stride_out] = (*R5).y;
	bufOutRe[outOffset + ( 10*me + 2 + 360 )*stride_out] = (*R8).x;
	bufOutIm[outOffset + ( 10*me + 2 + 360 )*stride_out] = (*R8).y;
	bufOutRe[outOffset + ( 10*me + 3 + 360 )*stride_out] = (*R11).x;
	bufOutIm[outOffset + ( 10*me + 3 + 360 )*stride_out] = (*R11).y;
	bufOutRe[outOffset + ( 10*me + 4 + 360 )*stride_out] = (*R14).x;
	bufOutIm[outOffset + ( 10*me + 4 + 360 )*stride_out] = (*R14).y;
	bufOutRe[outOffset + ( 10*me + 5 + 360 )*stride_out] = (*R17).x;
	bufOutIm[outOffset + ( 10*me + 5 + 360 )*stride_out] = (*R17).y;
	bufOutRe[outOffset + ( 10*me + 6 + 360 )*stride_out] = (*R20).x;
	bufOutIm[outOffset + ( 10*me + 6 + 360 )*stride_out] = (*R20).y;
	bufOutRe[outOffset + ( 10*me + 7 + 360 )*stride_out] = (*R23).x;
	bufOutIm[outOffset + ( 10*me + 7 + 360 )*stride_out] = (*R23).y;
	bufOutRe[outOffset + ( 10*me + 8 + 360 )*stride_out] = (*R26).x;
	bufOutIm[outOffset + ( 10*me + 8 + 360 )*stride_out] = (*R26).y;
	bufOutRe[outOffset + ( 10*me + 9 + 360 )*stride_out] = (*R29).x;
	bufOutIm[outOffset + ( 10*me + 9 + 360 )*stride_out] = (*R29).y;
	}
...
template <typename T, StrideBin sb, CallbackType cbtype>
__device__ void
InvPass0_len540(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, T *bufIn, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data)
{
...
template <typename T, StrideBin sb, CallbackType cbtype>
__device__ void
InvPass1_len540(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29)
{
...
template <typename T, StrideBin sb, CallbackType cbtype>
__device__ void
InvPass2_len540(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, T *R26, T *R27, T *R28, T *R29)
{
...
template <typename T, StrideBin sb,CallbackType cbtype>
__device__ void 
fwd_len540_device(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *gbIn, unsigned int iOffset, T *gbOut, unsigned int oOffset, real_type_t<T> *lds, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19, R20, R21, R22, R23, R24, R25, R26, R27, R28, R29;
	FwdPass0_len540<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, iOffset, ldsOffset,  gbIn, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29, load_cb_fn, load_cb_data);
	FwdPass1_len540<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	FwdPass2_len540<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	FwdPass3_len540<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, oOffset, lds, lds,  gbOut, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}

template <typename T, StrideBin sb,CallbackType cbtype>
__device__ void 
back_len540_device(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *gbIn, unsigned int iOffset, T *gbOut, unsigned int oOffset, real_type_t<T> *lds, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19, R20, R21, R22, R23, R24, R25, R26, R27, R28, R29;
	InvPass0_len540<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, iOffset, ldsOffset,  gbIn, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29, load_cb_fn, load_cb_data);
	InvPass1_len540<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	InvPass2_len540<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	InvPass3_len540<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, oOffset, lds, lds,  gbOut, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fwd_len540_device(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *gbIn, unsigned int iOffset, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, unsigned int oOffset, real_type_t<T> *lds, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data)
{
	...
	FwdPass1_len540<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	FwdPass2_len540<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	FwdPass3_len540<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, oOffset, lds, lds, bufOutRe, bufOutIm, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
back_len540_device(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *gbIn, unsigned int iOffset, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, unsigned int oOffset, real_type_t<T> *lds, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data)
{
	...
	InvPass1_len540<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	InvPass2_len540<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	InvPass3_len540<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, oOffset, lds, lds, bufOutRe, bufOutIm, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19, R20, R21, R22, R23, R24, R25, R26, R27, R28, R29;
	FwdPass0_len540<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, iOffset, ldsOffset,  bufInRe, bufInIm, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29, load_cb_fn, load_cb_data);
	FwdPass1_len540<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	FwdPass2_len540<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	FwdPass3_len540<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, oOffset, lds, lds,  gbOut, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19, R20, R21, R22, R23, R24, R25, R26, R27, R28, R29;
	InvPass0_len540<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, iOffset, ldsOffset,  bufInRe, bufInIm, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29, load_cb_fn, load_cb_data);
	InvPass1_len540<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	InvPass2_len540<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29);
	InvPass3_len540<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, oOffset, lds, lds,  gbOut, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, &R26, &R27, &R28, &R29, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_fwd_ip_len540( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, T * __restrict__ gb)
{
	...
	unsigned int rw = (static_cast<int>(me) < (static_cast<int>(upper_count)  - static_cast<int>(batch)*3)*18) ? 1 : 0;
	...
	size_t counter_mod = (batch*3 + (me/18));
	if(dim == 1){
	...
	fwd_len540_device<T, sb, cbtype>(twiddles, stride_in[0], stride_in[0],  rw, b, me%18, (me/18)*540, gb, ioOffset, gb, ioOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
__global__ void
__launch_bounds__(54)
fft_back_ip_len540( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, T * __restrict__ gb)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	back_len540_device<T, sb, cbtype>(twiddles, stride_in[0], stride_in[0],  rw, b, me%18, (me/18)*540, gb, ioOffset, gb, ioOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_fwd_ip_len540( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, real_type_t<T> * __restrict__ gbRe, real_type_t<T> * __restrict__ gbIm)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	fwd_len540_device<T, sb, cbtype>(twiddles, stride_in[0], stride_in[0],  rw, b, me%18, (me/18)*540, gbRe, gbIm, ioOffset, gbRe, gbIm, ioOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_back_ip_len540( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, real_type_t<T> * __restrict__ gbRe, real_type_t<T> * __restrict__ gbIm)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	back_len540_device<T, sb, cbtype>(twiddles, stride_in[0], stride_in[0],  rw, b, me%18, (me/18)*540, gbRe, gbIm, ioOffset, gbRe, gbIm, ioOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_fwd_op_len540( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, T * __restrict__ gbIn, T * __restrict__ gbOut)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	fwd_len540_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  rw, b, me%18, (me/18)*540, gbIn, iOffset, gbOut, oOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_back_op_len540( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, T * __restrict__ gbIn, T * __restrict__ gbOut)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	back_len540_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  rw, b, me%18, (me/18)*540, gbIn, iOffset, gbOut, oOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_fwd_op_len540( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, T * __restrict__ gbIn, real_type_t<T> * __restrict__ gbOutRe, real_type_t<T> * __restrict__ gbOutIm)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	fwd_len540_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  rw, b, me%18, (me/18)*540, gbIn, iOffset, gbOutRe, gbOutIm, oOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_back_op_len540( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, T * __restrict__ gbIn, real_type_t<T> * __restrict__ gbOutRe, real_type_t<T> * __restrict__ gbOutIm)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	back_len540_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  rw, b, me%18, (me/18)*540, gbIn, iOffset, gbOutRe, gbOutIm, oOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_fwd_op_len540( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, real_type_t<T> * __restrict__ gbInRe, real_type_t<T> * __restrict__ gbInIm, T * __restrict__ gbOut)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	fwd_len540_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  rw, b, me%18, (me/18)*540, gbInRe, gbInIm, iOffset, gbOut, oOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_back_op_len540( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, real_type_t<T> * __restrict__ gbInRe, real_type_t<T> * __restrict__ gbInIm, T * __restrict__ gbOut)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	back_len540_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  rw, b, me%18, (me/18)*540, gbInRe, gbInIm, iOffset, gbOut, oOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_fwd_op_len540( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, real_type_t<T> * __restrict__ gbInRe, real_type_t<T> * __restrict__ gbInIm, real_type_t<T> * __restrict__ gbOutRe, real_type_t<T> * __restrict__ gbOutIm)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	fwd_len540_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  rw, b, me%18, (me/18)*540, gbInRe, gbInIm, iOffset, gbOutRe, gbOutIm, oOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_back_op_len540( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, real_type_t<T> * __restrict__ gbInRe, real_type_t<T> * __restrict__ gbInIm, real_type_t<T> * __restrict__ gbOutRe, real_type_t<T> * __restrict__ gbOutIm)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	back_len540_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  rw, b, me%18, (me/18)*540, gbInRe, gbInIm, iOffset, gbOutRe, gbOutIm, oOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
