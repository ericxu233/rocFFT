...
FwdPass0_len2000(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, T *bufIn, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19)
{
	...
	(*R1) = bufIn[inOffset + ( 0 + me*2 + 0 + 200 )*stride_in];
	(*R11) = bufIn[inOffset + ( 0 + me*2 + 1 + 200 )*stride_in];
	(*R2) = bufIn[inOffset + ( 0 + me*2 + 0 + 400 )*stride_in];
	(*R12) = bufIn[inOffset + ( 0 + me*2 + 1 + 400 )*stride_in];
	(*R3) = bufIn[inOffset + ( 0 + me*2 + 0 + 600 )*stride_in];
	(*R13) = bufIn[inOffset + ( 0 + me*2 + 1 + 600 )*stride_in];
	(*R4) = bufIn[inOffset + ( 0 + me*2 + 0 + 800 )*stride_in];
	(*R14) = bufIn[inOffset + ( 0 + me*2 + 1 + 800 )*stride_in];
	(*R5) = bufIn[inOffset + ( 0 + me*2 + 0 + 1000 )*stride_in];
	(*R15) = bufIn[inOffset + ( 0 + me*2 + 1 + 1000 )*stride_in];
	(*R6) = bufIn[inOffset + ( 0 + me*2 + 0 + 1200 )*stride_in];
	(*R16) = bufIn[inOffset + ( 0 + me*2 + 1 + 1200 )*stride_in];
	(*R7) = bufIn[inOffset + ( 0 + me*2 + 0 + 1400 )*stride_in];
	(*R17) = bufIn[inOffset + ( 0 + me*2 + 1 + 1400 )*stride_in];
	(*R8) = bufIn[inOffset + ( 0 + me*2 + 0 + 1600 )*stride_in];
	(*R18) = bufIn[inOffset + ( 0 + me*2 + 1 + 1600 )*stride_in];
	(*R9) = bufIn[inOffset + ( 0 + me*2 + 0 + 1800 )*stride_in];
	(*R19) = bufIn[inOffset + ( 0 + me*2 + 1 + 1800 )*stride_in];
	}
	...
	(*R1).x = bufOutRe[outOffset + ( 0 + me*2 + 0 + 200 ) ];
	(*R11).x = bufOutRe[outOffset + ( 0 + me*2 + 1 + 200 ) ];
	(*R2).x = bufOutRe[outOffset + ( 0 + me*2 + 0 + 400 ) ];
	(*R12).x = bufOutRe[outOffset + ( 0 + me*2 + 1 + 400 ) ];
	(*R3).x = bufOutRe[outOffset + ( 0 + me*2 + 0 + 600 ) ];
	(*R13).x = bufOutRe[outOffset + ( 0 + me*2 + 1 + 600 ) ];
	(*R4).x = bufOutRe[outOffset + ( 0 + me*2 + 0 + 800 ) ];
	(*R14).x = bufOutRe[outOffset + ( 0 + me*2 + 1 + 800 ) ];
	(*R5).x = bufOutRe[outOffset + ( 0 + me*2 + 0 + 1000 ) ];
	(*R15).x = bufOutRe[outOffset + ( 0 + me*2 + 1 + 1000 ) ];
	(*R6).x = bufOutRe[outOffset + ( 0 + me*2 + 0 + 1200 ) ];
	(*R16).x = bufOutRe[outOffset + ( 0 + me*2 + 1 + 1200 ) ];
	(*R7).x = bufOutRe[outOffset + ( 0 + me*2 + 0 + 1400 ) ];
	(*R17).x = bufOutRe[outOffset + ( 0 + me*2 + 1 + 1400 ) ];
	(*R8).x = bufOutRe[outOffset + ( 0 + me*2 + 0 + 1600 ) ];
	(*R18).x = bufOutRe[outOffset + ( 0 + me*2 + 1 + 1600 ) ];
	(*R9).x = bufOutRe[outOffset + ( 0 + me*2 + 0 + 1800 ) ];
	(*R19).x = bufOutRe[outOffset + ( 0 + me*2 + 1 + 1800 ) ];
	}
	...
	(*R1).y = bufOutIm[outOffset + ( 0 + me*2 + 0 + 200 ) ];
	(*R11).y = bufOutIm[outOffset + ( 0 + me*2 + 1 + 200 ) ];
	(*R2).y = bufOutIm[outOffset + ( 0 + me*2 + 0 + 400 ) ];
	(*R12).y = bufOutIm[outOffset + ( 0 + me*2 + 1 + 400 ) ];
	(*R3).y = bufOutIm[outOffset + ( 0 + me*2 + 0 + 600 ) ];
	(*R13).y = bufOutIm[outOffset + ( 0 + me*2 + 1 + 600 ) ];
	(*R4).y = bufOutIm[outOffset + ( 0 + me*2 + 0 + 800 ) ];
	(*R14).y = bufOutIm[outOffset + ( 0 + me*2 + 1 + 800 ) ];
	(*R5).y = bufOutIm[outOffset + ( 0 + me*2 + 0 + 1000 ) ];
	(*R15).y = bufOutIm[outOffset + ( 0 + me*2 + 1 + 1000 ) ];
	(*R6).y = bufOutIm[outOffset + ( 0 + me*2 + 0 + 1200 ) ];
	(*R16).y = bufOutIm[outOffset + ( 0 + me*2 + 1 + 1200 ) ];
	(*R7).y = bufOutIm[outOffset + ( 0 + me*2 + 0 + 1400 ) ];
	(*R17).y = bufOutIm[outOffset + ( 0 + me*2 + 1 + 1400 ) ];
	(*R8).y = bufOutIm[outOffset + ( 0 + me*2 + 0 + 1600 ) ];
	(*R18).y = bufOutIm[outOffset + ( 0 + me*2 + 1 + 1600 ) ];
	(*R9).y = bufOutIm[outOffset + ( 0 + me*2 + 0 + 1800 ) ];
	(*R19).y = bufOutIm[outOffset + ( 0 + me*2 + 1 + 1800 ) ];
	}
...
FwdPass0_len2000(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19)
{
	...
	(*R1).x = bufInRe[inOffset + ( 0 + me*2 + 0 + 200 )*stride_in];
	(*R1).y = bufInIm[inOffset + ( 0 + me*2 + 0 + 200 )*stride_in];
	(*R11).x = bufInRe[inOffset + ( 0 + me*2 + 1 + 200 )*stride_in];
	(*R11).y = bufInIm[inOffset + ( 0 + me*2 + 1 + 200 )*stride_in];
	(*R2).x = bufInRe[inOffset + ( 0 + me*2 + 0 + 400 )*stride_in];
	(*R2).y = bufInIm[inOffset + ( 0 + me*2 + 0 + 400 )*stride_in];
	(*R12).x = bufInRe[inOffset + ( 0 + me*2 + 1 + 400 )*stride_in];
	(*R12).y = bufInIm[inOffset + ( 0 + me*2 + 1 + 400 )*stride_in];
	(*R3).x = bufInRe[inOffset + ( 0 + me*2 + 0 + 600 )*stride_in];
	(*R3).y = bufInIm[inOffset + ( 0 + me*2 + 0 + 600 )*stride_in];
	(*R13).x = bufInRe[inOffset + ( 0 + me*2 + 1 + 600 )*stride_in];
	(*R13).y = bufInIm[inOffset + ( 0 + me*2 + 1 + 600 )*stride_in];
	(*R4).x = bufInRe[inOffset + ( 0 + me*2 + 0 + 800 )*stride_in];
	(*R4).y = bufInIm[inOffset + ( 0 + me*2 + 0 + 800 )*stride_in];
	(*R14).x = bufInRe[inOffset + ( 0 + me*2 + 1 + 800 )*stride_in];
	(*R14).y = bufInIm[inOffset + ( 0 + me*2 + 1 + 800 )*stride_in];
	(*R5).x = bufInRe[inOffset + ( 0 + me*2 + 0 + 1000 )*stride_in];
	(*R5).y = bufInIm[inOffset + ( 0 + me*2 + 0 + 1000 )*stride_in];
	(*R15).x = bufInRe[inOffset + ( 0 + me*2 + 1 + 1000 )*stride_in];
	(*R15).y = bufInIm[inOffset + ( 0 + me*2 + 1 + 1000 )*stride_in];
	(*R6).x = bufInRe[inOffset + ( 0 + me*2 + 0 + 1200 )*stride_in];
	(*R6).y = bufInIm[inOffset + ( 0 + me*2 + 0 + 1200 )*stride_in];
	(*R16).x = bufInRe[inOffset + ( 0 + me*2 + 1 + 1200 )*stride_in];
	(*R16).y = bufInIm[inOffset + ( 0 + me*2 + 1 + 1200 )*stride_in];
	(*R7).x = bufInRe[inOffset + ( 0 + me*2 + 0 + 1400 )*stride_in];
	(*R7).y = bufInIm[inOffset + ( 0 + me*2 + 0 + 1400 )*stride_in];
	(*R17).x = bufInRe[inOffset + ( 0 + me*2 + 1 + 1400 )*stride_in];
	(*R17).y = bufInIm[inOffset + ( 0 + me*2 + 1 + 1400 )*stride_in];
	(*R8).x = bufInRe[inOffset + ( 0 + me*2 + 0 + 1600 )*stride_in];
	(*R8).y = bufInIm[inOffset + ( 0 + me*2 + 0 + 1600 )*stride_in];
	(*R18).x = bufInRe[inOffset + ( 0 + me*2 + 1 + 1600 )*stride_in];
	(*R18).y = bufInIm[inOffset + ( 0 + me*2 + 1 + 1600 )*stride_in];
	(*R9).x = bufInRe[inOffset + ( 0 + me*2 + 0 + 1800 )*stride_in];
	(*R9).y = bufInIm[inOffset + ( 0 + me*2 + 0 + 1800 )*stride_in];
	(*R19).x = bufInRe[inOffset + ( 0 + me*2 + 1 + 1800 )*stride_in];
	(*R19).y = bufInIm[inOffset + ( 0 + me*2 + 1 + 1800 )*stride_in];
	}
...
FwdPass2_len2000(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19)
{
	...
	(*R3).x = bufOutRe[outOffset + ( 0 + me*10 + 1 + 1000 ) ];
	(*R5).x = bufOutRe[outOffset + ( 0 + me*10 + 2 + 1000 ) ];
	(*R7).x = bufOutRe[outOffset + ( 0 + me*10 + 3 + 1000 ) ];
	(*R9).x = bufOutRe[outOffset + ( 0 + me*10 + 4 + 1000 ) ];
	(*R11).x = bufOutRe[outOffset + ( 0 + me*10 + 5 + 1000 ) ];
	(*R13).x = bufOutRe[outOffset + ( 0 + me*10 + 6 + 1000 ) ];
	(*R15).x = bufOutRe[outOffset + ( 0 + me*10 + 7 + 1000 ) ];
	(*R17).x = bufOutRe[outOffset + ( 0 + me*10 + 8 + 1000 ) ];
	(*R19).x = bufOutRe[outOffset + ( 0 + me*10 + 9 + 1000 ) ];
	}
	...
	(*R3).y = bufOutIm[outOffset + ( 0 + me*10 + 1 + 1000 ) ];
	(*R5).y = bufOutIm[outOffset + ( 0 + me*10 + 2 + 1000 ) ];
	(*R7).y = bufOutIm[outOffset + ( 0 + me*10 + 3 + 1000 ) ];
	(*R9).y = bufOutIm[outOffset + ( 0 + me*10 + 4 + 1000 ) ];
	(*R11).y = bufOutIm[outOffset + ( 0 + me*10 + 5 + 1000 ) ];
	(*R13).y = bufOutIm[outOffset + ( 0 + me*10 + 6 + 1000 ) ];
	(*R15).y = bufOutIm[outOffset + ( 0 + me*10 + 7 + 1000 ) ];
	(*R17).y = bufOutIm[outOffset + ( 0 + me*10 + 8 + 1000 ) ];
	(*R19).y = bufOutIm[outOffset + ( 0 + me*10 + 9 + 1000 ) ];
	}
...
FwdPass3_len2000(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, T *bufOut, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19)
{
	...
	{
		T W = twiddles[999 + 1*((10*me + 0)%1000) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R1).x; ry = (*R1).y;
	...
	{
		T W = twiddles[999 + 1*((10*me + 1)%1000) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R3).x; ry = (*R3).y;
	...
	{
		T W = twiddles[999 + 1*((10*me + 2)%1000) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R5).x; ry = (*R5).y;
	...
	{
		T W = twiddles[999 + 1*((10*me + 3)%1000) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R7).x; ry = (*R7).y;
	...
	{
		T W = twiddles[999 + 1*((10*me + 4)%1000) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R9).x; ry = (*R9).y;
	...
	{
		T W = twiddles[999 + 1*((10*me + 5)%1000) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R11).x; ry = (*R11).y;
	...
	{
		T W = twiddles[999 + 1*((10*me + 6)%1000) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R13).x; ry = (*R13).y;
	...
	{
		T W = twiddles[999 + 1*((10*me + 7)%1000) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R15).x; ry = (*R15).y;
	...
	{
		T W = twiddles[999 + 1*((10*me + 8)%1000) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R17).x; ry = (*R17).y;
	...
	{
		T W = twiddles[999 + 1*((10*me + 9)%1000) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R19).x; ry = (*R19).y;
	...
	buff4g[ 5*me + 0 + 500 ] = lib_make_vector4< vector4_type_t<T> >((*R1).x, (*R1).y, (*R3).x, (*R3).y) ;
	buff4g[ 5*me + 1 + 500 ] = lib_make_vector4< vector4_type_t<T> >((*R5).x, (*R5).y, (*R7).x, (*R7).y) ;
	buff4g[ 5*me + 2 + 500 ] = lib_make_vector4< vector4_type_t<T> >((*R9).x, (*R9).y, (*R11).x, (*R11).y) ;
	buff4g[ 5*me + 3 + 500 ] = lib_make_vector4< vector4_type_t<T> >((*R13).x, (*R13).y, (*R15).x, (*R15).y) ;
	buff4g[ 5*me + 4 + 500 ] = lib_make_vector4< vector4_type_t<T> >((*R17).x, (*R17).y, (*R19).x, (*R19).y) ;
	}
	...
	bufOut[outOffset + ( 10*me + 0 + 1000 )*stride_out] = (*R1);
	bufOut[outOffset + ( 10*me + 1 + 1000 )*stride_out] = (*R3);
	bufOut[outOffset + ( 10*me + 2 + 1000 )*stride_out] = (*R5);
	bufOut[outOffset + ( 10*me + 3 + 1000 )*stride_out] = (*R7);
	bufOut[outOffset + ( 10*me + 4 + 1000 )*stride_out] = (*R9);
	bufOut[outOffset + ( 10*me + 5 + 1000 )*stride_out] = (*R11);
	bufOut[outOffset + ( 10*me + 6 + 1000 )*stride_out] = (*R13);
	bufOut[outOffset + ( 10*me + 7 + 1000 )*stride_out] = (*R15);
	bufOut[outOffset + ( 10*me + 8 + 1000 )*stride_out] = (*R17);
	bufOut[outOffset + ( 10*me + 9 + 1000 )*stride_out] = (*R19);
	}
	}
...
FwdPass3_len2000(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19)
{
	...
	bufOutRe[outOffset + ( 10*me + 1 + 1000 )*stride_out] = (*R3).x;
	bufOutIm[outOffset + ( 10*me + 1 + 1000 )*stride_out] = (*R3).y;
	bufOutRe[outOffset + ( 10*me + 2 + 1000 )*stride_out] = (*R5).x;
	bufOutIm[outOffset + ( 10*me + 2 + 1000 )*stride_out] = (*R5).y;
	bufOutRe[outOffset + ( 10*me + 3 + 1000 )*stride_out] = (*R7).x;
	bufOutIm[outOffset + ( 10*me + 3 + 1000 )*stride_out] = (*R7).y;
	bufOutRe[outOffset + ( 10*me + 4 + 1000 )*stride_out] = (*R9).x;
	bufOutIm[outOffset + ( 10*me + 4 + 1000 )*stride_out] = (*R9).y;
	bufOutRe[outOffset + ( 10*me + 5 + 1000 )*stride_out] = (*R11).x;
	bufOutIm[outOffset + ( 10*me + 5 + 1000 )*stride_out] = (*R11).y;
	bufOutRe[outOffset + ( 10*me + 6 + 1000 )*stride_out] = (*R13).x;
	bufOutIm[outOffset + ( 10*me + 6 + 1000 )*stride_out] = (*R13).y;
	bufOutRe[outOffset + ( 10*me + 7 + 1000 )*stride_out] = (*R15).x;
	bufOutIm[outOffset + ( 10*me + 7 + 1000 )*stride_out] = (*R15).y;
	bufOutRe[outOffset + ( 10*me + 8 + 1000 )*stride_out] = (*R17).x;
	bufOutIm[outOffset + ( 10*me + 8 + 1000 )*stride_out] = (*R17).y;
	bufOutRe[outOffset + ( 10*me + 9 + 1000 )*stride_out] = (*R19).x;
	bufOutIm[outOffset + ( 10*me + 9 + 1000 )*stride_out] = (*R19).y;
	}
...
template <typename T, StrideBin sb>
__device__ void
InvPass0_len2000(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, T *bufIn, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19)
{
...
template <typename T, StrideBin sb>
__device__ void
InvPass1_len2000(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19)
{
...
template <typename T, StrideBin sb>
__device__ void
InvPass2_len2000(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19)
{
...
template <typename T, StrideBin sb>
__device__ void 
fwd_len2000_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *lwbIn, T *lwbOut, real_type_t<T> *lds)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19;
	FwdPass0_len2000<T, sb>(twiddles, stride_in, stride_out, rw, b, me, 0, ldsOffset,  lwbIn, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19);
	FwdPass1_len2000<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19);
	FwdPass2_len2000<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19);
	FwdPass3_len2000<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, 0, lds, lds,  lwbOut, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19);
}

template <typename T, StrideBin sb>
__device__ void 
back_len2000_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *lwbIn, T *lwbOut, real_type_t<T> *lds)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19;
	InvPass0_len2000<T, sb>(twiddles, stride_in, stride_out, rw, b, me, 0, ldsOffset,  lwbIn, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19);
	InvPass1_len2000<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19);
	InvPass2_len2000<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19);
	InvPass3_len2000<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, 0, lds, lds,  lwbOut, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19);
}

template <typename T, StrideBin sb>
__device__ void 
fwd_len2000_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *lwbIn, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, real_type_t<T> *lds)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19;
	FwdPass0_len2000<T, sb>(twiddles, stride_in, stride_out, rw, b, me, 0, ldsOffset,  lwbIn, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19);
	FwdPass1_len2000<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19);
	FwdPass2_len2000<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19);
	FwdPass3_len2000<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, 0, lds, lds, bufOutRe, bufOutIm, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19);
}

template <typename T, StrideBin sb>
__device__ void 
back_len2000_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *lwbIn, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, real_type_t<T> *lds)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19;
	InvPass0_len2000<T, sb>(twiddles, stride_in, stride_out, rw, b, me, 0, ldsOffset,  lwbIn, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19);
	InvPass1_len2000<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19);
	InvPass2_len2000<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19);
	InvPass3_len2000<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, 0, lds, lds, bufOutRe, bufOutIm, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19);
}

template <typename T, StrideBin sb>
__device__ void 
fwd_len2000_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, T *lwbOut, real_type_t<T> *lds)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19;
	FwdPass0_len2000<T, sb>(twiddles, stride_in, stride_out, rw, b, me, 0, ldsOffset,  bufInRe, bufInIm, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19);
	FwdPass1_len2000<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19);
	FwdPass2_len2000<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19);
	FwdPass3_len2000<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, 0, lds, lds,  lwbOut, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19);
}
...
template <typename T, StrideBin sb>
__device__ void 
back_len2000_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, T *lwbOut, real_type_t<T> *lds)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19;
	InvPass0_len2000<T, sb>(twiddles, stride_in, stride_out, rw, b, me, 0, ldsOffset,  bufInRe, bufInIm, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19);
	InvPass1_len2000<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19);
	InvPass2_len2000<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19);
	InvPass3_len2000<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, 0, lds, lds,  lwbOut, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19);
}
...
template <typename T, StrideBin sb>
__device__ void 
fwd_len2000_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, real_type_t<T> *lds)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19;
	FwdPass0_len2000<T, sb>(twiddles, stride_in, stride_out, rw, b, me, 0, ldsOffset,  bufInRe, bufInIm, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19);
	FwdPass1_len2000<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19);
...
template <typename T, StrideBin sb>
__device__ void 
back_len2000_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, real_type_t<T> *lds)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19;
	InvPass0_len2000<T, sb>(twiddles, stride_in, stride_out, rw, b, me, 0, ldsOffset,  bufInRe, bufInIm, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19);
	InvPass1_len2000<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19);
...
fft_fwd_ip_len2000( cl::sycl::range<3> blocks, cl::sycl::range<3> threads, cl::sycl::queue rocfftQueue, cl::sycl::buffer<T, 1> twiddles_GB, const size_t dim, cl::sycl::buffer<size_t, 1> *lengths_GB, cl::sycl::buffer<size_t, 1> *stride_in_GB, const size_t batch_count, cl::sycl::buffer<T, 1> gb_GB)
{
rocfftQueue.submit([&](cl::sycl::handler &cgh)
{
	...
	cl::sycl::accessor<real_type_t<T>,1,sycl::access::mode::read_write,sycl::access::target::local> lds(cl::sycl::range<1>(2000), cgh);
	cgh.parallel_for<class kern_fft_fwd_ip_len2000>(
...
//// Print kernel code here (after function prototype)
	...
	fwd_len2000_device<T, sb>(twiddles, stride_in[0], stride_in[0],  1, b, me, 0, lwb, lwb, lds);
});
});
}
...
__global__ void
__launch_bounds__(100)
fft_back_ip_len2000( cl::sycl::range<3> blocks, cl::sycl::range<3> threads, cl::sycl::queue rocfftQueue, cl::sycl::buffer<T, 1> twiddles_GB, const size_t dim, cl::sycl::buffer<size_t, 1> *lengths_GB, cl::sycl::buffer<size_t, 1> *stride_in_GB, const size_t batch_count, cl::sycl::buffer<T, 1> gb_GB)
{
rocfftQueue.submit([&](cl::sycl::handler &cgh)
{
	auto twiddles = twiddles_GB.get_access<cl::sycl::access::mode::read>(cgh);
	...
	auto gb = gb_GB.get_access<cl::sycl::access::mode::read_write>(cgh);
	cl::sycl::accessor<real_type_t<T>,1,sycl::access::mode::read_write,sycl::access::target::local> lds(cl::sycl::range<1>(2000), cgh);
	cgh.parallel_for<class kern_fft_back_ip_len2000>(
	                   cl::sycl::nd_range<3>(blocks, threads),
	                   [=](cl::sycl::nd_item<3> wItem)
{
//// Print kernel code here (after function prototype)
	...
	// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, lwb, lds
	back_len2000_device<T, sb>(twiddles, stride_in[0], stride_in[0],  1, b, me, 0, lwb, lwb, lds);
});
});
}
...
//// Print kernel code here (after function prototype)
	...
	// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, lwb, lds
	fwd_len2000_device<T, sb>(twiddles, stride_in[0], stride_in[0],  1, b, me, 0, lwbRe, lwbIm, lwbRe, lwbIm, lds);
});
});
}
...
__global__ void
__launch_bounds__(100)
fft_back_ip_len2000( cl::sycl::range<3> blocks, cl::sycl::range<3> threads, cl::sycl::queue rocfftQueue, cl::sycl::buffer<T, 1> twiddles_GB, const size_t dim, cl::sycl::buffer<size_t, 1> *lengths_GB, cl::sycl::buffer<size_t, 1> *stride_in_GB, const size_t batch_count, cl::sycl::buffer<real_type_t<T>, 1> gbRe_GB, cl::sycl::buffer<real_type_t<T>, 1> gbIm_GB)
{
rocfftQueue.submit([&](cl::sycl::handler &cgh)
{
	auto twiddles = twiddles_GB.get_access<cl::sycl::access::mode::read>(cgh);
...
//// Print kernel code here (after function prototype)
	...
	// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, lwb, lds
	back_len2000_device<T, sb>(twiddles, stride_in[0], stride_in[0],  1, b, me, 0, lwbRe, lwbIm, lwbRe, lwbIm, lds);
});
});
}
...
rocfftQueue.submit([&](cl::sycl::handler &cgh)
{
	...
	cl::sycl::accessor<real_type_t<T>,1,sycl::access::mode::read_write,sycl::access::target::local> lds(cl::sycl::range<1>(2000), cgh);
	cgh.parallel_for<class kern_fft_fwd_op_len2000>(
	                   cl::sycl::nd_range<3>(blocks, threads),
	                   [=](cl::sycl::nd_item<3> wItem)
{
//// Print kernel code here (after function prototype)
	...
	// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, lwb, lds
	fwd_len2000_device<T, sb>(twiddles, stride_in[0], stride_out[0],  1, b, me, 0, lwbIn, lwbOut, lds);
});
});
}
...
__global__ void
__launch_bounds__(100)
fft_back_op_len2000( cl::sycl::range<3> blocks, cl::sycl::range<3> threads, cl::sycl::queue rocfftQueue, cl::sycl::buffer<T, 1> twiddles_GB, const size_t dim, cl::sycl::buffer<size_t, 1> *lengths_GB, cl::sycl::buffer<size_t, 1> *stride_in_GB, cl::sycl::buffer<size_t, 1> *stride_out_GB, const size_t batch_count, cl::sycl::buffer<T, 1> gbIn_GB, cl::sycl::buffer<T, 1> gbOut_GB)
{
rocfftQueue.submit([&](cl::sycl::handler &cgh)
{
	auto twiddles = twiddles_GB.get_access<cl::sycl::access::mode::read>(cgh);
	...
	auto gbOut = gbOut_GB.get_access<cl::sycl::access::mode::read_write>(cgh);
	cl::sycl::accessor<real_type_t<T>,1,sycl::access::mode::read_write,sycl::access::target::local> lds(cl::sycl::range<1>(2000), cgh);
	cgh.parallel_for<class kern_fft_back_op_len2000>(
	                   cl::sycl::nd_range<3>(blocks, threads),
	                   [=](cl::sycl::nd_item<3> wItem)
{
//// Print kernel code here (after function prototype)
	...
	// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, lwb, lds
	back_len2000_device<T, sb>(twiddles, stride_in[0], stride_out[0],  1, b, me, 0, lwbIn, lwbOut, lds);
});
});
}
...
//// Print kernel code here (after function prototype)
	...
	// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, lwb, lds
	fwd_len2000_device<T, sb>(twiddles, stride_in[0], stride_out[0],  1, b, me, 0, lwbIn, lwbOutRe, lwbOutIm, lds);
});
});
}
...
//// Print kernel code here (after function prototype)
	...
	// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, lwb, lds
	back_len2000_device<T, sb>(twiddles, stride_in[0], stride_out[0],  1, b, me, 0, lwbIn, lwbOutRe, lwbOutIm, lds);
});
});
}
...
//// Print kernel code here (after function prototype)
	...
	// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, lwb, lds
	fwd_len2000_device<T, sb>(twiddles, stride_in[0], stride_out[0],  1, b, me, 0, lwbInRe, lwbInIm, lwbOut, lds);
});
});
}
...
//// Print kernel code here (after function prototype)
	...
	// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, lwb, lds
	back_len2000_device<T, sb>(twiddles, stride_in[0], stride_out[0],  1, b, me, 0, lwbInRe, lwbInIm, lwbOut, lds);
});
});
}
...
//// Print kernel code here (after function prototype)
	...
	// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, lwb, lds
	fwd_len2000_device<T, sb>(twiddles, stride_in[0], stride_out[0],  1, b, me, 0, lwbInRe, lwbInIm, lwbOutRe, lwbOutIm, lds);
});
});
}
...
//// Print kernel code here (after function prototype)
	...
	// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, lwb, lds
	back_len2000_device<T, sb>(twiddles, stride_in[0], stride_out[0],  1, b, me, 0, lwbInRe, lwbInIm, lwbOutRe, lwbOutIm, lds);
});
});
}
