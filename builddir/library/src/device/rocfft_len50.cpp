 ...
 * Kernel is: namespace(factors=[10, 5], flavour='uwide', length=50, scheme='CS_KERNEL_STOCKHAM', threads_per_block=256)
 */
...
__device__ void ip_forward_length50_SBRR_device(scalar_type* __restrict__ lds,
...
__global__
    __launch_bounds__(250) void ip_forward_length50_SBRR(const scalar_type* __restrict__ twiddles,
                                                         const size_t dim,
                                                         ...
                                                         scalar_type* __restrict__ buf)
{
    ...
    offset_lds = (50 + lds_padding) * (transform % 25); /* stockham.py:373 */
    ...
    ip_forward_length50_SBRR_device<scalar_type, SB_UNIT>(
...
/* stockham.py:709 */
template <typename scalar_type, StrideBin sb, EmbeddedType ebtype, CallbackType cbtype>
__global__ __launch_bounds__(250) void ip_forward_length50_SBRR(
    const scalar_type* __restrict__ twiddles,
    const size_t dim,
    const size_t* __restrict__ lengths,
    const size_t* __restrict__ stride,
...
/* stockham.py:765 */
template <typename scalar_type, StrideBin sb>
__device__ void op_forward_length50_SBRR_device(scalar_type* __restrict__ lds,
                                                const scalar_type* __restrict__ twiddles,
                                                size_t       stride_lds,
                                                unsigned int offset_lds,
                                                bool         write)
...
template <typename scalar_type, StrideBin sb, EmbeddedType ebtype, CallbackType cbtype>
__global__
    __launch_bounds__(250) void op_forward_length50_SBRR(const scalar_type* __restrict__ twiddles,
                                                         const size_t dim,
                                                         const size_t* __restrict__ lengths,
                                                         ...
                                                         scalar_type* __restrict__ buf_out)
{
    ...
    // transform
    write = true; /* stockham.py:681 */
    op_forward_length50_SBRR_device<scalar_type, SB_UNIT>(
        lds, twiddles, stride_lds, offset_lds, write); /* stockham.py:686 */
...
/* stockham.py:709 */
template <typename scalar_type, StrideBin sb, EmbeddedType ebtype, CallbackType cbtype>
__global__ __launch_bounds__(250) void op_forward_length50_SBRR(
    const scalar_type* __restrict__ twiddles,
    const size_t dim,
    const size_t* __restrict__ lengths,
    const size_t* __restrict__ stride_in,
...
/* stockham.py:765 */
template <typename scalar_type, StrideBin sb>
__device__ void ip_inverse_length50_SBRR_device(scalar_type* __restrict__ lds,
                                                const scalar_type* __restrict__ twiddles,
                                                size_t       stride_lds,
                                                unsigned int offset_lds,
                                                bool         write)
...
template <typename scalar_type, StrideBin sb, EmbeddedType ebtype, CallbackType cbtype>
__global__
    __launch_bounds__(250) void ip_inverse_length50_SBRR(const scalar_type* __restrict__ twiddles,
                                                         const size_t dim,
                                                         const size_t* __restrict__ lengths,
                                                         const size_t* __restrict__ stride,
                                                         const size_t       nbatch,
                                                         ...
                                                         scalar_type* __restrict__ buf)
{
    ...
    // transform
    write = true; /* stockham.py:681 */
    ip_inverse_length50_SBRR_device<scalar_type, SB_UNIT>(
        lds, twiddles, stride_lds, offset_lds, write); /* stockham.py:686 */
...
/* stockham.py:709 */
template <typename scalar_type, StrideBin sb, EmbeddedType ebtype, CallbackType cbtype>
__global__ __launch_bounds__(250) void ip_inverse_length50_SBRR(
    const scalar_type* __restrict__ twiddles,
    const size_t dim,
    const size_t* __restrict__ lengths,
    const size_t* __restrict__ stride,
...
/* stockham.py:765 */
template <typename scalar_type, StrideBin sb>
__device__ void op_inverse_length50_SBRR_device(scalar_type* __restrict__ lds,
                                                const scalar_type* __restrict__ twiddles,
                                                size_t       stride_lds,
                                                unsigned int offset_lds,
                                                bool         write)
...
template <typename scalar_type, StrideBin sb, EmbeddedType ebtype, CallbackType cbtype>
__global__
    __launch_bounds__(250) void op_inverse_length50_SBRR(const scalar_type* __restrict__ twiddles,
                                                         const size_t dim,
                                                         const size_t* __restrict__ lengths,
                                                         const size_t* __restrict__ stride_in,
                                                         const size_t* __restrict__ stride_out,
                                                         ...
                                                         scalar_type* __restrict__ buf_out)
{
    ...
    // transform
    write = true; /* stockham.py:681 */
    op_inverse_length50_SBRR_device<scalar_type, SB_UNIT>(
        lds, twiddles, stride_lds, offset_lds, write); /* stockham.py:686 */
...
/* stockham.py:709 */
template <typename scalar_type, StrideBin sb, EmbeddedType ebtype, CallbackType cbtype>
__global__ __launch_bounds__(250) void op_inverse_length50_SBRR(
    const scalar_type* __restrict__ twiddles,
    const size_t dim,
    const size_t* __restrict__ lengths,
    const size_t* __restrict__ stride_in,
...
POWX_SMALL_GENERATOR(rocfft_internal_dfn_dp_ci_ci_stoc_50,
                     ip_forward_length50_SBRR,
                     ip_inverse_length50_SBRR,
                     op_forward_length50_SBRR,
                     op_inverse_length50_SBRR,
                     double2);
POWX_SMALL_GENERATOR(rocfft_internal_dfn_sp_ci_ci_stoc_50,
                     ip_forward_length50_SBRR,
                     ip_inverse_length50_SBRR,
                     op_forward_length50_SBRR,
                     op_inverse_length50_SBRR,
