...
FwdPass0_len208(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, T *bufIn, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data)
{
	...
	(*R14) = load_cb(bufIn, inOffset + ( 0 + me*2 + 1 + 16 )*stride_in, load_cb_data, nullptr);

	(*R2) = load_cb(bufIn, inOffset + ( 0 + me*2 + 0 + 32 )*stride_in, load_cb_data, nullptr);

	(*R15) = load_cb(bufIn, inOffset + ( 0 + me*2 + 1 + 32 )*stride_in, load_cb_data, nullptr);

	(*R3) = load_cb(bufIn, inOffset + ( 0 + me*2 + 0 + 48 )*stride_in, load_cb_data, nullptr);

	(*R16) = load_cb(bufIn, inOffset + ( 0 + me*2 + 1 + 48 )*stride_in, load_cb_data, nullptr);

	(*R4) = load_cb(bufIn, inOffset + ( 0 + me*2 + 0 + 64 )*stride_in, load_cb_data, nullptr);

	(*R17) = load_cb(bufIn, inOffset + ( 0 + me*2 + 1 + 64 )*stride_in, load_cb_data, nullptr);

	(*R5) = load_cb(bufIn, inOffset + ( 0 + me*2 + 0 + 80 )*stride_in, load_cb_data, nullptr);

	(*R18) = load_cb(bufIn, inOffset + ( 0 + me*2 + 1 + 80 )*stride_in, load_cb_data, nullptr);

	(*R6) = load_cb(bufIn, inOffset + ( 0 + me*2 + 0 + 96 )*stride_in, load_cb_data, nullptr);

	(*R19) = load_cb(bufIn, inOffset + ( 0 + me*2 + 1 + 96 )*stride_in, load_cb_data, nullptr);

	(*R7) = load_cb(bufIn, inOffset + ( 0 + me*2 + 0 + 112 )*stride_in, load_cb_data, nullptr);

	(*R20) = load_cb(bufIn, inOffset + ( 0 + me*2 + 1 + 112 )*stride_in, load_cb_data, nullptr);

	(*R8) = load_cb(bufIn, inOffset + ( 0 + me*2 + 0 + 128 )*stride_in, load_cb_data, nullptr);

	(*R21) = load_cb(bufIn, inOffset + ( 0 + me*2 + 1 + 128 )*stride_in, load_cb_data, nullptr);

	(*R9) = load_cb(bufIn, inOffset + ( 0 + me*2 + 0 + 144 )*stride_in, load_cb_data, nullptr);

	(*R22) = load_cb(bufIn, inOffset + ( 0 + me*2 + 1 + 144 )*stride_in, load_cb_data, nullptr);

	(*R10) = load_cb(bufIn, inOffset + ( 0 + me*2 + 0 + 160 )*stride_in, load_cb_data, nullptr);

	(*R23) = load_cb(bufIn, inOffset + ( 0 + me*2 + 1 + 160 )*stride_in, load_cb_data, nullptr);

	(*R11) = load_cb(bufIn, inOffset + ( 0 + me*2 + 0 + 176 )*stride_in, load_cb_data, nullptr);

	(*R24) = load_cb(bufIn, inOffset + ( 0 + me*2 + 1 + 176 )*stride_in, load_cb_data, nullptr);

	(*R12) = load_cb(bufIn, inOffset + ( 0 + me*2 + 0 + 192 )*stride_in, load_cb_data, nullptr);

	(*R25) = load_cb(bufIn, inOffset + ( 0 + me*2 + 1 + 192 )*stride_in, load_cb_data, nullptr);
	...
	(*R1).x = bufOutRe[outOffset + ( 0 + me*13 + 0 + 104 ) ];
	(*R3).x = bufOutRe[outOffset + ( 0 + me*13 + 1 + 104 ) ];
	(*R5).x = bufOutRe[outOffset + ( 0 + me*13 + 2 + 104 ) ];
	(*R7).x = bufOutRe[outOffset + ( 0 + me*13 + 3 + 104 ) ];
	(*R9).x = bufOutRe[outOffset + ( 0 + me*13 + 4 + 104 ) ];
	(*R11).x = bufOutRe[outOffset + ( 0 + me*13 + 5 + 104 ) ];
	(*R13).x = bufOutRe[outOffset + ( 0 + me*13 + 6 + 104 ) ];
	(*R15).x = bufOutRe[outOffset + ( 0 + me*13 + 7 + 104 ) ];
	(*R17).x = bufOutRe[outOffset + ( 0 + me*13 + 8 + 104 ) ];
	(*R19).x = bufOutRe[outOffset + ( 0 + me*13 + 9 + 104 ) ];
	(*R21).x = bufOutRe[outOffset + ( 0 + me*13 + 10 + 104 ) ];
	(*R23).x = bufOutRe[outOffset + ( 0 + me*13 + 11 + 104 ) ];
	(*R25).x = bufOutRe[outOffset + ( 0 + me*13 + 12 + 104 ) ];
	}
	...
	(*R1).y = bufOutIm[outOffset + ( 0 + me*13 + 0 + 104 ) ];
	(*R3).y = bufOutIm[outOffset + ( 0 + me*13 + 1 + 104 ) ];
	(*R5).y = bufOutIm[outOffset + ( 0 + me*13 + 2 + 104 ) ];
	(*R7).y = bufOutIm[outOffset + ( 0 + me*13 + 3 + 104 ) ];
	(*R9).y = bufOutIm[outOffset + ( 0 + me*13 + 4 + 104 ) ];
	(*R11).y = bufOutIm[outOffset + ( 0 + me*13 + 5 + 104 ) ];
	(*R13).y = bufOutIm[outOffset + ( 0 + me*13 + 6 + 104 ) ];
	(*R15).y = bufOutIm[outOffset + ( 0 + me*13 + 7 + 104 ) ];
	(*R17).y = bufOutIm[outOffset + ( 0 + me*13 + 8 + 104 ) ];
	(*R19).y = bufOutIm[outOffset + ( 0 + me*13 + 9 + 104 ) ];
	(*R21).y = bufOutIm[outOffset + ( 0 + me*13 + 10 + 104 ) ];
	(*R23).y = bufOutIm[outOffset + ( 0 + me*13 + 11 + 104 ) ];
	(*R25).y = bufOutIm[outOffset + ( 0 + me*13 + 12 + 104 ) ];
	}
...
FwdPass0_len208(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data)
{
	...
	(*R14).x = bufInRe[inOffset + ( 0 + me*2 + 1 + 16 )*stride_in];
	(*R14).y = bufInIm[inOffset + ( 0 + me*2 + 1 + 16 )*stride_in];
	...
	(*R16).x = bufInRe[inOffset + ( 0 + me*2 + 1 + 48 )*stride_in];
	(*R16).y = bufInIm[inOffset + ( 0 + me*2 + 1 + 48 )*stride_in];
	(*R4).x = bufInRe[inOffset + ( 0 + me*2 + 0 + 64 )*stride_in];
	(*R4).y = bufInIm[inOffset + ( 0 + me*2 + 0 + 64 )*stride_in];
	(*R17).x = bufInRe[inOffset + ( 0 + me*2 + 1 + 64 )*stride_in];
	(*R17).y = bufInIm[inOffset + ( 0 + me*2 + 1 + 64 )*stride_in];
	(*R5).x = bufInRe[inOffset + ( 0 + me*2 + 0 + 80 )*stride_in];
	(*R5).y = bufInIm[inOffset + ( 0 + me*2 + 0 + 80 )*stride_in];
	(*R18).x = bufInRe[inOffset + ( 0 + me*2 + 1 + 80 )*stride_in];
	(*R18).y = bufInIm[inOffset + ( 0 + me*2 + 1 + 80 )*stride_in];
	(*R6).x = bufInRe[inOffset + ( 0 + me*2 + 0 + 96 )*stride_in];
	(*R6).y = bufInIm[inOffset + ( 0 + me*2 + 0 + 96 )*stride_in];
	(*R19).x = bufInRe[inOffset + ( 0 + me*2 + 1 + 96 )*stride_in];
	(*R19).y = bufInIm[inOffset + ( 0 + me*2 + 1 + 96 )*stride_in];
	(*R7).x = bufInRe[inOffset + ( 0 + me*2 + 0 + 112 )*stride_in];
	(*R7).y = bufInIm[inOffset + ( 0 + me*2 + 0 + 112 )*stride_in];
	(*R20).x = bufInRe[inOffset + ( 0 + me*2 + 1 + 112 )*stride_in];
	(*R20).y = bufInIm[inOffset + ( 0 + me*2 + 1 + 112 )*stride_in];
	(*R8).x = bufInRe[inOffset + ( 0 + me*2 + 0 + 128 )*stride_in];
	(*R8).y = bufInIm[inOffset + ( 0 + me*2 + 0 + 128 )*stride_in];
	(*R21).x = bufInRe[inOffset + ( 0 + me*2 + 1 + 128 )*stride_in];
	(*R21).y = bufInIm[inOffset + ( 0 + me*2 + 1 + 128 )*stride_in];
	(*R9).x = bufInRe[inOffset + ( 0 + me*2 + 0 + 144 )*stride_in];
	(*R9).y = bufInIm[inOffset + ( 0 + me*2 + 0 + 144 )*stride_in];
	(*R22).x = bufInRe[inOffset + ( 0 + me*2 + 1 + 144 )*stride_in];
	(*R22).y = bufInIm[inOffset + ( 0 + me*2 + 1 + 144 )*stride_in];
	(*R10).x = bufInRe[inOffset + ( 0 + me*2 + 0 + 160 )*stride_in];
	(*R10).y = bufInIm[inOffset + ( 0 + me*2 + 0 + 160 )*stride_in];
	(*R23).x = bufInRe[inOffset + ( 0 + me*2 + 1 + 160 )*stride_in];
	(*R23).y = bufInIm[inOffset + ( 0 + me*2 + 1 + 160 )*stride_in];
	(*R11).x = bufInRe[inOffset + ( 0 + me*2 + 0 + 176 )*stride_in];
	(*R11).y = bufInIm[inOffset + ( 0 + me*2 + 0 + 176 )*stride_in];
	(*R24).x = bufInRe[inOffset + ( 0 + me*2 + 1 + 176 )*stride_in];
	(*R24).y = bufInIm[inOffset + ( 0 + me*2 + 1 + 176 )*stride_in];
	(*R12).x = bufInRe[inOffset + ( 0 + me*2 + 0 + 192 )*stride_in];
	(*R12).y = bufInIm[inOffset + ( 0 + me*2 + 0 + 192 )*stride_in];
	(*R25).x = bufInRe[inOffset + ( 0 + me*2 + 1 + 192 )*stride_in];
	(*R25).y = bufInIm[inOffset + ( 0 + me*2 + 1 + 192 )*stride_in];
	}
...
template <typename T, StrideBin sb, CallbackType cbtype>
__device__ void
FwdPass2_len208(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25)
{
...
template <typename T, StrideBin sb, CallbackType cbtype>
__device__ void
FwdPass3_len208(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25)
{
	...
	if(rw)
	{
	bufOutRe[outOffset + ( ((13*me + 0)/52)*104 + (13*me + 0)%52 + 0 ) ] = (*R0).x;
	bufOutRe[outOffset + ( ((13*me + 0)/52)*104 + (13*me + 0)%52 + 52 ) ] = (*R1).x;
	bufOutRe[outOffset + ( ((13*me + 1)/52)*104 + (13*me + 1)%52 + 0 ) ] = (*R2).x;
	bufOutRe[outOffset + ( ((13*me + 1)/52)*104 + (13*me + 1)%52 + 52 ) ] = (*R3).x;
	bufOutRe[outOffset + ( ((13*me + 2)/52)*104 + (13*me + 2)%52 + 0 ) ] = (*R4).x;
	bufOutRe[outOffset + ( ((13*me + 2)/52)*104 + (13*me + 2)%52 + 52 ) ] = (*R5).x;
	bufOutRe[outOffset + ( ((13*me + 3)/52)*104 + (13*me + 3)%52 + 0 ) ] = (*R6).x;
	bufOutRe[outOffset + ( ((13*me + 3)/52)*104 + (13*me + 3)%52 + 52 ) ] = (*R7).x;
	bufOutRe[outOffset + ( ((13*me + 4)/52)*104 + (13*me + 4)%52 + 0 ) ] = (*R8).x;
	bufOutRe[outOffset + ( ((13*me + 4)/52)*104 + (13*me + 4)%52 + 52 ) ] = (*R9).x;
	bufOutRe[outOffset + ( ((13*me + 5)/52)*104 + (13*me + 5)%52 + 0 ) ] = (*R10).x;
	bufOutRe[outOffset + ( ((13*me + 5)/52)*104 + (13*me + 5)%52 + 52 ) ] = (*R11).x;
	bufOutRe[outOffset + ( ((13*me + 6)/52)*104 + (13*me + 6)%52 + 0 ) ] = (*R12).x;
	bufOutRe[outOffset + ( ((13*me + 6)/52)*104 + (13*me + 6)%52 + 52 ) ] = (*R13).x;
	bufOutRe[outOffset + ( ((13*me + 7)/52)*104 + (13*me + 7)%52 + 0 ) ] = (*R14).x;
	bufOutRe[outOffset + ( ((13*me + 7)/52)*104 + (13*me + 7)%52 + 52 ) ] = (*R15).x;
	bufOutRe[outOffset + ( ((13*me + 8)/52)*104 + (13*me + 8)%52 + 0 ) ] = (*R16).x;
	bufOutRe[outOffset + ( ((13*me + 8)/52)*104 + (13*me + 8)%52 + 52 ) ] = (*R17).x;
	bufOutRe[outOffset + ( ((13*me + 9)/52)*104 + (13*me + 9)%52 + 0 ) ] = (*R18).x;
	bufOutRe[outOffset + ( ((13*me + 9)/52)*104 + (13*me + 9)%52 + 52 ) ] = (*R19).x;
	bufOutRe[outOffset + ( ((13*me + 10)/52)*104 + (13*me + 10)%52 + 0 ) ] = (*R20).x;
	bufOutRe[outOffset + ( ((13*me + 10)/52)*104 + (13*me + 10)%52 + 52 ) ] = (*R21).x;
	bufOutRe[outOffset + ( ((13*me + 11)/52)*104 + (13*me + 11)%52 + 0 ) ] = (*R22).x;
	bufOutRe[outOffset + ( ((13*me + 11)/52)*104 + (13*me + 11)%52 + 52 ) ] = (*R23).x;
	bufOutRe[outOffset + ( ((13*me + 12)/52)*104 + (13*me + 12)%52 + 0 ) ] = (*R24).x;
	bufOutRe[outOffset + ( ((13*me + 12)/52)*104 + (13*me + 12)%52 + 52 ) ] = (*R25).x;
	}
	...
	if(rw)
	{
	bufOutIm[outOffset + ( ((13*me + 0)/52)*104 + (13*me + 0)%52 + 0 ) ] = (*R0).y;
	bufOutIm[outOffset + ( ((13*me + 0)/52)*104 + (13*me + 0)%52 + 52 ) ] = (*R1).y;
	bufOutIm[outOffset + ( ((13*me + 1)/52)*104 + (13*me + 1)%52 + 0 ) ] = (*R2).y;
	bufOutIm[outOffset + ( ((13*me + 1)/52)*104 + (13*me + 1)%52 + 52 ) ] = (*R3).y;
	bufOutIm[outOffset + ( ((13*me + 2)/52)*104 + (13*me + 2)%52 + 0 ) ] = (*R4).y;
	bufOutIm[outOffset + ( ((13*me + 2)/52)*104 + (13*me + 2)%52 + 52 ) ] = (*R5).y;
	bufOutIm[outOffset + ( ((13*me + 3)/52)*104 + (13*me + 3)%52 + 0 ) ] = (*R6).y;
	bufOutIm[outOffset + ( ((13*me + 3)/52)*104 + (13*me + 3)%52 + 52 ) ] = (*R7).y;
	bufOutIm[outOffset + ( ((13*me + 4)/52)*104 + (13*me + 4)%52 + 0 ) ] = (*R8).y;
	bufOutIm[outOffset + ( ((13*me + 4)/52)*104 + (13*me + 4)%52 + 52 ) ] = (*R9).y;
	bufOutIm[outOffset + ( ((13*me + 5)/52)*104 + (13*me + 5)%52 + 0 ) ] = (*R10).y;
	bufOutIm[outOffset + ( ((13*me + 5)/52)*104 + (13*me + 5)%52 + 52 ) ] = (*R11).y;
	bufOutIm[outOffset + ( ((13*me + 6)/52)*104 + (13*me + 6)%52 + 0 ) ] = (*R12).y;
	bufOutIm[outOffset + ( ((13*me + 6)/52)*104 + (13*me + 6)%52 + 52 ) ] = (*R13).y;
	bufOutIm[outOffset + ( ((13*me + 7)/52)*104 + (13*me + 7)%52 + 0 ) ] = (*R14).y;
	bufOutIm[outOffset + ( ((13*me + 7)/52)*104 + (13*me + 7)%52 + 52 ) ] = (*R15).y;
	bufOutIm[outOffset + ( ((13*me + 8)/52)*104 + (13*me + 8)%52 + 0 ) ] = (*R16).y;
	bufOutIm[outOffset + ( ((13*me + 8)/52)*104 + (13*me + 8)%52 + 52 ) ] = (*R17).y;
	bufOutIm[outOffset + ( ((13*me + 9)/52)*104 + (13*me + 9)%52 + 0 ) ] = (*R18).y;
	bufOutIm[outOffset + ( ((13*me + 9)/52)*104 + (13*me + 9)%52 + 52 ) ] = (*R19).y;
	bufOutIm[outOffset + ( ((13*me + 10)/52)*104 + (13*me + 10)%52 + 0 ) ] = (*R20).y;
	bufOutIm[outOffset + ( ((13*me + 10)/52)*104 + (13*me + 10)%52 + 52 ) ] = (*R21).y;
	bufOutIm[outOffset + ( ((13*me + 11)/52)*104 + (13*me + 11)%52 + 0 ) ] = (*R22).y;
	bufOutIm[outOffset + ( ((13*me + 11)/52)*104 + (13*me + 11)%52 + 52 ) ] = (*R23).y;
	bufOutIm[outOffset + ( ((13*me + 12)/52)*104 + (13*me + 12)%52 + 0 ) ] = (*R24).y;
	bufOutIm[outOffset + ( ((13*me + 12)/52)*104 + (13*me + 12)%52 + 52 ) ] = (*R25).y;
	}
...
FwdPass4_len208(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, T *bufOut, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data)
{
	...
	{
		T W = twiddles[103 + 1*((13*me + 0)%104) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R1).x; ry = (*R1).y;
	...
	{
		T W = twiddles[103 + 1*((13*me + 1)%104) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R3).x; ry = (*R3).y;
	...
	{
		T W = twiddles[103 + 1*((13*me + 2)%104) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R5).x; ry = (*R5).y;
	...
	{
		T W = twiddles[103 + 1*((13*me + 3)%104) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R7).x; ry = (*R7).y;
	...
	{
		T W = twiddles[103 + 1*((13*me + 4)%104) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R9).x; ry = (*R9).y;
	...
	{
		T W = twiddles[103 + 1*((13*me + 5)%104) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R11).x; ry = (*R11).y;
	...
	{
		T W = twiddles[103 + 1*((13*me + 6)%104) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R13).x; ry = (*R13).y;
	...
	{
		T W = twiddles[103 + 1*((13*me + 7)%104) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R15).x; ry = (*R15).y;
	...
	{
		T W = twiddles[103 + 1*((13*me + 8)%104) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R17).x; ry = (*R17).y;
	...
	{
		T W = twiddles[103 + 1*((13*me + 9)%104) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R19).x; ry = (*R19).y;
	...
	{
		T W = twiddles[103 + 1*((13*me + 10)%104) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R21).x; ry = (*R21).y;
	...
	{
		T W = twiddles[103 + 1*((13*me + 11)%104) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R23).x; ry = (*R23).y;
	...
	{
		T W = twiddles[103 + 1*((13*me + 12)%104) + 0];
		real_type_t<T> TR, TI;
		real_type_t<T>wx, wy, rx, ry;
		wx = W.x; wy = W.y;
		rx = (*R25).x; ry = (*R25).y;
	...
	store_cb(bufOut, outOffset + ( 13*me + 0 + 104 )*stride_out, (*R1), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 13*me + 1 + 104 )*stride_out, (*R3), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 13*me + 2 + 104 )*stride_out, (*R5), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 13*me + 3 + 104 )*stride_out, (*R7), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 13*me + 4 + 104 )*stride_out, (*R9), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 13*me + 5 + 104 )*stride_out, (*R11), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 13*me + 6 + 104 )*stride_out, (*R13), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 13*me + 7 + 104 )*stride_out, (*R15), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 13*me + 8 + 104 )*stride_out, (*R17), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 13*me + 9 + 104 )*stride_out, (*R19), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 13*me + 10 + 104 )*stride_out, (*R21), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 13*me + 11 + 104 )*stride_out, (*R23), store_cb_data, nullptr);

	store_cb(bufOut, outOffset + ( 13*me + 12 + 104 )*stride_out, (*R25), store_cb_data, nullptr);
...
FwdPass4_len208(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data)
{
	...
	bufOutRe[outOffset + ( 13*me + 0 + 104 )*stride_out] = (*R1).x;
	bufOutIm[outOffset + ( 13*me + 0 + 104 )*stride_out] = (*R1).y;
	bufOutRe[outOffset + ( 13*me + 1 + 104 )*stride_out] = (*R3).x;
	bufOutIm[outOffset + ( 13*me + 1 + 104 )*stride_out] = (*R3).y;
	bufOutRe[outOffset + ( 13*me + 2 + 104 )*stride_out] = (*R5).x;
	bufOutIm[outOffset + ( 13*me + 2 + 104 )*stride_out] = (*R5).y;
	bufOutRe[outOffset + ( 13*me + 3 + 104 )*stride_out] = (*R7).x;
	bufOutIm[outOffset + ( 13*me + 3 + 104 )*stride_out] = (*R7).y;
	bufOutRe[outOffset + ( 13*me + 4 + 104 )*stride_out] = (*R9).x;
	bufOutIm[outOffset + ( 13*me + 4 + 104 )*stride_out] = (*R9).y;
	bufOutRe[outOffset + ( 13*me + 5 + 104 )*stride_out] = (*R11).x;
	bufOutIm[outOffset + ( 13*me + 5 + 104 )*stride_out] = (*R11).y;
	bufOutRe[outOffset + ( 13*me + 6 + 104 )*stride_out] = (*R13).x;
	bufOutIm[outOffset + ( 13*me + 6 + 104 )*stride_out] = (*R13).y;
	bufOutRe[outOffset + ( 13*me + 7 + 104 )*stride_out] = (*R15).x;
	bufOutIm[outOffset + ( 13*me + 7 + 104 )*stride_out] = (*R15).y;
	bufOutRe[outOffset + ( 13*me + 8 + 104 )*stride_out] = (*R17).x;
	bufOutIm[outOffset + ( 13*me + 8 + 104 )*stride_out] = (*R17).y;
	bufOutRe[outOffset + ( 13*me + 9 + 104 )*stride_out] = (*R19).x;
	bufOutIm[outOffset + ( 13*me + 9 + 104 )*stride_out] = (*R19).y;
	bufOutRe[outOffset + ( 13*me + 10 + 104 )*stride_out] = (*R21).x;
	bufOutIm[outOffset + ( 13*me + 10 + 104 )*stride_out] = (*R21).y;
	bufOutRe[outOffset + ( 13*me + 11 + 104 )*stride_out] = (*R23).x;
	bufOutIm[outOffset + ( 13*me + 11 + 104 )*stride_out] = (*R23).y;
	bufOutRe[outOffset + ( 13*me + 12 + 104 )*stride_out] = (*R25).x;
	bufOutIm[outOffset + ( 13*me + 12 + 104 )*stride_out] = (*R25).y;
	}
...
template <typename T, StrideBin sb, CallbackType cbtype>
__device__ void
InvPass0_len208(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, T *bufIn, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data)
{
...
template <typename T, StrideBin sb, CallbackType cbtype>
__device__ void
InvPass1_len208(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25)
{
...
template <typename T, StrideBin sb, CallbackType cbtype>
__device__ void
InvPass2_len208(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25)
{
...
template <typename T, StrideBin sb, CallbackType cbtype>
__device__ void
InvPass3_len208(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25)
{
...
template <typename T, StrideBin sb, CallbackType cbtype>
__device__ void
InvPass4_len208(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, T *bufOut, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9, T *R10, T *R11, T *R12, T *R13, T *R14, T *R15, T *R16, T *R17, T *R18, T *R19, T *R20, T *R21, T *R22, T *R23, T *R24, T *R25, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data)
{
...
template <typename T, StrideBin sb,CallbackType cbtype>
__device__ void 
fwd_len208_device(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *gbIn, unsigned int iOffset, T *gbOut, unsigned int oOffset, real_type_t<T> *lds, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19, R20, R21, R22, R23, R24, R25;
	FwdPass0_len208<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, iOffset, ldsOffset,  gbIn, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, load_cb_fn, load_cb_data);
	FwdPass1_len208<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25);
	FwdPass2_len208<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25);
	FwdPass3_len208<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25);
	FwdPass4_len208<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, oOffset, lds, lds,  gbOut, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}

template <typename T, StrideBin sb,CallbackType cbtype>
__device__ void 
back_len208_device(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *gbIn, unsigned int iOffset, T *gbOut, unsigned int oOffset, real_type_t<T> *lds, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19, R20, R21, R22, R23, R24, R25;
	InvPass0_len208<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, iOffset, ldsOffset,  gbIn, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, load_cb_fn, load_cb_data);
	InvPass1_len208<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25);
	InvPass2_len208<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25);
	InvPass3_len208<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25);
	InvPass4_len208<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, oOffset, lds, lds,  gbOut, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fwd_len208_device(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *gbIn, unsigned int iOffset, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, unsigned int oOffset, real_type_t<T> *lds, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data)
{
	...
	FwdPass2_len208<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25);
	FwdPass3_len208<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25);
	FwdPass4_len208<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, oOffset, lds, lds, bufOutRe, bufOutIm, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
back_len208_device(const T * const twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *gbIn, unsigned int iOffset, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, unsigned int oOffset, real_type_t<T> *lds, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data)
{
	...
	InvPass2_len208<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25);
	InvPass3_len208<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25);
	InvPass4_len208<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, oOffset, lds, lds, bufOutRe, bufOutIm, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19, R20, R21, R22, R23, R24, R25;
	FwdPass0_len208<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, iOffset, ldsOffset,  bufInRe, bufInIm, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, load_cb_fn, load_cb_data);
	FwdPass1_len208<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25);
	FwdPass2_len208<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25);
	FwdPass3_len208<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25);
	FwdPass4_len208<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, oOffset, lds, lds,  gbOut, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, load_cb_lds_bytes, store_cb_fn, store_cb_data);
...
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19, R20, R21, R22, R23, R24, R25;
	InvPass0_len208<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, iOffset, ldsOffset,  bufInRe, bufInIm, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, load_cb_fn, load_cb_data);
	InvPass1_len208<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25);
	InvPass2_len208<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25);
	InvPass3_len208<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, lds, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25);
	InvPass4_len208<T, sb, cbtype>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, oOffset, lds, lds,  gbOut, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9, &R10, &R11, &R12, &R13, &R14, &R15, &R16, &R17, &R18, &R19, &R20, &R21, &R22, &R23, &R24, &R25, load_cb_lds_bytes, store_cb_fn, store_cb_data);
...
fft_fwd_ip_len208( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, T * __restrict__ gb)
{
	...
	fwd_len208_device<T, sb, cbtype>(twiddles, stride_in[0], stride_in[0],  rw, b, me%8, (me/8)*208, gb, ioOffset, gb, ioOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
__global__ void
__launch_bounds__(128)
fft_back_ip_len208( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, T * __restrict__ gb)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	back_len208_device<T, sb, cbtype>(twiddles, stride_in[0], stride_in[0],  rw, b, me%8, (me/8)*208, gb, ioOffset, gb, ioOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_fwd_ip_len208( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, real_type_t<T> * __restrict__ gbRe, real_type_t<T> * __restrict__ gbIm)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	fwd_len208_device<T, sb, cbtype>(twiddles, stride_in[0], stride_in[0],  rw, b, me%8, (me/8)*208, gbRe, gbIm, ioOffset, gbRe, gbIm, ioOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_back_ip_len208( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, real_type_t<T> * __restrict__ gbRe, real_type_t<T> * __restrict__ gbIm)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	back_len208_device<T, sb, cbtype>(twiddles, stride_in[0], stride_in[0],  rw, b, me%8, (me/8)*208, gbRe, gbIm, ioOffset, gbRe, gbIm, ioOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_fwd_op_len208( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, T * __restrict__ gbIn, T * __restrict__ gbOut)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	fwd_len208_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  rw, b, me%8, (me/8)*208, gbIn, iOffset, gbOut, oOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
__global__ void
__launch_bounds__(128)
fft_back_op_len208( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, T * __restrict__ gbIn, T * __restrict__ gbOut)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	back_len208_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  rw, b, me%8, (me/8)*208, gbIn, iOffset, gbOut, oOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_fwd_op_len208( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, T * __restrict__ gbIn, real_type_t<T> * __restrict__ gbOutRe, real_type_t<T> * __restrict__ gbOutIm)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	fwd_len208_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  rw, b, me%8, (me/8)*208, gbIn, iOffset, gbOutRe, gbOutIm, oOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_back_op_len208( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, T * __restrict__ gbIn, real_type_t<T> * __restrict__ gbOutRe, real_type_t<T> * __restrict__ gbOutIm)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	back_len208_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  rw, b, me%8, (me/8)*208, gbIn, iOffset, gbOutRe, gbOutIm, oOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_fwd_op_len208( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, real_type_t<T> * __restrict__ gbInRe, real_type_t<T> * __restrict__ gbInIm, T * __restrict__ gbOut)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	fwd_len208_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  rw, b, me%8, (me/8)*208, gbInRe, gbInIm, iOffset, gbOut, oOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_back_op_len208( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, real_type_t<T> * __restrict__ gbInRe, real_type_t<T> * __restrict__ gbInIm, T * __restrict__ gbOut)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	back_len208_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  rw, b, me%8, (me/8)*208, gbInRe, gbInIm, iOffset, gbOut, oOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_fwd_op_len208( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, real_type_t<T> * __restrict__ gbInRe, real_type_t<T> * __restrict__ gbInIm, real_type_t<T> * __restrict__ gbOutRe, real_type_t<T> * __restrict__ gbOutIm)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	fwd_len208_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  rw, b, me%8, (me/8)*208, gbInRe, gbInIm, iOffset, gbOutRe, gbOutIm, oOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
...
fft_back_op_len208( const T * __restrict__ twiddles, const size_t dim, const size_t *lengths, const size_t *stride_in, const size_t *stride_out, const size_t batch_count, const unsigned int lds_padding, void* __restrict__ load_cb_fn, void* __restrict__ load_cb_data, uint32_t load_cb_lds_bytes, void* __restrict__ store_cb_fn, void* __restrict__ store_cb_data, real_type_t<T> * __restrict__ gbInRe, real_type_t<T> * __restrict__ gbInIm, real_type_t<T> * __restrict__ gbOutRe, real_type_t<T> * __restrict__ gbOutIm)
{
	...
	// Perform FFT input: gb(In) ; output: gb(Out); working space: lds 
	// rw, b, me% control read/write; then ldsOffset, gb, lds
	back_len208_device<T, sb, cbtype>(twiddles, stride_in[0], stride_out[0],  rw, b, me%8, (me/8)*208, gbInRe, gbInIm, iOffset, gbOutRe, gbOutIm, oOffset, lds, load_cb_fn, load_cb_data, load_cb_lds_bytes, store_cb_fn, store_cb_data);
}
