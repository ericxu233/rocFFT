...
__device__ void
FwdPass0_len256_sbrc(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, T *bufIn, T *bufOut, T *R0, T *R1, T *R2, T *R3)
{
...
template <typename T, StrideBin sb>
__device__ void
FwdPass1_len256_sbrc(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, T *bufIn, T *bufOut, T *R0, T *R1, T *R2, T *R3)
{
...
template <typename T, StrideBin sb>
__device__ void
FwdPass2_len256_sbrc(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, T *bufIn, T *bufOut, T *R0, T *R1, T *R2, T *R3)
{
...
template <typename T, StrideBin sb>
__device__ void
FwdPass3_len256_sbrc(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, T *bufIn, T *bufOut, T *R0, T *R1, T *R2, T *R3)
{
...
template <typename T, StrideBin sb>
__device__ void
InvPass0_len256_sbrc(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, T *bufIn, T *bufOut, T *R0, T *R1, T *R2, T *R3)
{
...
template <typename T, StrideBin sb>
__device__ void
InvPass1_len256_sbrc(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, T *bufIn, T *bufOut, T *R0, T *R1, T *R2, T *R3)
{
...
template <typename T, StrideBin sb>
__device__ void
InvPass2_len256_sbrc(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, T *bufIn, T *bufOut, T *R0, T *R1, T *R2, T *R3)
{
...
template <typename T, StrideBin sb>
__device__ void
InvPass3_len256_sbrc(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, T *bufIn, T *bufOut, T *R0, T *R1, T *R2, T *R3)
{
...
template <typename T, StrideBin sb>
__device__ void 
fwd_len256_sbrc_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *lwbIn, T *lwbOut, T *lds)
{
	T R0, R1, R2, R3;
	FwdPass0_len256_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset,  lwbIn, lds, &R0, &R1, &R2, &R3);
	__syncthreads();
	FwdPass1_len256_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, &R0, &R1, &R2, &R3);
	__syncthreads();
	FwdPass2_len256_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, &R0, &R1, &R2, &R3);
	__syncthreads();
	FwdPass3_len256_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds,  lwbOut, &R0, &R1, &R2, &R3);
	__syncthreads();
}

template <typename T, StrideBin sb>
__device__ void 
back_len256_sbrc_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *lwbIn, T *lwbOut, T *lds)
{
	T R0, R1, R2, R3;
	InvPass0_len256_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset,  lwbIn, lds, &R0, &R1, &R2, &R3);
	__syncthreads();
	InvPass1_len256_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, &R0, &R1, &R2, &R3);
	__syncthreads();
	InvPass2_len256_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, &R0, &R1, &R2, &R3);
	__syncthreads();
	InvPass3_len256_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds,  lwbOut, &R0, &R1, &R2, &R3);
	__syncthreads();
}

template <typename T, StrideBin sb>
__device__ void 
fwd_len256_sbrc_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *lwbIn, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *lds)
{
	T R0, R1, R2, R3;
	FwdPass0_len256_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset,  lwbIn, lds, &R0, &R1, &R2, &R3);
	__syncthreads();
	...
	FwdPass2_len256_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, &R0, &R1, &R2, &R3);
	__syncthreads();
	FwdPass3_len256_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, bufOutRe, bufOutIm, &R0, &R1, &R2, &R3);
	__syncthreads();
}

template <typename T, StrideBin sb>
__device__ void 
back_len256_sbrc_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *lwbIn, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *lds)
{
	T R0, R1, R2, R3;
	InvPass0_len256_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset,  lwbIn, lds, &R0, &R1, &R2, &R3);
	__syncthreads();
	...
	InvPass2_len256_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, &R0, &R1, &R2, &R3);
	__syncthreads();
	InvPass3_len256_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, bufOutRe, bufOutIm, &R0, &R1, &R2, &R3);
	__syncthreads();
}

template <typename T, StrideBin sb>
__device__ void 
fwd_len256_sbrc_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, T *lwbOut, T *lds)
{
	T R0, R1, R2, R3;
	FwdPass0_len256_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset,  bufInRe, bufInIm, lds, &R0, &R1, &R2, &R3);
	__syncthreads();
	FwdPass1_len256_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, &R0, &R1, &R2, &R3);
	__syncthreads();
	FwdPass2_len256_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, &R0, &R1, &R2, &R3);
...
template <typename T, StrideBin sb>
__device__ void 
back_len256_sbrc_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, T *lwbOut, T *lds)
{
	T R0, R1, R2, R3;
	InvPass0_len256_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset,  bufInRe, bufInIm, lds, &R0, &R1, &R2, &R3);
	__syncthreads();
	InvPass1_len256_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, &R0, &R1, &R2, &R3);
	__syncthreads();
	InvPass2_len256_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, lds, &R0, &R1, &R2, &R3);
...
template <typename T, StrideBin sb>
__device__ void 
fwd_len256_sbrc_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *lds)
{
	T R0, R1, R2, R3;
	FwdPass0_len256_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset,  bufInRe, bufInIm, lds, &R0, &R1, &R2, &R3);
	__syncthreads();
...
template <typename T, StrideBin sb>
__device__ void 
back_len256_sbrc_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *lds)
{
	T R0, R1, R2, R3;
	InvPass0_len256_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset,  bufInRe, bufInIm, lds, &R0, &R1, &R2, &R3);
	__syncthreads();
...
rocfftQueue.submit([&](cl::sycl::handler &cgh)
{
	...
	cgh.parallel_for<class kern_fft_fwd_op_len256_sbrc>(
...
//// Print kernel code here (after function prototype)
	...
	for(unsigned int t=0; t<8; t++) // generator.kernel.hpp:1657
	{
		...
		{
			R0 = lwbIn[me % 256 * stride_in[0] + ((me /256 * 32) + t % 8)*stride_in[2] + t / 8 * 256 * stride_in[0]];
		}
	...
	for(unsigned int t=0; t<2; t++) // generator.kernel.hpp:1847
	{
		...
		fwd_len256_sbrc_device<T, sb>(twiddles, stride_in[0], stride_out[0],  1, b, me%64, t * (256 + lds_row_padding) * 4 + (me/64)*(256+ lds_row_padding), lds, lds, lds);
	...
	if (Tsbrc == SBRC_3D_FFT_ERC_TRANS_Z_XY)
	{
		...
		{
			post_process_interleaved_inplace<T, true>(me, 256 - me, 256, 128, &lds[r * (256 + lds_row_padding)], &twiddles[256]);
		}
		__syncthreads();
	}
	...
	for(unsigned int t=0; t<8; t++) // generator.kernel.hpp:1970
	{
		...
		if(Tsbrc == SBRC_2D)
		{
			lwbOut[(me%8) * stride_out[1] + (me/8)*stride_out[0] + t*stride_out[0]*32] = R0;
		}
		else if(Tsbrc == SBRC_3D_FFT_TRANS_XY_Z)
		{
			lwbOut[(me%8) * stride_out[0] + (me/8)*stride_out[1] + t*stride_out[1]*32] = R0;
		}
		else if(Tsbrc == SBRC_3D_FFT_TRANS_Z_XY || Tsbrc == SBRC_3D_FFT_ERC_TRANS_Z_XY)
		{
			lwbOut[(me%8) * stride_out[0] + (me/8)*stride_out[2] + t*stride_out[2]*32] = R0;
		}
	}
...
rocfftQueue.submit([&](cl::sycl::handler &cgh)
{
	...
	auto gbOut = gbOut_GB.get_access<cl::sycl::access::mode::read_write>(cgh);
	cl::sycl::accessor<T,1,sycl::access::mode::read_write,sycl::access::target::local> lds(cl::sycl::range<1>(2056), cgh);
	cgh.parallel_for<class kern_fft_back_op_len256_sbrc>(
	                   cl::sycl::nd_range<3>(blocks, threads),
	                   [=](cl::sycl::nd_item<3> wItem)
{
//// Print kernel code here (after function prototype)
	...
	for(unsigned int t=0; t<2; t++) // generator.kernel.hpp:1847
	{
		...
		// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
		// rw, b, me% control read/write; then ldsOffset, lwb, lds
		back_len256_sbrc_device<T, sb>(twiddles, stride_in[0], stride_out[0],  1, b, me%64, t * (256 + lds_row_padding) * 4 + (me/64)*(256+ lds_row_padding), lds, lds, lds);
...
//// Print kernel code here (after function prototype)
	...
	for(unsigned int t=0; t<8; t++) // generator.kernel.hpp:1970
	{
		...
		if(Tsbrc == SBRC_2D)
		{
			lwbOutRe[(me%8) * stride_out[1] + (me/8)*stride_out[0] + t*stride_out[0]*32] = R0.x;
			lwbOutIm[(me%8) * stride_out[1] + (me/8)*stride_out[0] + t*stride_out[0]*32] = R0.y;
		}
		else if(Tsbrc == SBRC_3D_FFT_TRANS_XY_Z)
		{
			lwbOutRe[(me%8) * stride_out[0] + (me/8)*stride_out[1] + t*stride_out[1]*32] = R0.x;
			lwbOutIm[(me%8) * stride_out[0] + (me/8)*stride_out[1] + t*stride_out[1]*32] = R0.y;
		}
		else if(Tsbrc == SBRC_3D_FFT_TRANS_Z_XY || Tsbrc == SBRC_3D_FFT_ERC_TRANS_Z_XY)
		{
			lwbOutRe[(me%8) * stride_out[0] + (me/8)*stride_out[2] + t*stride_out[2]*32] = R0.x;
			lwbOutIm[(me%8) * stride_out[0] + (me/8)*stride_out[2] + t*stride_out[2]*32] = R0.y;
		}
	}
...
//// Print kernel code here (after function prototype)
	...
	for(unsigned int t=0; t<8; t++) // generator.kernel.hpp:1657
	{
		...
		if(Tsbrc == SBRC_2D || Tsbrc == SBRC_3D_FFT_TRANS_Z_XY || Tsbrc == SBRC_3D_FFT_ERC_TRANS_Z_XY)
		{
			R0.x = lwbInRe[me + t*256];
			R0.y = lwbInIm[me + t*256];
		}
		else if(Tsbrc == SBRC_3D_FFT_TRANS_XY_Z)
		{
			R0.x = lwbInRe[me % 256 * stride_in[0] + ((me /256 * 32) + t % 8)*stride_in[2] + t / 8 * 256 * stride_in[0]];
			R0.y = lwbInIm[me % 256 * stride_in[0] + ((me /256 * 32) + t % 8)*stride_in[2] + t / 8 * 256 * stride_in[0]];
		}
