...
__device__ void
FwdPass0_len50_sbrc(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, T *bufIn, T *bufOut, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9)
{
...
template <typename T, StrideBin sb>
__device__ void
FwdPass1_len50_sbrc(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, T *bufIn, T *bufOut, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9)
{
...
template <typename T, StrideBin sb>
__device__ void
InvPass0_len50_sbrc(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, T *bufIn, T *bufOut, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9)
{
...
template <typename T, StrideBin sb>
__device__ void
InvPass1_len50_sbrc(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int inOffset, unsigned int outOffset, T *bufIn, T *bufOut, T *R0, T *R1, T *R2, T *R3, T *R4, T *R5, T *R6, T *R7, T *R8, T *R9)
{
...
template <typename T, StrideBin sb>
__device__ void 
fwd_len50_sbrc_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *lwbIn, T *lwbOut, T *lds)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9;
	FwdPass0_len50_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset,  lwbIn, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9);
	__syncthreads();
	FwdPass1_len50_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds,  lwbOut, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9);
	__syncthreads();
}

template <typename T, StrideBin sb>
__device__ void 
back_len50_sbrc_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *lwbIn, T *lwbOut, T *lds)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9;
	InvPass0_len50_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset,  lwbIn, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9);
	__syncthreads();
	InvPass1_len50_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds,  lwbOut, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9);
	__syncthreads();
}

template <typename T, StrideBin sb>
__device__ void 
fwd_len50_sbrc_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *lwbIn, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *lds)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9;
	FwdPass0_len50_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset,  lwbIn, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9);
	__syncthreads();
	FwdPass1_len50_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, bufOutRe, bufOutIm, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9);
	__syncthreads();
}

template <typename T, StrideBin sb>
__device__ void 
back_len50_sbrc_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, T *lwbIn, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *lds)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9;
	InvPass0_len50_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset,  lwbIn, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9);
	__syncthreads();
	InvPass1_len50_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds, bufOutRe, bufOutIm, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9);
	__syncthreads();
}

template <typename T, StrideBin sb>
__device__ void 
fwd_len50_sbrc_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, T *lwbOut, T *lds)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9;
	FwdPass0_len50_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset,  bufInRe, bufInIm, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9);
	__syncthreads();
	FwdPass1_len50_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds,  lwbOut, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9);
	__syncthreads();
}
...
template <typename T, StrideBin sb>
__device__ void 
back_len50_sbrc_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, T *lwbOut, T *lds)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9;
	InvPass0_len50_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset,  bufInRe, bufInIm, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9);
	__syncthreads();
	InvPass1_len50_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset, lds,  lwbOut, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9);
	__syncthreads();
}
...
template <typename T, StrideBin sb>
__device__ void 
fwd_len50_sbrc_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *lds)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9;
	FwdPass0_len50_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset,  bufInRe, bufInIm, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9);
	__syncthreads();
...
template <typename T, StrideBin sb>
__device__ void 
back_len50_sbrc_device(const T *twiddles, const size_t stride_in, const size_t stride_out, unsigned int rw, unsigned int b, unsigned int me, unsigned int ldsOffset, real_type_t<T> *bufInRe, real_type_t<T> *bufInIm, real_type_t<T> *bufOutRe, real_type_t<T> *bufOutIm, T *lds)
{
	T R0, R1, R2, R3, R4, R5, R6, R7, R8, R9;
	InvPass0_len50_sbrc<T, sb>(twiddles, stride_in, stride_out, rw, b, me, ldsOffset, ldsOffset,  bufInRe, bufInIm, lds, &R0, &R1, &R2, &R3, &R4, &R5, &R6, &R7, &R8, &R9);
	__syncthreads();
...
rocfftQueue.submit([&](cl::sycl::handler &cgh)
{
	...
	cgh.parallel_for<class kern_fft_fwd_op_len50_sbrc>(
...
//// Print kernel code here (after function prototype)
	...
	for(unsigned int t=0; t<10; t++) // generator.kernel.hpp:1657
	{
		...
		{
			R0 = lwbIn[me % 50 * stride_in[0] + ((me /50 * 5) + t % 10)*stride_in[2] + t / 10 * 50 * stride_in[0]];
		}
	...
	for(unsigned int t=0; t<1; t++) // generator.kernel.hpp:1847
	{
		...
		fwd_len50_sbrc_device<T, sb>(twiddles, stride_in[0], stride_out[0],  rw, b, me%5, t * (50 + lds_row_padding) * 10 + (me/5)*(50+ lds_row_padding), lds, lds, lds);
	...
	if (Tsbrc == SBRC_3D_FFT_ERC_TRANS_Z_XY)
	{
		...
		{
			post_process_interleaved_inplace<T, true>(me, 50 - me, 50, 25, &lds[r * (50 + lds_row_padding)], &twiddles[50]);
		}
		__syncthreads();
	}
	...
	for(unsigned int t=0; t<10; t++) // generator.kernel.hpp:1970
	{
		...
		if(Tsbrc == SBRC_2D)
		{
			lwbOut[(me%10) * stride_out[1] + (me/10)*stride_out[0] + t*stride_out[0]*5] = R0;
		}
		else if(Tsbrc == SBRC_3D_FFT_TRANS_XY_Z)
		{
			lwbOut[(me%10) * stride_out[0] + (me/10)*stride_out[1] + t*stride_out[1]*5] = R0;
		}
		else if(Tsbrc == SBRC_3D_FFT_TRANS_Z_XY || Tsbrc == SBRC_3D_FFT_ERC_TRANS_Z_XY)
		{
			lwbOut[(me%10) * stride_out[0] + (me/10)*stride_out[2] + t*stride_out[2]*5] = R0;
		}
	}
...
__global__ void
__launch_bounds__(50)
fft_back_op_len50_sbrc( cl::sycl::range<3> blocks, cl::sycl::range<3> threads, cl::sycl::queue rocfftQueue, cl::sycl::buffer<T, 1> twiddles_GB, const size_t dim, cl::sycl::buffer<size_t, 1> *lengths_GB, cl::sycl::buffer<size_t, 1> *stride_in_GB, cl::sycl::buffer<size_t, 1> *stride_out_GB, const size_t batch_count, cl::sycl::buffer<T, 1> gbIn_GB, cl::sycl::buffer<T, 1> gbOut_GB)
{
rocfftQueue.submit([&](cl::sycl::handler &cgh)
{
	auto twiddles = twiddles_GB.get_access<cl::sycl::access::mode::read>(cgh);
	...
	auto gbOut = gbOut_GB.get_access<cl::sycl::access::mode::read_write>(cgh);
	cl::sycl::accessor<T,1,sycl::access::mode::read_write,sycl::access::target::local> lds(cl::sycl::range<1>(510), cgh);
	cgh.parallel_for<class kern_fft_back_op_len50_sbrc>(
	                   cl::sycl::nd_range<3>(blocks, threads),
	                   [=](cl::sycl::nd_item<3> wItem)
{
//// Print kernel code here (after function prototype)
	...
	for(unsigned int t=0; t<1; t++) // generator.kernel.hpp:1847
	{
		...
		// Perform FFT input: lwb(In) ; output: lwb(Out); working space: lds 
		// rw, b, me% control read/write; then ldsOffset, lwb, lds
		back_len50_sbrc_device<T, sb>(twiddles, stride_in[0], stride_out[0],  rw, b, me%5, t * (50 + lds_row_padding) * 10 + (me/5)*(50+ lds_row_padding), lds, lds, lds);
...
//// Print kernel code here (after function prototype)
	...
	for(unsigned int t=0; t<10; t++) // generator.kernel.hpp:1970
	{
		...
		if(Tsbrc == SBRC_2D)
		{
			lwbOutRe[(me%10) * stride_out[1] + (me/10)*stride_out[0] + t*stride_out[0]*5] = R0.x;
			lwbOutIm[(me%10) * stride_out[1] + (me/10)*stride_out[0] + t*stride_out[0]*5] = R0.y;
		}
		else if(Tsbrc == SBRC_3D_FFT_TRANS_XY_Z)
		{
			lwbOutRe[(me%10) * stride_out[0] + (me/10)*stride_out[1] + t*stride_out[1]*5] = R0.x;
			lwbOutIm[(me%10) * stride_out[0] + (me/10)*stride_out[1] + t*stride_out[1]*5] = R0.y;
		}
		else if(Tsbrc == SBRC_3D_FFT_TRANS_Z_XY || Tsbrc == SBRC_3D_FFT_ERC_TRANS_Z_XY)
		{
			lwbOutRe[(me%10) * stride_out[0] + (me/10)*stride_out[2] + t*stride_out[2]*5] = R0.x;
			lwbOutIm[(me%10) * stride_out[0] + (me/10)*stride_out[2] + t*stride_out[2]*5] = R0.y;
		}
	}
...
//// Print kernel code here (after function prototype)
	...
	for(unsigned int t=0; t<10; t++) // generator.kernel.hpp:1657
	{
		...
		if(Tsbrc == SBRC_2D || Tsbrc == SBRC_3D_FFT_TRANS_Z_XY || Tsbrc == SBRC_3D_FFT_ERC_TRANS_Z_XY)
		{
			R0.x = lwbInRe[me + t*50];
			R0.y = lwbInIm[me + t*50];
		}
		else if(Tsbrc == SBRC_3D_FFT_TRANS_XY_Z)
		{
			R0.x = lwbInRe[me % 50 * stride_in[0] + ((me /50 * 5) + t % 10)*stride_in[2] + t / 10 * 50 * stride_in[0]];
			R0.y = lwbInIm[me % 50 * stride_in[0] + ((me /50 * 5) + t % 10)*stride_in[2] + t / 10 * 50 * stride_in[0]];
		}
