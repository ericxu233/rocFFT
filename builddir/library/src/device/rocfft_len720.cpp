 ...
 * Kernel is: namespace(factors=[16, 5, 3, 3], flavour='uwide', length=720, scheme='CS_KERNEL_STOCKHAM', threads_per_block=256)
 */
...
__device__ void ip_forward_length720_SBRR_device(scalar_type* __restrict__ lds,
                                                 ...
                                                 bool         write)
{
    ...
    thread               = threadIdx.x % 240; /* stockham.py:731 */
    ...
    R[5]  = lds[offset_lds + (thread + 225) * lstride]; /* stockham.py:542 */
    R[6]  = lds[offset_lds + (thread + 270) * lstride]; /* stockham.py:542 */
    R[7]  = lds[offset_lds + (thread + 315) * lstride]; /* stockham.py:542 */
    R[8]  = lds[offset_lds + (thread + 360) * lstride]; /* stockham.py:542 */
    R[9]  = lds[offset_lds + (thread + 405) * lstride]; /* stockham.py:542 */
    R[10] = lds[offset_lds + (thread + 450) * lstride]; /* stockham.py:542 */
    R[11] = lds[offset_lds + (thread + 495) * lstride]; /* stockham.py:542 */
    R[12] = lds[offset_lds + (thread + 540) * lstride]; /* stockham.py:542 */
    R[13] = lds[offset_lds + (thread + 585) * lstride]; /* stockham.py:542 */
    R[14] = lds[offset_lds + (thread + 630) * lstride]; /* stockham.py:542 */
    R[15] = lds[offset_lds + (thread + 675) * lstride]; /* stockham.py:542 */
    ...
    __syncthreads();
    R[0] = lds[offset_lds + (thread + 0) * lstride]; /* stockham.py:542 */
    R[1] = lds[offset_lds + (thread + 144) * lstride]; /* stockham.py:542 */
    R[2] = lds[offset_lds + (thread + 288) * lstride]; /* stockham.py:542 */
    R[3] = lds[offset_lds + (thread + 432) * lstride]; /* stockham.py:542 */
    R[4] = lds[offset_lds + (thread + 576) * lstride]; /* stockham.py:542 */
    ...
    __syncthreads();
    R[0] = lds[offset_lds + (thread + 0) * lstride]; /* stockham.py:542 */
    R[1] = lds[offset_lds + (thread + 240) * lstride]; /* stockham.py:542 */
    R[2] = lds[offset_lds + (thread + 480) * lstride]; /* stockham.py:542 */
    ...
    W    = twiddles[239 + 2 * (thread % 240)]; /* stockham.py:554 */
    t.x  = W.x * R[1].x - W.y * R[1].y; /* stockham.py:555 */
    t.y  = W.y * R[1].x + W.x * R[1].y; /* stockham.py:556 */
    R[1] = t; /* stockham.py:557 */
    W    = twiddles[240 + 2 * (thread % 240)]; /* stockham.py:554 */
    t.x  = W.x * R[2].x - W.y * R[2].y; /* stockham.py:555 */
    t.y  = W.y * R[2].x + W.x * R[2].y; /* stockham.py:556 */
    R[2] = t; /* stockham.py:557 */
    ...
    if(write)
    {
        lds[offset_lds + ((thread / 240) * 720 + thread % 240 + 0) * lstride]
            = R[0]; /* stockham.py:577 */
        lds[offset_lds + ((thread / 240) * 720 + thread % 240 + 240) * lstride]
            = R[1]; /* stockham.py:577 */
        lds[offset_lds + ((thread / 240) * 720 + thread % 240 + 480) * lstride]
            = R[2]; /* stockham.py:577 */
    }
}
/* stockham.py:709 */
...
__global__
    __launch_bounds__(240) void ip_forward_length720_SBRR(const scalar_type* __restrict__ twiddles,
                                                          const size_t dim,
...
{
    // this kernel:
    //   uses 240 threads per transform
    ...
    transform = blockIdx.x * 1 + threadIdx.x / 240; /* stockham.py:363 */
    ...
    offset_lds = (720 + lds_padding) * (transform % 1); /* stockham.py:373 */
    ...
    // load global
    thread = threadIdx.x % 240; /* stockham.py:384 */
    ...
    if(ebtype == EmbeddedType::C2Real_PRE)
    {
        ...
        real_pre_process_kernel_inplace<scalar_type, true>(thread % 360 + 0,
                                                           720 - thread % 360 - 0,
                                                           360,
                                                           &lds[offset_lds],
                                                           0,
                                                           &twiddles[720]); /* stockham.py:338 */

        real_pre_process_kernel_inplace<scalar_type, true>(thread % 360 + 240,
                                                           720 - thread % 360 - 240,
                                                           360,
                                                           &lds[offset_lds],
                                                           0,
    ...
    ip_forward_length720_SBRR_device<scalar_type, SB_UNIT>(
    ...
    if(ebtype == EmbeddedType::Real2C_POST)
    {
        ...
        real_post_process_kernel_inplace<scalar_type, true>(thread % 360 + 0,
                                                            720 - thread % 360 - 0,
                                                            360,
                                                            &lds[offset_lds],
                                                            0,
        ...
        real_post_process_kernel_inplace<scalar_type, true>(thread % 360 + 240,
                                                            720 - thread % 360 - 240,
                                                            360,
                                                            &lds[offset_lds],
                                                            0,
...
/* stockham.py:709 */
template <typename scalar_type, StrideBin sb, EmbeddedType ebtype, CallbackType cbtype>
__global__ __launch_bounds__(240) void ip_forward_length720_SBRR(
    const scalar_type* __restrict__ twiddles,
    const size_t dim,
    const size_t* __restrict__ lengths,
    const size_t* __restrict__ stride,
...
/* stockham.py:765 */
template <typename scalar_type, StrideBin sb>
__device__ void op_forward_length720_SBRR_device(scalar_type* __restrict__ lds,
                                                 const scalar_type* __restrict__ twiddles,
                                                 size_t       stride_lds,
                                                 unsigned int offset_lds,
                                                 bool         write)
...
template <typename scalar_type, StrideBin sb, EmbeddedType ebtype, CallbackType cbtype>
__global__
    __launch_bounds__(240) void op_forward_length720_SBRR(const scalar_type* __restrict__ twiddles,
                                                          const size_t dim,
                                                          const size_t* __restrict__ lengths,
                                                          ...
                                                          scalar_type* __restrict__ buf_out)
{
    ...
    // transform
    write = true; /* stockham.py:681 */
    op_forward_length720_SBRR_device<scalar_type, SB_UNIT>(
        lds, twiddles, stride_lds, offset_lds, write); /* stockham.py:686 */
...
/* stockham.py:709 */
template <typename scalar_type, StrideBin sb, EmbeddedType ebtype, CallbackType cbtype>
__global__ __launch_bounds__(240) void op_forward_length720_SBRR(
    const scalar_type* __restrict__ twiddles,
    const size_t dim,
    const size_t* __restrict__ lengths,
    const size_t* __restrict__ stride_in,
...
/* stockham.py:765 */
template <typename scalar_type, StrideBin sb>
__device__ void ip_inverse_length720_SBRR_device(scalar_type* __restrict__ lds,
                                                 const scalar_type* __restrict__ twiddles,
                                                 size_t       stride_lds,
                                                 unsigned int offset_lds,
                                                 bool         write)
{
    ...
    W    = {twiddles[239 + 2 * (thread % 240)].x,
         -twiddles[239 + 2 * (thread % 240)].y}; /* generator.py:1065 */
    t.x  = W.x * R[1].x - W.y * R[1].y; /* stockham.py:555 */
    t.y  = W.y * R[1].x + W.x * R[1].y; /* stockham.py:556 */
    R[1] = t; /* stockham.py:557 */
    W    = {twiddles[240 + 2 * (thread % 240)].x,
         -twiddles[240 + 2 * (thread % 240)].y}; /* generator.py:1065 */
    t.x  = W.x * R[2].x - W.y * R[2].y; /* stockham.py:555 */
    t.y  = W.y * R[2].x + W.x * R[2].y; /* stockham.py:556 */
    R[2] = t; /* stockham.py:557 */
...
template <typename scalar_type, StrideBin sb, EmbeddedType ebtype, CallbackType cbtype>
__global__
    __launch_bounds__(240) void ip_inverse_length720_SBRR(const scalar_type* __restrict__ twiddles,
                                                          const size_t dim,
                                                          const size_t* __restrict__ lengths,
                                                          const size_t* __restrict__ stride,
                                                          const size_t       nbatch,
                                                          ...
                                                          scalar_type* __restrict__ buf)
{
    ...
    // transform
    write = true; /* stockham.py:681 */
    ip_inverse_length720_SBRR_device<scalar_type, SB_UNIT>(
        lds, twiddles, stride_lds, offset_lds, write); /* stockham.py:686 */
...
/* stockham.py:709 */
template <typename scalar_type, StrideBin sb, EmbeddedType ebtype, CallbackType cbtype>
__global__ __launch_bounds__(240) void ip_inverse_length720_SBRR(
    const scalar_type* __restrict__ twiddles,
    const size_t dim,
    const size_t* __restrict__ lengths,
    const size_t* __restrict__ stride,
...
/* stockham.py:765 */
template <typename scalar_type, StrideBin sb>
__device__ void op_inverse_length720_SBRR_device(scalar_type* __restrict__ lds,
                                                 const scalar_type* __restrict__ twiddles,
                                                 size_t       stride_lds,
                                                 unsigned int offset_lds,
                                                 bool         write)
...
template <typename scalar_type, StrideBin sb, EmbeddedType ebtype, CallbackType cbtype>
__global__
    __launch_bounds__(240) void op_inverse_length720_SBRR(const scalar_type* __restrict__ twiddles,
                                                          const size_t dim,
                                                          const size_t* __restrict__ lengths,
                                                          const size_t* __restrict__ stride_in,
                                                          const size_t* __restrict__ stride_out,
                                                          ...
                                                          scalar_type* __restrict__ buf_out)
{
    ...
    // transform
    write = true; /* stockham.py:681 */
    op_inverse_length720_SBRR_device<scalar_type, SB_UNIT>(
        lds, twiddles, stride_lds, offset_lds, write); /* stockham.py:686 */
...
/* stockham.py:709 */
template <typename scalar_type, StrideBin sb, EmbeddedType ebtype, CallbackType cbtype>
__global__ __launch_bounds__(240) void op_inverse_length720_SBRR(
    const scalar_type* __restrict__ twiddles,
    const size_t dim,
    const size_t* __restrict__ lengths,
    const size_t* __restrict__ stride_in,
...
POWX_SMALL_GENERATOR(rocfft_internal_dfn_dp_ci_ci_stoc_720,
                     ip_forward_length720_SBRR,
                     ip_inverse_length720_SBRR,
                     op_forward_length720_SBRR,
                     op_inverse_length720_SBRR,
                     double2);
POWX_SMALL_GENERATOR(rocfft_internal_dfn_sp_ci_ci_stoc_720,
                     ip_forward_length720_SBRR,
                     ip_inverse_length720_SBRR,
                     op_forward_length720_SBRR,
                     op_inverse_length720_SBRR,
